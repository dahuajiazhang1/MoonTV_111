    ...
    <form onSubmit={handleSubmit} className='space-y-6 max-w-2xl'>
      <div className='space-y-2'>
        ...
        <input
          ...
          onChange={(e) =>
            setSettings({ ...settings, alipay_qr_code: e.target.value })
          }
      ...
      <div className='space-y-2'>
        ...
        <input
          ...
          onChange={(e) =>
            setSettings({ ...settings, alipay_account_name: e.target.value })
          }
          className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-2 focus:ring-blue-500'
          placeholder='例如：*某某'
        />
      ...
      <div className='space-y-2'>
        ...
        <textarea
          ...
          onChange={(e) =>
            setSettings({ ...settings, payment_notice: e.target.value })
          }
      ...
      <div className='flex items-center gap-4'>
        <div className='flex items-center gap-2'>
          <input
            ...
            onChange={(e) =>
              setSettings({ ...settings, auto_approval: e.target.checked })
            }
      ...
      <div className='space-y-2'>
        ...
        <input
          ...
          onChange={(e) =>
            setSettings({
              ...settings,
              order_expire_hours: Number(e.target.value),
            })
          }
          className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-2 focus:ring-blue-500'
        />
