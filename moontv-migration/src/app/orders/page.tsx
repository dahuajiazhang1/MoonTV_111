                                ...
                                >
                                    <div className="p-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                                            ...
                                            {order.plan_duration && (
                                                <div>
                                                    <span className="text-gray-500 dark:text-gray-400">套餐时长：</span>
                                                    <span className="text-gray-900 dark:text-white">
                                            ...
                                            {order.verified_at && (
                                                <div>
                                                    <span className="text-gray-500 dark:text-gray-400">审核时间：</span>
                                                    <span className="text-gray-900 dark:text-white">
                                                        {new Date(order.verified_at).toLocaleString('zh-CN')}
                                                    </span>
                                                </div>
                                            )}
                                            {order.expires_at && order.payment_status === 'pending' && (
                                                <div>
