...
var q = globalThis.__nextOnPagesRoutesIsolation.getProxyFor('/api/admin/reset'),
  Ct = pt(q, q, q),
  Pt = Ct.__chunk_52387,
  rt = bt(q, q, q),
  xt = rt.__chunk_67550,
  ...
  $a = (($, V, tt) => (
        ...
        7976: function (G, j, k) {
          ...
          class c {
            ...
            resubscribe() {
              ...
              if (_.length)
                return Promise.all(
                  _.map((a) => u(this, n, 'm', M).call(this, a))
                );
            }
          ...
          class W extends L.EventEmitter {
            ...
            constructor(i) {
              super(),
                ...
                a(this, E, _(this, n, 'm', M).call(this), 'f'),
            ...
            async multiExecutor(i, P, v) {
              ...
              _(this, n, 'm', s).call(this);
              let Y = await F;
              return P !== void 0 && a(this, y, P, 'f'), Y;
            }
        ...
        66723: function (G, j, k) {
          ...
          class g {
            ...
            unsubscribe(s, c, e, _) {
              ...
              if (d.length === 1) {
                for (let O of l) f(r, r, 'm', b).call(r, a.get(O), _).delete(e);
                return;
              }
        ...
        73663: function (G, j, k) {
          ...
          (m = Q),
            ...
            (N = async function (I) {
              let w = new Set();
              try {
                let T = await d(this, n, 'm', M).call(this, I),
                  W = [],
            ...
            (C = async function (I) {
              ...
              for (let { master: T, replicas: W } of this.shards)
                if (
                  (T.client &&
                    w.push(d(this, n, 'm', s).call(this, T.client, I)),
                  T.pubSubClient &&
                    w.push(d(this, n, 'm', s).call(this, T.pubSubClient, I)),
                  W)
                )
    ...
    ($.webpackChunk_N_E = $.webpackChunk_N_E || []).push([
      [2390],
      {
        ...
        39355: (G, j, k) => {
          ...
          async function M(s) {
            ...
            if (c.username !== process.env.USERNAME)
              return R.xk.json(
                {
                  error:
                    '\u4EC5\u652F\u6301\u7AD9\u957F\u91CD\u7F6E\u914D\u7F6E',
          ...
          let x = new E.AppRouteRouteModule({
              definition: {
                kind: b.x.APP_ROUTE,
                page: '/api/admin/reset/route',
                pathname: '/api/admin/reset',
                filename: 'route',
                bundlePath: 'app/api/admin/reset/route',
              },
              resolvedPagePath:
                '/Volumes/OS/Users/wangbengang/Documents/moontv/MoonTV/src/app/api/admin/reset/route.ts',
      ...
      (G) => {
        var j = (n) => G((G.s = n));
        G.O(0, [5300, 7304, 366, 4292, 3664], () => j(39355));
        var k = G.O();
        (V._ENTRIES = typeof V._ENTRIES > 'u' ? {} : V._ENTRIES)[
          'middleware_app/api/admin/reset/route'
        ] = k;
      },
    ]),
    function () {
              ...
              for (l = a, L = !1; D(); )
                if (((d = e.charAt(a)), d === ',')) {
                  ...
                  a < e.length && e.charAt(a) === '='
                    ? ((L = !0), (a = H), _.push(e.substring(l, O)), (l = a))
                    : (a = O + 1);
                } else a += 1;
      ...
      .call({})
      .default({
        name: 'app/api/admin/reset/route',
        staticRoutes: [
          {
            page: '/',
            regex: '^/(?:/)?$',
