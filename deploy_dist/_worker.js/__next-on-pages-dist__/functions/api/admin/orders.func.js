...
var q =
    globalThis.__nextOnPagesRoutesIsolation.getProxyFor('/api/admin/orders'),
  Ct = pt(q, q, q),
  Pt = Ct.__chunk_52387,
  rt = bt(q, q, q),
  xt = rt.__chunk_67550,
  ...
  $a = (($, V, tt) => (
      ...
      (k.m = G),
        ...
        (() => {
          ...
          k.O = (m, o, E, b) => {
            ...
            for (var R = 1 / 0, l = 0; l < _.length; l++) {
              for (var [o, E, b] = _[l], y = !0, L = 0; L < o.length; L++)
                R >= b && Object.keys(k.O).every((f) => k.O[f](o[L]))
                  ? o.splice(L--, 1)
                  : ((y = !1), b < R && (R = b));
              if (y) {
                _.splice(l--, 1);
      ...
      [7304],
      {
        ...
        13785: function (G, j, k) {
          ...
          var _ =
              ...
              (Object.create
                ? function (y, L, T, M) {
                    M === void 0 && (M = T);
                    var x = Object.getOwnPropertyDescriptor(L, T);
                    (!x ||
                      ('get' in x
                        ? !L.__esModule
          ...
          var _,
            ...
            p =
              ...
              function (e, n, c, a, d) {
                ...
                return (
                  a === 'a' ? d.call(e, c) : d ? (d.value = c) : n.set(e, c), c
                );
              };
          Object.defineProperty(j, '__esModule', { value: !0 });
          let f = k(66339),
                      ...
                      if (i(this, y, 'f').isActive && Array.isArray(a)) {
                        ...
                        if (H && !i(this, l, 'f').length) {
                          ...
                          i(this, R, 'f').call(
                            this,
                            B,
                            i(this, y, 'f').removeShardedListeners(B)
                          );
                          return;
                        }
                        ...
                        if (h.equals(a[0])) {
                          let { resolve: B, returnBuffers: F } = i(
                              this,
                              l,
                              'f'
                            ).shift(),
                            U = a[1].length === 0 ? a[0] : a[1];
                          B(F ? U : U.toString());
                          return;
                        }
                      }
                      let { resolve: d, reject: N } = i(this, l, 'f').shift();
                      a instanceof u.ErrorReply ? N(a) : d(a);
                    },
                  })
                ),
                p(this, E, n, 'f'),
            ...
            addCommand(n, c) {
              return i(this, E, 'f') &&
                ...
                : new Promise((a, d) => {
                    ...
                    if (c?.signal) {
                      let H = () => {
                        i(this, b, 'f').removeNode(N),
                          N.value.reject(new u.AbortError());
                      };
                      (N.value.abort = { signal: c.signal, listener: H }),
                        c.signal.addEventListener('abort', H, { once: !0 });
                    }
                    c?.asap
                      ? i(this, b, 'f').unshiftNode(N)
                      : i(this, b, 'f').pushNode(N);
                  });
            }
            subscribe(n, c, a, d) {
              return i(this, _, 'm', M).call(
                this,
                i(this, y, 'f').subscribe(n, c, a, d)
              );
            }
            unsubscribe(n, c, a, d) {
              return i(this, _, 'm', M).call(
                this,
                i(this, y, 'f').unsubscribe(n, c, a, d)
              );
            }
            resubscribe() {
              ...
              if (n.length)
                return Promise.all(
                  n.map((c) => i(this, _, 'm', M).call(this, c))
                );
            }
            extendPubSubChannelListeners(n, c, a) {
              return i(this, _, 'm', M).call(
                this,
                i(this, y, 'f').extendChannelListeners(n, c, a)
              );
            }
            extendPubSubListeners(n, c) {
              return i(this, _, 'm', M).call(
                this,
                i(this, y, 'f').extendTypeListeners(n, c)
              );
            }
          ...
          var _,
            ...
            c =
              ...
              function (O, r, P, v, D) {
                ...
                if (typeof r == 'function' ? O !== r || !D : !r.has(O))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  v === 'a' ? D.call(O, P) : D ? (D.value = P) : r.set(O, P), P
                );
              };
          Object.defineProperty(j, '__esModule', { value: !0 });
          let a = k(76486),
          ...
          class W extends B.EventEmitter {
            ...
            constructor(r) {
              super(),
                ...
                c(this, o, n(this, _, 'm', L).call(this, r), 'f'),
                c(this, b, n(this, _, 'm', T).call(this), 'f'),
                c(this, E, n(this, _, 'm', M).call(this), 'f'),
            ...
            async functionsExecuter(r, P, v) {
              let { args: D, options: Y } = (0, U.transformCommandArguments)(
                r,
                P
              );
              return (0, U.transformCommandReply)(
            ...
            async multiExecutor(r, P, v) {
              ...
              n(this, _, 'm', h).call(this);
              let Y = await D;
              return P !== void 0 && c(this, y, P, 'f'), Y;
            }
            ...
            (b = function () {
              ...
              (this.addCommand = (...u) => (
                y(this, m, 'f').addCommand(
                  (0, M.transformLegacyCommandArguments)(u)
                ),
                this
              )),
        ...
        66723: function (G, j, k) {
          ...
          class g {
            ...
            subscribe(h, s, e, n) {
              ...
              for (let N of d) {
                let H = f(this, y, 'f')[h].get(N);
                (!H || H.unsubscribing) && a.push(N);
              }
              if (a.length === 1) {
                for (let N of d)
                  f(o, o, 'm', b).call(o, f(this, y, 'f')[h].get(N), n).add(e);
                return;
              }
              return (
                u(this, R, !0, 'f'),
            ...
            extendTypeListeners(h, s) {
              ...
              let n = [S[h].subscribe];
              for (let [c, a] of s)
                f(this, m, 'm', L).call(this, h, c, a) && n.push(c);
              if (n.length !== 1)
                return (
                  u(this, R, !0, 'f'),
            ...
            unsubscribe(h, s, e, n) {
              ...
              for (let N of a) {
                ...
                if (H) {
                  ...
                  if (
                    (n
                      ? ((B = H.buffers), (F = H.strings))
                      : ((B = H.strings), (F = H.buffers)),
                    (B.has(e) ? B.size - 1 : B.size) !== 0 || F.size !== 0)
                  )
                    continue;
                  H.unsubscribing = !0;
                }
              ...
              if (d.length === 1) {
                for (let N of a) f(o, o, 'm', b).call(o, c.get(N), n).delete(e);
                return;
              }
        ...
        53304: function (G, j, k) {
          ...
          var _,
            ...
            s =
              ...
              function (B, F, U, K) {
                ...
                if (typeof F == 'function' ? B !== F || !K : !F.has(B))
                  throw TypeError(
                    'Cannot read private member from an object whose class did not declare it'
                  );
                return U === 'm'
            ...
            e =
              ...
              function (B, F, U, K, Q) {
                ...
                if (typeof F == 'function' ? B !== F || !Q : !F.has(B))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  K === 'a' ? Q.call(B, U) : Q ? (Q.value = U) : F.set(B, U), U
                );
              };
          Object.defineProperty(j, '__esModule', { value: !0 });
          let n = k(15846),
          ...
          class H extends n.EventEmitter {
            ...
            writeCommand(F) {
              ...
              for (let U of F) e(this, T, !s(this, R, 'f').write(U), 'f');
            }
            disconnect() {
          ...
          (m = H),
            ...
            (o = function (B) {
              ...
              return (
                B ?? (B = {}),
                B.path ||
                  ((F = B).port ?? (F.port = 6379),
                  (U = B).host ?? (U.host = 'localhost')),
            ...
            (x = function (B, F) {
              ...
              if (s(this, l, 'f').reconnectStrategy)
                try {
                  let U = s(this, l, 'f').reconnectStrategy(B, F);
            ...
            (i = function (B, F) {
              let U = s(this, _, 'm', x).call(this, B, F);
              return U === !1
            ...
            (p = async function () {
              ...
              do
                try {
                  ...
                  let U = s(this, _, 'm', i).call(this, B++, F);
                  if (typeof U != 'number') throw U;
                  this.emit('error', F),
                    await (0, N.promiseTimeout)(U),
        ...
        73663: function (G, j, k) {
          ...
          (m = Q),
            ...
            (g = async function (I) {
              if (!(await d(this, _, 'm', T).call(this, I.options)))
                        ...
                        I &&
                          (await Promise.all([
                            W.extendPubSubListeners(
                              U.PubSubType.CHANNELS,
                              I[U.PubSubType.CHANNELS]
                            ),
                            W.extendPubSubListeners(
                              U.PubSubType.PATTERNS,
                              I[U.PubSubType.PATTERNS]
                            ),
                          ])),
          ...
          class p extends M.EventEmitter {
            ...
            constructor(u) {
              super(),
                ...
                R(this, m, u, 'f'),
                R(this, o, new L.default(u, this.emit.bind(this)), 'f'),
                R(this, E, x.default.extend(u), 'f');
            }
            duplicate(u) {
              return new (Object.getPrototypeOf(this).constructor)({
                ...l(this, m, 'f'),
            ...
            async functionsExecutor(u, S, g) {
              let { args: C, options: h } = (0, T.transformCommandArguments)(
                u,
                S
              );
              return (0, T.transformCommandReply)(
            ...
            async scriptsExecutor(u, S) {
              let { args: g, options: C } = (0, T.transformCommandArguments)(
                u,
                S
              );
              return (0, T.transformCommandReply)(
            ...
            async SSUBSCRIBE(u, S, g) {
              let C = l(this, m, 'f').maxCommandRedirections ?? 16,
                ...
                s = await l(this, o, 'f').getShardedPubSubClient(h);
              for (let e = 0; ; e++)
                try {
            ...
            commandsExecutor(x, i) {
              ...
              return (
                E(
                  this,
                  o,
                  b(this, o, 'f') ?? L.default.extractFirstKey(x, i, p),
                  'f'
                ),
            ...
            functionsExecutor(x, i, p) {
              ...
              return (
                E(
                  this,
                  o,
                  b(this, o, 'f') ?? L.default.extractFirstKey(x, i, f),
                  'f'
                ),
                this
              );
        ...
        89601: function (G, j) {
          ...
          (m = new WeakMap()),
            ...
            (L = function (h, s) {
              return (
                g(this, E, 'f')?.[h][s] ?? g(this, _, 'm', T).call(this, h, s)
              );
            }),
            (T = async function (h, s) {
                ...
                e = {
                  ...
                  data: h.data.map((n) => {
                    ...
                    for (let a = 0; a < n.length; a++)
                      c[h.headers[a][1]] = g(this, _, 'm', x).call(
                        this,
                        n[a],
                        s
                      );
              ...
              switch (s) {
                ...
                case u.MAP:
                  ...
                  for (let a = 0; a < e.length; a++)
                    c[e[a++]] = g(this, _, 'm', h).call(this, e[a], n);
                  return c;
                case u.POINT:
                  return {
            ...
            (i = function ([h, s, e, n, c], a) {
              let d = {
                  id: h,
                  sourceId: e,
                  destinationId: n,
                  properties: g(this, _, 'm', f).call(this, c, a),
                },
                N = g(this, _, 'm', L).call(this, 'relationshipTypes', s);
              return (
                N instanceof Promise
                  ? a.push(N.then((H) => (d.relationshipType = H)))
                  : (d.relationshipType = N),
                d
              );
            }),
            (p = function ([h, s, e], n) {
              ...
              for (let a = 0; a < s.length; a++) {
                let d = g(this, _, 'm', L).call(this, 'labels', s[a]);
                d instanceof Promise
                  ? n.push(d.then((N) => (c[a] = N)))
                  : (c[a] = d);
              }
              return {
                id: h,
            ...
            (f = function (h, s) {
              let e = {};
              for (let [n, c, a] of h) {
                let d = g(this, _, 'm', x).call(this, [c, a], s),
                  N = g(this, _, 'm', L).call(this, 'propertyKeys', n);
                N instanceof Promise
                  ? s.push(N.then((H) => (e[H] = d)))
                  : (e[N] = d);
              }
              return e;
            }),
        ...
        95514: function (G, j, k) {
          ...
          (j.createClient = function (T) {
            return (0, o.createClient)({
              ...T,
              modules: { ...L, ...T?.modules },
            });
          }),
            (j.createCluster = function (T) {
    ...
    ($.webpackChunk_N_E = $.webpackChunk_N_E || []).push([
      [2402],
      {
        ...
        75563: (G, j, k) => {
          'use strict';
          k.r(j), k.d(j, { ComponentMod: () => s, default: () => e });
          var _ = {};
          k.r(_), k.d(_, { GET: () => i, POST: () => p, runtime: () => M });
          var m = {};
          k.r(m),
            k.d(m, {
              originalPathname: () => C,
          ...
          async function x(n) {
            let c = (0, y.l)(n);
            if (!c || !c.username) return !1;
            let a = c.username;
            if (a === process.env.USERNAME) return !0;
            let d = (await (0, T.iE)()).UserConfig.Users.find(
              (N) => N.username === a
            );
            return d?.role === 'admin' && !d.banned;
          }
          async function i(n) {
            if (!(await x(n)))
              return R.xk.json(
            ...
            let c = n.nextUrl.searchParams,
              a = Number(c.get('page')) || 1,
              d = Number(c.get('limit')) || 20;
            try {
              let N = await L.db.getAllOrders(a, d);
              return R.xk.json(N);
            } catch (N) {
              return (
                console.error(
          ...
          async function p(n) {
            ...
            try {
              let { orderNo: c, status: a, reason: d } = await n.json();
              if (!c || !a)
                return R.xk.json(
                  { error: '\u7F3A\u5C11\u5FC5\u8981\u53C2\u6570' },
                  { status: 400 }
                );
              if (!['approved', 'rejected'].includes(a))
                return R.xk.json(
                  { error: '\u65E0\u6548\u7684\u72B6\u6001' },
                  { status: 400 }
                );
              if (
                ((0, y.l)(n),
                await L.db.updateOrderStatus(c, a, void 0, d),
                a === 'approved')
              ) {
                let N = await L.db.getOrder(c);
                if (N && N.order_type === 'subscription' && N.related_id) {
                  let H = await L.db.getPlanById(N.related_id);
                  if (H) {
                    let B = new Date(),
                      F = B.toISOString(),
                      U = new Date(
                        B.getTime() + 864e5 * H.duration_days
                      ).toISOString();
                    await L.db.createUserSubscription({
                      user_id: N.user_id,
                      plan_id: H.id,
                      status: 'active',
                      start_date: F,
          ...
          let f = new E.AppRouteRouteModule({
              ...
              resolvedPagePath:
                '/Volumes/OS/Users/wangbengang/Documents/moontv/MoonTV/src/app/api/admin/orders/route.ts',
      ...
      (G) => {
        var j = (_) => G((G.s = _));
        G.O(0, [5300, 7304, 366, 4292, 3664], () => j(75563));
        var k = G.O();
        (V._ENTRIES = typeof V._ENTRIES > 'u' ? {} : V._ENTRIES)[
          'middleware_app/api/admin/orders/route'
        ] = k;
      },
    ]),
    function () {
        ...
        (function (k, _) {
          ...
          function S(e) {
            ...
            return (
              e &&
                e.forEach((c, a) => {
                  (n[a] = c), a.toLowerCase() === 'set-cookie' && (n[a] = g(c));
                }),
              n
            );
          }
          function g(e) {
            ...
            for (; c < e.length; ) {
              for (a = c, B = !1; F(); )
                if (((d = e.charAt(c)), d === ',')) {
                  for (N = c, c += 1, F(), H = c; c < e.length && U(); ) c += 1;
                  c < e.length && e.charAt(c) === '='
                    ? ((B = !0), (c = H), n.push(e.substring(a, N)), (a = c))
                    : (c = N + 1);
                } else c += 1;
              (!B || c >= e.length) && n.push(e.substring(a, e.length));
            }
            return n;
          }
          function C(e) {
            ...
            return async function (a, d) {
              ...
              let B = await u({ waitUntil: d.waitUntil }, () =>
      ...
      .call({})
      .default({
        name: 'app/api/admin/orders/route',
        staticRoutes: [
          {
            page: '/',
            regex: '^/(?:/)?$',
