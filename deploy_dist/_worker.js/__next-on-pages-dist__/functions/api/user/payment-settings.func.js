    ...
    if ((Q && typeof Q == 'object') || typeof Q == 'function')
      for (let M of lt(Q))
        !kt.call($, M) &&
          ...
          ut($, M, {
            get: () => Q[M],
            enumerable: !(K = at(Q, M)) || K.enumerable,
          });
    return $;
  },
...
var V = globalThis.__nextOnPagesRoutesIsolation.getProxyFor(
    ...
    (() => {
      ...
      function k(_) {
        ...
        var r = (M[_] = { id: _, loaded: !1, exports: {} }),
          E = !0;
        try {
          K[_].call(r.exports, r, r.exports, k), (E = !1);
        } finally {
          E && delete M[_];
        }
        ...
        66723: function (K, M, k) {
          ...
          class g {
            ...
            subscribe(c, s, e, n) {
              ...
              for (let I of d) {
                let H = f(this, y, 'f')[c].get(I);
                (!H || H.unsubscribing) && l.push(I);
              }
              if (l.length === 1) {
                for (let I of d)
                  f(r, r, 'm', b).call(r, f(this, y, 'f')[c].get(I), n).add(e);
                return;
              }
              return (
                h(this, T, !0, 'f'),
          ...
          (M.PubSub = g),
            ...
            (U = function (P, c, s) {
              let e = f(this, y, 'f')[P].get(c);
              if (!e) return f(this, y, 'f')[P].set(c, s), !0;
        ...
        53304: function (K, M, k) {
          ...
          var _,
            ...
            e =
              ...
              function (L, D, B, q, X) {
                ...
                return (
                  q === 'a' ? X.call(L, B) : X ? (X.value = B) : D.set(L, B), B
                );
              };
          Object.defineProperty(M, '__esModule', { value: !0 });
          let n = k(15846),
          ...
          class H extends n.EventEmitter {
            ...
            writeCommand(D) {
              ...
              for (let B of D) e(this, N, !s(this, T, 'f').write(B), 'f');
            }
            disconnect() {
            ...
            async quit(D) {
              ...
              e(this, y, !1, 'f');
              let B = await D();
              return s(this, _, 'm', P).call(this), B;
            }
            cork() {
              !s(this, T, 'f') ||
                s(this, c, 'f') ||
            ...
            ref() {
              e(this, O, !1, 'f'), s(this, T, 'f')?.ref();
            }
            unref() {
              e(this, O, !0, 'f'), s(this, T, 'f')?.unref();
            }
          }
          (m = H),
            (b = new WeakMap()),
            ...
            (f = function () {
              return new Promise((L, D) => {
                let { connectEvent: B, socket: q } = s(m, m, 'm', E).call(
                  m,
                  s(this, o, 'f')
                )
                ...
                s(this, o, 'f').connectTimeout &&
                  q.setTimeout(s(this, o, 'f').connectTimeout, () =>
                    q.destroy(new d.ConnectionTimeoutError())
                  ),
                  s(this, O, 'f') && q.unref(),
                  q
                    .setNoDelay(s(this, o, 'f').noDelay)
                    .once('error', D)
                    .once(B, () => {
                      q
                        .setTimeout(0)
                        ...
                        .off('error', D)
                        .once('error', (X) => s(this, _, 'm', g).call(this, X))
                        .once('close', (X) => {
                          !X &&
                            s(this, y, 'f') &&
                            s(this, T, 'f') === q &&
          ...
          (m = X),
            ...
            (N = async function (j) {
              ...
              try {
                ...
                for (let [i, C] of this.nodeByAddress.entries()) {
                  ...
                  C.client &&
                    W.push(
                      d(this, _, 'm', c).call(this, C.client, (F) =>
                        F.disconnect()
                      )
                    );
            ...
            (P = async function (j) {
              ...
              for (let { master: R, replicas: W } of this.shards)
                if (
                  (R.client &&
                    w.push(d(this, _, 'm', c).call(this, R.client, j)),
                  R.pubSubClient &&
                    w.push(d(this, _, 'm', c).call(this, R.pubSubClient, j)),
                  W)
                )
                  for (let { client: A } of W)
                    A && w.push(d(this, _, 'm', c).call(this, A, j));
              this.pubSubNode &&
                (w.push(
        ...
        87423: function (K, M, k) {
          ...
          class p extends O.EventEmitter {
            ...
            async functionsExecutor(h, S, g) {
              let { args: P, options: c } = (0, N.transformCommandArguments)(
                h,
                S
              );
              return (0, N.transformCommandReply)(
                h,
                await this.executeFunction(g, h, S, P, c),
                P.preserve
              );
            }
            async executeFunction(h, S, g, P, c) {
          ...
          (m = new WeakMap()),
            ...
            (u = function ([c, s, e, n, a], l) {
              let d = {
                ...
                I = g(this, _, 'm', U).call(this, 'relationshipTypes', s);
              return (
    ...
    ($.webpackChunk_N_E = $.webpackChunk_N_E || []).push([
      [7802],
      {
        ...
        39843: (K, M, k) => {
          ...
          async function N(P) {
            try {
              let c = await y.db.getPaymentSettings();
              return T.xk.json({
                success: !0,
                settings: {
                  alipay_qr_code: c?.alipay_qr_code || null,
                  alipay_account_name: c?.alipay_account_name || null,
                  payment_notice:
                    c?.payment_notice ||
          ...
          let O = new E.AppRouteRouteModule({
              definition: {
                kind: b.x.APP_ROUTE,
                page: '/api/user/payment-settings/route',
                pathname: '/api/user/payment-settings',
                filename: 'route',
                bundlePath: 'app/api/user/payment-settings/route',
              },
              resolvedPagePath:
                '/Volumes/OS/Users/wangbengang/Documents/moontv/MoonTV/src/app/api/user/payment-settings/route.ts',
            ...
            f = '/api/user/payment-settings/route';
          function h() {
            return (0, o.XH)({
              serverHooks: p,
              staticGenerationAsyncStorage: u,
      ...
      (K) => {
        var M = (_) => K((K.s = _));
        K.O(0, [5300, 7304, 366, 4292], () => M(39843));
        var k = K.O();
        (Q._ENTRIES = typeof Q._ENTRIES > 'u' ? {} : Q._ENTRIES)[
          'middleware_app/api/user/payment-settings/route'
        ] = k;
      },
    ]),
    function () {
      ...
      .call({})
      .default({
        name: 'app/api/user/payment-settings/route',
        staticRoutes: [
          {
            page: '/',
            regex: '^/(?:/)?$',
