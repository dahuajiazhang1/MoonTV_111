...
var q = globalThis.__nextOnPagesRoutesIsolation.getProxyFor(
  ...
  $a = (($, V, tt) => (
        ...
        (() => {
          ...
          k.O = (m, r, E, b) => {
            ...
            for (var T = 1 / 0, a = 0; a < n.length; a++) {
              for (var [r, E, b] = n[a], y = !0, U = 0; U < r.length; U++)
      ...
      [7304],
      {
        ...
        7976: function (G, j, k) {
          ...
          class c {
            ...
            subscribe(_, o, l, d) {
              return u(this, n, 'm', M).call(
                this,
                u(this, y, 'f').subscribe(_, o, l, d)
              );
            }
            unsubscribe(_, o, l, d) {
              return u(this, n, 'm', M).call(
                this,
                u(this, y, 'f').unsubscribe(_, o, l, d)
              );
            }
            resubscribe() {
              ...
              if (_.length)
                return Promise.all(
                  _.map((o) => u(this, n, 'm', M).call(this, o))
                );
            }
            extendPubSubChannelListeners(_, o, l) {
              return u(this, n, 'm', M).call(
                this,
                u(this, y, 'f').extendChannelListeners(_, o, l)
              );
            }
            extendPubSubListeners(_, o) {
              return u(this, n, 'm', M).call(
                this,
                u(this, y, 'f').extendTypeListeners(_, o)
              );
            }
          ...
          class W extends L.EventEmitter {
            ...
            constructor(i) {
              super(),
                ...
                o(this, E, _(this, n, 'm', M).call(this), 'f'),
        ...
        66723: function (G, j, k) {
          ...
          class g {
            ...
            subscribe(s, c, e, _) {
              ...
              if (l.length === 1) {
                for (let O of d)
                  f(r, r, 'm', b).call(r, f(this, y, 'f')[s].get(O), _).add(e);
                return;
              }
              return (
                h(this, T, !0, 'f'),
        ...
        73663: function (G, j, k) {
          ...
          (m = Q),
            ...
            (p = function ({ id: I, ip: w, port: R }, W, A, i, P) {
              let v = `${w}:${R}`;
              i.add(v);
          ...
          (m = new WeakMap()),
                ...
                e = {
                  ...
                  data: s.data.map((_) => {
                    ...
                    for (let l = 0; l < _.length; l++)
                      o[s.headers[l][1]] = g(this, n, 'm', x).call(
                        this,
                        _[l],
                        c
                      );
              ...
              switch (c) {
                ...
                case h.MAP:
                  ...
                  for (let l = 0; l < e.length; l++)
                    o[e[l++]] = g(this, n, 'm', s).call(this, e[l], _);
                  return o;
                case h.POINT:
                  return {
            ...
            (u = function ([s, c, e, _, o], l) {
              let d = {
                  ...
                  sourceId: e,
                  destinationId: _,
                  properties: g(this, n, 'm', f).call(this, o, l),
                },
            ...
            (f = function (s, c) {
              let e = {};
              for (let [_, o, l] of s) {
                let d = g(this, n, 'm', x).call(this, [o, l], c),
    ...
    ($.webpackChunk_N_E = $.webpackChunk_N_E || []).push([
        ...
        5538: (G, j, k) => {
          ...
          async function M(s) {
            try {
              ...
              return T.xk.json(_, {
                headers: {
                  'Cache-Control': `public, max-age=${o}, s-maxage=0`,
                },
              });
            } catch (c) {
              return (
          ...
          let x = new E.AppRouteRouteModule({
              definition: {
                kind: b.x.APP_ROUTE,
                page: '/api/config/sources/route',
                pathname: '/api/config/sources',
                filename: 'route',
                bundlePath: 'app/api/config/sources/route',
              },
              resolvedPagePath:
                '/Volumes/OS/Users/wangbengang/Documents/moontv/MoonTV/src/app/api/config/sources/route.ts',
      ...
      (G) => {
        var j = (n) => G((G.s = n));
        G.O(0, [5300, 7304, 366, 4292, 3664], () => j(5538));
        var k = G.O();
        (V._ENTRIES = typeof V._ENTRIES > 'u' ? {} : V._ENTRIES)[
          'middleware_app/api/config/sources/route'
        ] = k;
      },
    ]),
    function () {
        ...
        (function (k, n) {
          ...
          function S(e) {
            ...
            return (
              e &&
                e.forEach((o, l) => {
                  (_[l] = o), l.toLowerCase() === 'set-cookie' && (_[l] = g(o));
                }),
              _
            );
          }
              ...
              for (l = o, L = !1; D(); )
                if (((d = e.charAt(o)), d === ',')) {
                  ...
                  o < e.length && e.charAt(o) === '='
                    ? ((L = !0), (o = H), _.push(e.substring(l, O)), (l = o))
                    : (o = O + 1);
                } else o += 1;
              (!L || o >= e.length) && _.push(e.substring(l, e.length));
            }
            return _;
          }
          function C(e) {
      ...
      .call({})
      .default({
        name: 'app/api/config/sources/route',
        staticRoutes: [
          {
            page: '/',
            regex: '^/(?:/)?$',
