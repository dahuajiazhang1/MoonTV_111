...
var Y = globalThis.__nextOnPagesRoutesIsolation.getProxyFor('/api/register'),
  rt = pt(Y, Y, Y),
  vt = rt.__chunk_67550,
  Ct = rt.__chunk_21892,
  t = bt(Y, Y, Y),
  ...
  Da = (($, V, tt) => (
    ...
    (() => {
      ...
      function k(_) {
        ...
        var a = (M[_] = { id: _, loaded: !1, exports: {} }),
          E = !0;
        try {
      ...
      [7304],
      {
        ...
        13785: function (q, M, k) {
          ...
          var _ =
              ...
              (Object.create
                ? function (y, L, R, B) {
                    B === void 0 && (B = R);
                    var x = Object.getOwnPropertyDescriptor(L, R);
                    (!x ||
                      ('get' in x
                        ? !L.__esModule
          ...
          let a = k(85366),
            E = k(87423);
          (M.createClient = a.default.create),
            (M.commandOptions = a.default.commandOptions),
        ...
        7976: function (q, M, k) {
          ...
          var _,
            ...
            p =
              ...
              function (e, n, c, i, d) {
                ...
                return (
                  i === 'a' ? d.call(e, c) : d ? (d.value = c) : n.set(e, c), c
                );
              };
          Object.defineProperty(M, '__esModule', { value: !0 });
          let f = k(66339),
          ...
          class s {
                ...
                R.set(
                  ...
                  new S.default({
                    returnStringsAsBuffers: () =>
                      !!r(this, l, 'f').head?.value.returnBuffers ||
                      r(this, y, 'f').isActive,
                    onReply: (i) => {
                      if (r(this, y, 'f').isActive && Array.isArray(i)) {
                        if (r(this, y, 'f').handleMessageReply(i)) return;
                        let H = C.PubSub.isShardedUnsubscribe(i);
                        if (H && !r(this, l, 'f').length) {
                          let I = i[1].toString();
                          r(this, N, 'f').call(
                            this,
                            I,
                            r(this, y, 'f').removeShardedListeners(I)
                          );
                          return;
                        }
                        if (H || C.PubSub.isStatusReply(i)) {
                          let I = r(this, l, 'f').head.value;
                          ((Number.isNaN(I.channelsCounter) && i[2] === 0) ||
                            --I.channelsCounter == 0) &&
                            r(this, l, 'f').shift().resolve();
                          return;
                        }
                        if (h.equals(i[0])) {
                          let { resolve: I, returnBuffers: F } = r(
                              this,
                              l,
                              'f'
                            ).shift(),
                            U = i[1].length === 0 ? i[0] : i[1];
                          I(F ? U : U.toString());
                          return;
                        }
                      }
                      let { resolve: d, reject: T } = r(this, l, 'f').shift();
                      i instanceof u.ErrorReply ? T(i) : d(i);
                    },
                  })
                ),
                p(this, E, n, 'f'),
            ...
            addCommand(n, c) {
              return r(this, E, 'f') &&
                r(this, b, 'f').length + r(this, l, 'f').length >=
                  r(this, E, 'f')
                ...
                : new Promise((i, d) => {
                    ...
                    if (c?.signal) {
                      let H = () => {
                        r(this, b, 'f').removeNode(T),
                          T.value.reject(new u.AbortError());
                      };
                      (T.value.abort = { signal: c.signal, listener: H }),
                        c.signal.addEventListener('abort', H, { once: !0 });
                    }
                    c?.asap
                      ? r(this, b, 'f').unshiftNode(T)
                      : r(this, b, 'f').pushNode(T);
                  });
            }
            subscribe(n, c, i, d) {
              return r(this, _, 'm', B).call(
                this,
                r(this, y, 'f').subscribe(n, c, i, d)
              );
            }
            unsubscribe(n, c, i, d) {
              return r(this, _, 'm', B).call(
                this,
                r(this, y, 'f').unsubscribe(n, c, i, d)
              );
            }
            resubscribe() {
              let n = r(this, y, 'f').resubscribe();
              if (n.length)
                return Promise.all(
                  n.map((c) => r(this, _, 'm', B).call(this, c))
                );
            }
            extendPubSubChannelListeners(n, c, i) {
              return r(this, _, 'm', B).call(
                this,
                r(this, y, 'f').extendChannelListeners(n, c, i)
              );
            }
            extendPubSubListeners(n, c) {
              return r(this, _, 'm', B).call(
                this,
                r(this, y, 'f').extendTypeListeners(n, c)
              );
            }
            getPubSubListeners(n) {
              return r(this, y, 'f').getTypeListeners(n);
            }
            getCommandToSend() {
              let n,
                c = r(this, b, 'f').shift();
            ...
            flushWaitingForReply(n) {
              if (
                (r(this, R, 'f').reset(),
                r(this, y, 'f').reset(),
                r(m, m, 'm', a).call(m, r(this, l, 'f'), n),
                r(this, L, 'f'))
              ) {
                for (
                  ;
                  r(this, b, 'f').head?.value.chainId === r(this, L, 'f');
        ...
        85366: function (q, M, k) {
          ...
          var _,
            ...
            n =
              ...
              function (O, o, P, v) {
                ...
                if (typeof o == 'function' ? O !== o || !v : !o.has(O))
                  throw TypeError(
                    'Cannot read private member from an object whose class did not declare it'
                  );
                return P === 'm'
            ...
            c =
              ...
              function (O, o, P, v, D) {
                ...
                if (typeof o == 'function' ? O !== o || !D : !o.has(O))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  v === 'a' ? D.call(O, P) : D ? (D.value = P) : o.set(O, P), P
                );
              };
          Object.defineProperty(M, '__esModule', { value: !0 });
          let i = k(76486),
          ...
          class W extends I.EventEmitter {
            ...
            static extend(o) {
              ...
              return P !== m && (P.prototype.Multi = H.default.extend(o)), P;
            }
            static create(o) {
            ...
            constructor(o) {
              super(),
                ...
                c(this, a, n(this, _, 'm', L).call(this, o), 'f'),
                c(this, b, n(this, _, 'm', R).call(this), 'f'),
                c(this, E, n(this, _, 'm', B).call(this), 'f'),
                c(this, l, n(this, _, 'm', x).call(this), 'f'),
            ...
            async connect() {
              return (
                c(
                  this,
                  l,
                  n(this, l, 'f') ?? n(this, _, 'm', x).call(this),
                  'f'
                ),
            ...
            async commandsExecutor(o, P) {
              let { args: v, options: D } = (0, U.transformCommandArguments)(
                o,
                P
              );
              return (0, U.transformCommandReply)(
                o,
                await n(this, _, 'm', g).call(this, v, D),
                v.preserve
              );
            }
            sendCommand(o, P) {
              return n(this, _, 'm', g).call(this, o, P);
            }
            async functionsExecuter(o, P, v) {
              let { args: D, options: G } = (0, U.transformCommandArguments)(
                o,
                P
              );
              return (0, U.transformCommandReply)(
                o,
                await this.executeFunction(v, o, D, G),
                D.preserve
              );
            }
            executeFunction(o, P, v, D) {
              return n(this, _, 'm', g).call(
                this,
                (0, U.fCallArguments)(o, P, v),
                D
              );
            }
            async scriptsExecuter(o, P) {
              let { args: v, options: D } = (0, U.transformCommandArguments)(
                o,
                P
              );
              return (0, U.transformCommandReply)(
                o,
                await this.executeScript(o, v, D),
                v.preserve
              );
            }
            async executeScript(o, P, v) {
              let D = ['EVALSHA', o.SHA1];
              o.NUMBER_OF_KEYS !== void 0 &&
                D.push(o.NUMBER_OF_KEYS.toString()),
                D.push(...P);
              try {
                return await n(this, _, 'm', g).call(this, D, v);
              } catch (G) {
                if (!G?.message?.startsWith?.('NOSCRIPT')) throw G;
                return (
                  (D[0] = 'EVAL'),
                  (D[1] = o.SCRIPT),
                  n(this, _, 'm', g).call(this, D, v)
                );
              }
            }
            async SELECT(o, P) {
              (0, F.isCommandOptions)(o) || ((P = o), (o = null)),
            ...
            SUBSCRIBE(o, P, v) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').subscribe(w.PubSubType.CHANNELS, o, P, v)
              );
            }
            UNSUBSCRIBE(o, P, v) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').unsubscribe(w.PubSubType.CHANNELS, o, P, v)
              );
            }
            PSUBSCRIBE(o, P, v) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').subscribe(w.PubSubType.PATTERNS, o, P, v)
              );
            }
            PUNSUBSCRIBE(o, P, v) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').unsubscribe(w.PubSubType.PATTERNS, o, P, v)
              );
            }
            SSUBSCRIBE(o, P, v) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').subscribe(w.PubSubType.SHARDED, o, P, v)
              );
            }
            SUNSUBSCRIBE(o, P, v) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').unsubscribe(w.PubSubType.SHARDED, o, P, v)
              );
            }
            getPubSubListeners(o) {
              return n(this, b, 'f').getPubSubListeners(o);
            }
            extendPubSubChannelListeners(o, P, v) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').extendPubSubChannelListeners(o, P, v)
              );
            }
            extendPubSubListeners(o, P) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').extendPubSubListeners(o, P)
              );
            }
            QUIT() {
              return n(this, E, 'f').quit(async () => {
                ...
                let [P] = await Promise.all([o, n(this, _, 'm', e).call(this)]);
                return P;
              });
            }
            executeIsolated(o) {
            ...
            async multiExecutor(o, P, v) {
              if (!n(this, E, 'f').isOpen)
                return Promise.reject(new Q.ClientClosedError());
              let D = v
                ? Promise.all([
                    n(this, b, 'f').addCommand(['MULTI'], { chainId: v }),
                    n(this, _, 'm', s).call(this, o, v),
                    n(this, b, 'f').addCommand(['EXEC'], { chainId: v }),
                  ])
                : n(this, _, 'm', s).call(this, o);
              n(this, _, 'm', h).call(this);
              let G = await D;
              return P !== void 0 && c(this, y, P, 'f'), G;
            }
            async *scanIterator(o) {
              let P = 0;
              do {
                let v = await this.scan(P, o);
                for (let D of ((P = v.cursor), v.keys)) yield D;
              } while (P !== 0);
            }
            async *hScanIterator(o, P) {
              let v = 0;
              do {
                let D = await this.hScan(o, v, P);
                for (let G of ((v = D.cursor), D.tuples)) yield G;
              } while (v !== 0);
            }
            async *hScanNoValuesIterator(o, P) {
              let v = 0;
              do {
                let D = await this.hScanNoValues(o, v, P);
                for (let G of ((v = D.cursor), D.keys)) yield G;
              } while (v !== 0);
            }
            async *sScanIterator(o, P) {
              let v = 0;
              do {
                let D = await this.sScan(o, v, P);
                for (let G of ((v = D.cursor), D.members)) yield G;
              } while (v !== 0);
            }
            async *zScanIterator(o, P) {
              let v = 0;
              do {
                let D = await this.zScan(o, v, P);
                for (let G of ((v = D.cursor), D.members)) yield G;
              } while (v !== 0);
            }
            async disconnect() {
          ...
          (m = W),
            ...
            (L = function (O) {
              if (O?.url) {
                let o = m.parseURL(O.url);
                O.socket && (o.socket = Object.assign(O.socket, o.socket)),
                  Object.assign(O, o);
              }
              return O?.database && c(this, y, O.database, 'f'), O;
            }),
            (R = function () {
              return new T.default(
                n(this, a, 'f')?.commandsQueueMaxLength,
                (O, o) => this.emit('sharded-channel-moved', O, o)
              );
            }),
            (B = function () {
              let O = async () => {
              ...
              return new d.default(O, n(this, a, 'f')?.socket)
            ...
            (r = function () {
              var O;
              if (n(this, a, 'f')?.legacyMode) {
                for (let [o, P] of ((n(this, N, 'f').sendCommand = n(
                  this,
                  _,
                  'm',
                  g
                ...
                Object.entries(i.default)))
                  n(this, _, 'm', f).call(this, o, P),
                    this[(O = o.toLowerCase())] ?? (this[O] = this[o]);
            ...
            (p = function (...O) {
              let o = typeof O[O.length - 1] == 'function' ? O.pop() : void 0,
                P = n(this, _, 'm', g).call(
                  this,
                  (0, U.transformLegacyCommandArguments)(O)
                );
              if (o) return { promise: P, callback: o };
                ...
                (this[O] =
                  o && o.TRANSFORM_LEGACY_REPLY && o.transformReply
                    ? (...P) => {
                        ...
                        v &&
                          v.promise
                            .then((D) => v.callback(null, o.transformReply(D)))
            ...
            (g = function (O, o) {
              ...
              let P = n(this, b, 'f').addCommand(O, o);
            ...
            (s = function (O, o) {
              return Promise.all(
                O.map(({ args: P }) =>
                  n(this, b, 'f').addCommand(P, { chainId: o })
                )
              );
            }),
            (e = async function () {
          ...
          var _,
            ...
            N =
              ...
              function (r, p, f, u, S) {
                ...
                if (typeof p == 'function' ? r !== p || !S : !p.has(r))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  u === 'a' ? S.call(r, f) : S ? (S.value = f) : p.set(r, f), f
                );
              },
            y =
              (this && this.__classPrivateFieldGet) ||
              function (r, p, f, u) {
                ...
                if (typeof p == 'function' ? r !== p || !u : !p.has(r))
                  throw TypeError(
                    'Cannot read private member from an object whose class did not declare it'
                  );
                return f === 'm'
              ...
              (this.v4[r] = this[r].bind(this.v4)),
                (this[r] =
                  p && p.TRANSFORM_LEGACY_REPLY && p.transformReply
                    ? (...f) => (
                        y(this, m, 'f').addCommand(
                          [r, ...(0, B.transformLegacyCommandArguments)(f)],
                          p.transformReply
                        ),
                        this
                      )
        ...
        66723: function (q, M, k) {
          ...
          Object.defineProperty(M, '__esModule', { value: !0 }),
            ...
            ((_ = r || (M.PubSubType = r = {})).CHANNELS = 'CHANNELS'),
            (_.PATTERNS = 'PATTERNS'),
            (_.SHARDED = 'SHARDED');
          let S = {
            [r.CHANNELS]: {
          ...
          class g {
            ...
            static isStatusReply(h) {
              return (
                S[r.CHANNELS].subscribe.equals(h[0]) ||
                S[r.CHANNELS].unsubscribe.equals(h[0]) ||
                S[r.PATTERNS].subscribe.equals(h[0]) ||
                S[r.PATTERNS].unsubscribe.equals(h[0]) ||
                S[r.SHARDED].subscribe.equals(h[0])
              );
            }
            static isShardedUnsubscribe(h) {
              return S[r.SHARDED].unsubscribe.equals(h[0]);
            }
            get isActive() {
              return f(this, N, 'f');
            }
            subscribe(h, s, e, n) {
              var c;
              let i = [S[h].subscribe],
                d = f(a, a, 'm', E).call(a, s);
              for (let T of d) {
                let H = f(this, y, 'f')[h].get(T);
                (!H || H.unsubscribing) && i.push(T);
              }
              if (i.length === 1) {
                for (let T of d)
                  f(a, a, 'm', b).call(a, f(this, y, 'f')[h].get(T), n).add(e);
                return;
              }
              return (
                u(this, N, !0, 'f'),
                u(this, l, ((c = f(this, l, 'f')), ++c), 'f'),
                {
                  args: i,
            ...
            extendChannelListeners(h, s, e) {
              var n;
              if (f(this, m, 'm', L).call(this, h, s, e))
                return (
                  u(this, N, !0, 'f'),
            ...
            extendTypeListeners(h, s) {
              ...
              let n = [S[h].subscribe];
              for (let [c, i] of s)
                f(this, m, 'm', L).call(this, h, c, i) && n.push(c);
              if (n.length !== 1)
                return (
                  u(this, N, !0, 'f'),
            ...
            unsubscribe(h, s, e, n) {
              ...
              for (let T of i) {
                ...
                if (H) {
                  ...
                  if (
                    (n
                      ? ((I = H.buffers), (F = H.strings))
                      : ((I = H.strings), (F = H.buffers)),
              ...
              if (d.length === 1) {
                for (let T of i) f(a, a, 'm', b).call(a, c.get(T), n).delete(e);
                return;
              }
            ...
            resubscribe() {
              ...
              for (let [e, n] of Object.entries(f(this, y, 'f'))) {
                ...
                let c = () => {
                  var i, d;
                  return (
                    u(this, l, ((d = f(this, l, 'f')), (i = d--), d), 'f'), i
                  );
                };
                s.push({
            ...
            handleMessageReply(h) {
              return S[r.CHANNELS].message.equals(h[0])
                ? (f(this, m, 'm', x).call(this, r.CHANNELS, h[2], h[1]), !0)
                : S[r.PATTERNS].message.equals(h[0])
                ? (f(this, m, 'm', x).call(this, r.PATTERNS, h[3], h[2], h[1]),
                  !0)
                : !!S[r.SHARDED].message.equals(h[0]) &&
                  (f(this, m, 'm', x).call(this, r.SHARDED, h[2], h[1]), !0);
            }
            removeShardedListeners(h) {
              let s = f(this, y, 'f')[r.SHARDED].get(h);
              return (
                f(this, y, 'f')[r.SHARDED].delete(h),
                f(this, m, 'm', B).call(this),
                s
              );
            }
          ...
          (M.PubSub = g),
            ...
            (B = function () {
              u(
                this,
                N,
                f(this, y, 'f')[r.CHANNELS].size !== 0 ||
                  f(this, y, 'f')[r.PATTERNS].size !== 0 ||
                  f(this, y, 'f')[r.SHARDED].size !== 0 ||
                  f(this, l, 'f') !== 0,
                'f'
              );
            }),
            (x = function (C, h, s, e) {
              let n = (e ?? s).toString(),
                c = f(this, y, 'f')[C].get(n);
              if (!c) return;
              for (let T of c.buffers) T(h, s);
              if (!c.strings.size) return;
              let i = e ? s.toString() : n,
                d =
        ...
        53304: function (q, M, k) {
          ...
          var _,
            ...
            e =
              ...
              function (I, F, U, K, Q) {
                ...
                return (
                  K === 'a' ? Q.call(I, U) : Q ? (Q.value = U) : F.set(I, U), U
                );
              };
          Object.defineProperty(M, '__esModule', { value: !0 });
          let n = k(15846),
          ...
          class H extends n.EventEmitter {
            ...
            writeCommand(F) {
              ...
              for (let U of F) e(this, R, !s(this, N, 'f').write(U), 'f');
            }
            disconnect() {
            ...
            async quit(F) {
              ...
              e(this, y, !1, 'f');
              let U = await F();
              return s(this, _, 'm', C).call(this), U;
            }
            cork() {
              !s(this, N, 'f') ||
                s(this, h, 'f') ||
          ...
          (m = H),
            ...
            (x = function (I, F) {
              if (s(this, l, 'f').reconnectStrategy === !1) return !1;
              if (typeof s(this, l, 'f').reconnectStrategy == 'number')
                return s(this, l, 'f').reconnectStrategy;
              if (s(this, l, 'f').reconnectStrategy)
                try {
                  let U = s(this, l, 'f').reconnectStrategy(I, F);
            ...
            (r = function (I, F) {
              let U = s(this, _, 'm', x).call(this, I, F);
              return U === !1
                ? (e(this, y, !1, 'f'), this.emit('error', F), F)
                : U instanceof Error
                ? (e(this, y, !1, 'f'),
                  this.emit('error', F),
                  new d.ReconnectStrategyError(U, F))
                : U;
            }),
            (p = async function () {
              let I = 0;
              do
                try {
                  ...
                  let U = s(this, _, 'm', r).call(this, I++, F);
                  if (typeof U != 'number') throw U;
                  this.emit('error', F),
                    await (0, T.promiseTimeout)(U),
            ...
            (f = function () {
              return new Promise((I, F) => {
                let { connectEvent: U, socket: K } = s(m, m, 'm', E).call(
                  m,
                  s(this, l, 'f')
                )
                  ? s(this, _, 'm', S).call(this)
                  : s(this, _, 'm', u).call(this);
                s(this, l, 'f').connectTimeout &&
                  K.setTimeout(s(this, l, 'f').connectTimeout, () =>
                    K.destroy(new d.ConnectionTimeoutError())
                  ),
                  s(this, B, 'f') && K.unref(),
                  K.setNoDelay(s(this, l, 'f').noDelay)
                    .once('error', F)
                    .once(U, () => {
                      K.setTimeout(0)
                        .setKeepAlive(
                          s(this, l, 'f').keepAlive !== !1,
                          s(this, l, 'f').keepAlive || 0
                        )
                        .off('error', F)
            ...
            (u = function () {
              return {
                ...
                socket: c.connect(s(this, l, 'f')),
              };
            }),
            (S = function () {
              return {
                connectEvent: 'secureConnect',
                socket: i.connect(s(this, l, 'f')),
              };
            }),
            (g = function (I) {
              let F = s(this, L, 'f');
              e(this, L, !1, 'f'),
                ...
                F &&
                  s(this, y, 'f') &&
                  typeof s(this, _, 'm', r).call(this, 0, I) == 'number' &&
                  (this.emit('reconnecting'),
                  s(this, _, 'm', p)
                    .call(this)
                    .catch(() => {}));
        ...
        73663: function (q, M, k) {
          ...
          class Q {
            ...
            getShardedPubSubClient(w) {
              ...
              return A.pubSubClient ?? d(this, _, 'm', i).call(this, A);
            }
          ...
          (m = Q),
            ...
            (R = async function (j) {
              let w = new Set();
              try {
                let A = await d(this, _, 'm', B).call(this, j),
                  W = [],
                  O = d(this, E, 'f').minimizeConnections !== !0;
                for (let { from: o, to: P, master: v, replicas: D } of (d(
                  this,
                  _,
                  'm',
                  L
                ...
                if (this.pubSubNode && !w.has(this.pubSubNode.address))
                  if (F.types.isPromise(this.pubSubNode.client))
                    ...
                    (o.size || P.size) &&
                      W.push(
                        d(this, _, 'm', c).call(this, {
                          [U.PubSubType.CHANNELS]: o,
                          [U.PubSubType.PATTERNS]: P,
                        })
                      );
                  }
                for (let [o, P] of this.nodeByAddress.entries()) {
                  if (w.has(o)) continue;
                  P.client &&
                    W.push(
                      d(this, _, 'm', h).call(this, P.client, (D) =>
                        D.disconnect()
                      )
                    );
                  ...
                  v &&
                    W.push(
                      d(this, _, 'm', h).call(this, v, (D) => D.disconnect())
                    ),
            ...
            (p = function ({ id: j, ip: w, port: A }, W, O, o, P) {
              let v = `${w}:${A}`;
              o.add(v);
              ...
              return (
                D ||
                  ...
                  O && P.push(d(this, _, 'm', u).call(this, D)),
                        ...
                        j &&
                          (await Promise.all([
                            W.extendPubSubListeners(
                              U.PubSubType.CHANNELS,
                              j[U.PubSubType.CHANNELS]
                            ),
                            W.extendPubSubListeners(
                              U.PubSubType.PATTERNS,
                              j[U.PubSubType.PATTERNS]
                            ),
                          ])),
        ...
        87423: function (q, M, k) {
          ...
          class p extends B.EventEmitter {
            ...
            async UNSUBSCRIBE(u, S, g) {
              return l(this, a, 'f').executeUnsubscribeCommand((C) =>
                C.UNSUBSCRIBE(u, S, g)
              );
            }
            ...
            async SSUBSCRIBE(u, S, g) {
              let C = l(this, m, 'f').maxCommandRedirections ?? 16,
                ...
                s = await l(this, a, 'f').getShardedPubSubClient(h);
              for (let e = 0; ; e++)
                try {
                  return await s.SSUBSCRIBE(u, S, g);
                } catch (n) {
                  if (++e > C || !(n instanceof r.ErrorReply)) throw n;
                  if (n.message.startsWith('MOVED')) {
                    await l(this, a, 'f').rediscover(s),
                      (s = await l(this, a, 'f').getShardedPubSubClient(h));
                    continue;
                  }
                  throw n;
          ...
          (m = new WeakMap()),
            ...
            (b = async function (f, u, S) {
              let g = l(this, m, 'f').maxCommandRedirections ?? 16,
                C = await l(this, a, 'f').getClient(f, u);
              for (let h = 0; ; h++)
                try {
                  return await S(C);
                } catch (s) {
                  if (++h > g || !(s instanceof r.ErrorReply)) throw s;
        ...
        53550: function (q, M, k) {
          ...
          var _,
            ...
            E =
              ...
              function (B, x, r, p, f) {
                ...
                return (
                  p === 'a' ? f.call(B, r) : f ? (f.value = r) : x.set(B, r), r
                );
              },
            b =
              (this && this.__classPrivateFieldGet) ||
          ...
          class R {
            ...
            commandsExecutor(x, r) {
              let p = x.transformArguments(...r);
              return (
                E(
                  this,
                  a,
                  b(this, a, 'f') ?? L.default.extractFirstKey(x, r, p),
                  'f'
                ),
            ...
            addCommand(x, r, p) {
              return (
                E(this, a, b(this, a, 'f') ?? x, 'f'),
                b(this, _, 'f').addCommand(r, p),
                this
              );
            }
            functionsExecutor(x, r, p) {
              let f = b(this, _, 'f').addFunction(p, x, r);
              return (
                E(
                  this,
                  a,
                  b(this, a, 'f') ?? L.default.extractFirstKey(x, r, f),
                  'f'
                ),
                this
              );
            ...
            scriptsExecutor(x, r) {
              let p = b(this, _, 'f').addScript(x, r);
              return (
                E(
                  this,
                  a,
          ...
          var k,
            ...
            S =
              ...
              function (h, s, e, n, c) {
                ...
                if (typeof s == 'function' ? h !== s || !c : !s.has(h))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  n === 'a' ? c.call(h, e) : c ? (c.value = e) : s.set(h, e), e
                );
              },
            g =
              (this && this.__classPrivateFieldGet) ||
          ...
          class C {
            ...
            async query(s, e) {
              return g(this, _, 'm', B).call(
                this,
                await g(this, m, 'f').graph.query(g(this, a, 'f'), s, e, !0)
              );
            }
            async roQuery(s, e) {
              return g(this, _, 'm', B).call(
                this,
                await g(this, m, 'f').graph.roQuery(g(this, a, 'f'), s, e, !0)
              );
            }
          }
          (m = new WeakMap()),
            ...
            (R = async function (h, s) {
              let e = (await g(this, _, 'm', l).call(this))[h][s];
              if (e === void 0)
                ...
                e = {
                  ...
                  data: h.data.map((n) => {
                    ...
                    for (let i = 0; i < n.length; i++)
                      c[h.headers[i][1]] = g(this, _, 'm', x).call(
                        this,
                        n[i],
                        s
                      );
            ...
            (x = function h([s, e], n) {
              switch (s) {
                ...
                case u.DOUBLE:
                  return parseFloat(e);
                case u.ARRAY:
                  return e.map((i) => g(this, _, 'm', h).call(this, i, n));
                case u.EDGE:
                  return g(this, _, 'm', r).call(this, e, n);
                case u.NODE:
                  return g(this, _, 'm', p).call(this, e, n);
                case u.PATH:
                  return {
                    nodes: e[0][1].map(([, i]) =>
                      g(this, _, 'm', p).call(this, i, n)
                    ),
                    edges: e[1][1].map(([, i]) =>
                      g(this, _, 'm', r).call(this, i, n)
                    ),
                  };
                case u.MAP:
                  let c = {};
                  for (let i = 0; i < e.length; i++)
                    c[e[i++]] = g(this, _, 'm', h).call(this, e[i], n);
                  return c;
                case u.POINT:
                  return {
            ...
            (r = function ([h, s, e, n, c], i) {
              let d = {
                  id: h,
                  sourceId: e,
                  destinationId: n,
                  properties: g(this, _, 'm', f).call(this, c, i),
                },
                T = g(this, _, 'm', L).call(this, 'relationshipTypes', s);
              return (
                T instanceof Promise
                  ? i.push(T.then((H) => (d.relationshipType = H)))
            ...
            (p = function ([h, s, e], n) {
              ...
              for (let i = 0; i < s.length; i++) {
                let d = g(this, _, 'm', L).call(this, 'labels', s[i]);
                d instanceof Promise
                  ? n.push(d.then((T) => (c[i] = T)))
                  : (c[i] = d);
              }
              return {
                id: h,
            ...
            (f = function (h, s) {
              let e = {};
              for (let [n, c, i] of h) {
                let d = g(this, _, 'm', x).call(this, [c, i], s),
                  T = g(this, _, 'm', L).call(this, 'propertyKeys', n);
                T instanceof Promise
                  ? s.push(T.then((H) => (e[H] = d)))
                  : (e[T] = d);
              }
              return e;
            }),
              ...
              (Object.create
                ? function (R, B, x, r) {
                    ...
                    (!p ||
                      ...
                      Object.defineProperty(R, r, p);
                  }
                : function (R, B, x, r) {
                    r === void 0 && (r = x), (R[r] = B[x]);
                  }),
            m =
              (this && this.__exportStar) ||
              function (R, B) {
    ...
    ($.webpackChunk_N_E = $.webpackChunk_N_E || []).push([
      [5569],
      {
        ...
        86421: (q, M, k) => {
          'use strict';
          k.r(M), k.d(M, { ComponentMod: () => s, default: () => e });
          var _ = {};
          k.r(_), k.d(_, { POST: () => p, runtime: () => R });
          var m = {};
          k.r(m),
            k.d(m, {
              originalPathname: () => C,
          ...
          var a = k(6773),
            ...
            L = k(10611);
          let R = 'edge',
            B = process.env.NEXT_PUBLIC_STORAGE_TYPE || 'localstorage';
          async function x(n, c) {
            ...
            return Array.from(
              new Uint8Array(await crypto.subtle.sign('HMAC', H, T))
            )
              .map((I) => I.toString(16).padStart(2, '0'))
              .join('');
          }
          async function r(n) {
            let c = { role: 'user', username: n, timestamp: Date.now() },
              i = process.env.PASSWORD || '',
              d = await x(n, i);
            return (c.signature = d), encodeURIComponent(JSON.stringify(c));
          }
          async function p(n) {
            try {
              if (B === 'localstorage')
              ...
              let c = await (0, y.iE)();
              if (!c.UserConfig.AllowRegister)
                return N.xk.json(
                  { error: '\u5F53\u524D\u672A\u5F00\u653E\u6CE8\u518C' },
                  { status: 400 }
                );
              let { username: i, password: d } = await n.json();
              ...
              if (i === process.env.USERNAME)
                return N.xk.json(
                  { error: '\u7528\u6237\u5DF2\u5B58\u5728' },
                  { status: 400 }
                );
              try {
                if (await L.db.checkUserExist(i))
                  return N.xk.json(
                    { error: '\u7528\u6237\u5DF2\u5B58\u5728' },
                    { status: 400 }
                  );
                await L.db.registerUser(i, d),
                  c.UserConfig.Users.push({ username: i, role: 'user' }),
                  await L.db.saveAdminConfig(c);
                let T = N.xk.json({ ok: !0 }),
                  H = await r(i),
                  I = new Date();
                return (
                  I.setDate(I.getDate() + 7),
                  T.cookies.set('auth', H, {
                    path: '/',
                    expires: I,
                    sameSite: 'lax',
                    httpOnly: !1,
          ...
          let f = new E.AppRouteRouteModule({
              ...
              resolvedPagePath:
                '/Volumes/OS/Users/wangbengang/Documents/moontv/MoonTV/src/app/api/register/route.ts',
      ...
      (q) => {
        var M = (_) => q((q.s = _));
        q.O(0, [5300, 7304, 366, 4292, 3664], () => M(86421));
        var k = q.O();
        (V._ENTRIES = typeof V._ENTRIES > 'u' ? {} : V._ENTRIES)[
          'middleware_app/api/register/route'
        ] = k;
      },
    ]),
    function () {
      ...
      return (
        (function (k, _) {
          ...
          var m = Object.defineProperty,
            ...
            l = (e, n) => {
              for (var c in n) m(e, c, { get: n[c], enumerable: !0 });
            },
            N = (e, n, c, i) => {
              if ((n && typeof n == 'object') || typeof n == 'function')
                for (let d of E(n))
                  !b.call(e, d) &&
                    ...
                    m(e, d, {
                      get: () => n[d],
                      enumerable: !(i = a(n, d)) || i.enumerable,
                    });
              return e;
            },
          ...
          function S(e) {
            ...
            return (
              e &&
                e.forEach((c, i) => {
                  (n[i] = c), i.toLowerCase() === 'set-cookie' && (n[i] = g(c));
                }),
              n
            );
          }
          function g(e) {
            ...
            function U() {
              return (d = e.charAt(c)), d !== '=' && d !== ';' && d !== ',';
            }
            for (; c < e.length; ) {
              for (i = c, I = !1; F(); )
                if (((d = e.charAt(c)), d === ',')) {
                  for (T = c, c += 1, F(), H = c; c < e.length && U(); ) c += 1;
                  c < e.length && e.charAt(c) === '='
                    ? ((I = !0), (c = H), n.push(e.substring(i, T)), (i = c))
                    : (c = T + 1);
                } else c += 1;
              (!I || c >= e.length) && n.push(e.substring(i, e.length));
            }
            return n;
          }
          function C(e) {
            ...
            return async function (i, d) {
              ...
              if (!H.name) {
                ...
                for (let U of c || []) {
                  ...
                  let K = U.regexp.exec(T);
                  if (K) {
                    H = { name: U.page, params: K.groups };
                    break;
                  }
                }
              }
                ...
                V._ENTRIES[`middleware_${e.name}`].default.call(
                  {},
                  {
                    request: {
                      ...
                      method: i.method,
                      headers: S(i.headers),
                      ip: h(i.headers, 'x-real-ip'),
                      geo: {
                        city: h(i.headers, 'x-vercel-ip-city', !0),
                        country: h(i.headers, 'x-vercel-ip-country', !0),
                        latitude: h(i.headers, 'x-vercel-ip-latitude'),
                        longitude: h(i.headers, 'x-vercel-ip-longitude'),
                        region: h(i.headers, 'x-vercel-ip-country-region', !0),
                      },
          ...
          function h(e, n, c = !1) {
            ...
            return c && i ? decodeURIComponent(i) : i;
          }
          function s(e) {
