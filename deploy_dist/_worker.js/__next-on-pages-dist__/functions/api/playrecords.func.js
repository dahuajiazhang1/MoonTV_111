...
var q = globalThis.__nextOnPagesRoutesIsolation.getProxyFor('/api/playrecords'),
  Ct = pt(q, q, q),
  Pt = Ct.__chunk_52387,
  rt = bt(q, q, q),
  xt = rt.__chunk_67550,
  ...
  $a = ((K, V, tt) => (
      ...
      (k.m = G),
        ...
        (() => {
          ...
          k.O = (m, o, E, b) => {
            ...
            for (var S = 1 / 0, l = 0; l < _.length; l++) {
              for (var [o, E, b] = _[l], y = !0, L = 0; L < o.length; L++)
                S >= b && Object.keys(k.O).every((f) => k.O[f](o[L]))
                  ? o.splice(L--, 1)
                  : ((y = !1), b < S && (S = b));
              if (y) {
                _.splice(l--, 1);
      ...
      [7304],
      {
                  ...
                  new v.default({
                    ...
                    onReply: (a) => {
                      if (i(this, y, 'f').isActive && Array.isArray(a)) {
                        ...
                        if (h.equals(a[0])) {
                          let { resolve: A, returnBuffers: D } = i(
                              this,
                              l,
                              'f'
                            ).shift(),
                            j = a[1].length === 0 ? a[0] : a[1];
                          A(D ? j : j.toString());
                          return;
                        }
                      }
        ...
        85366: function (G, U, k) {
          ...
          var _,
            ...
            n =
              ...
              function (I, r, x, C) {
                ...
                if (typeof r == 'function' ? I !== r || !C : !r.has(I))
                  throw TypeError(
                    'Cannot read private member from an object whose class did not declare it'
                  );
                return x === 'm'
            ...
            s =
              ...
              function (I, r, x, C, F) {
                ...
                return (
                  C === 'a' ? F.call(I, x) : F ? (F.value = x) : r.set(I, x), x
                );
              };
          Object.defineProperty(U, '__esModule', { value: !0 });
          let a = k(76486),
          ...
          class W extends A.EventEmitter {
            ...
            constructor(r) {
              super(),
                ...
                s(this, b, n(this, _, 'm', N).call(this), 'f'),
            ...
            async commandsExecutor(r, x) {
              let { args: C, options: F } = (0, j.transformCommandArguments)(
                r,
                x
              );
            ...
            sendCommand(r, x) {
              return n(this, _, 'm', g).call(this, r, x);
            }
            async functionsExecuter(r, x, C) {
              let { args: F, options: z } = (0, j.transformCommandArguments)(
                r,
                x
              );
              return (0, j.transformCommandReply)(
                r,
                await this.executeFunction(C, r, F, z),
                F.preserve
              );
            }
            executeFunction(r, x, C, F) {
              return n(this, _, 'm', g).call(
                this,
                (0, j.fCallArguments)(r, x, C),
                F
              );
            }
            async scriptsExecuter(r, x) {
              ...
              return (0, j.transformCommandReply)(
                r,
                await this.executeScript(r, C, F),
                C.preserve
              );
            }
            ...
            async SELECT(r, x) {
              (0, D.isCommandOptions)(r) || ((x = r), (r = null)),
            ...
            async multiExecutor(r, x, C) {
              ...
              n(this, _, 'm', h).call(this);
              let z = await F;
              return x !== void 0 && s(this, y, x, 'f'), z;
            }
            async *scanIterator(r) {
              let x = 0;
              do {
                let C = await this.scan(x, r);
                for (let F of ((x = C.cursor), C.keys)) yield F;
              } while (x !== 0);
            }
            async *hScanIterator(r, x) {
              let C = 0;
              do {
                let F = await this.hScan(r, C, x);
                for (let z of ((C = F.cursor), F.tuples)) yield z;
              } while (C !== 0);
            }
            async *hScanNoValuesIterator(r, x) {
              let C = 0;
              do {
                let F = await this.hScanNoValues(r, C, x);
                for (let z of ((C = F.cursor), F.keys)) yield z;
              } while (C !== 0);
            }
            async *sScanIterator(r, x) {
              let C = 0;
              do {
                let F = await this.sScan(r, C, x);
                for (let z of ((C = F.cursor), F.members)) yield z;
              } while (C !== 0);
            }
            async *zScanIterator(r, x) {
              let C = 0;
              do {
                let F = await this.zScan(r, C, x);
                for (let z of ((C = F.cursor), F.members)) yield z;
              } while (C !== 0);
            }
            async disconnect() {
          ...
          (m = W),
            ...
            (L = function (I) {
              ...
              return I?.database && s(this, y, I.database, 'f'), I;
            }),
            (N = function () {
            ...
            (i = function () {
              var I;
              if (n(this, o, 'f')?.legacyMode) {
                for (let [r, x] of ((n(this, S, 'f').sendCommand = n(
                  this,
                  _,
                  'm',
                  g
            ...
            (p = function (...I) {
              let r = typeof I[I.length - 1] == 'function' ? I.pop() : void 0,
                x = n(this, _, 'm', g).call(
                  this,
                  (0, j.transformLegacyCommandArguments)(I)
                );
              if (r) return { promise: x, callback: r };
              x.catch((C) => this.emit('error', C));
            }),
            (f = function (I, r) {
              (n(this, S, 'f')[I] = this[I].bind(this)),
                (this[I] =
                  r && r.TRANSFORM_LEGACY_REPLY && r.transformReply
                    ? (...x) => {
                        let C = n(this, _, 'm', p).call(this, I, ...x);
                        C &&
                          C.promise
                            .then((F) => C.callback(null, r.transformReply(F)))
                            .catch((F) => C.callback(F));
                      }
                    : (...x) => this.sendCommand(I, ...x));
            }),
            (v = function I() {
            ...
            (g = function (I, r) {
              ...
              let x = n(this, b, 'f').addCommand(I, r);
              return n(this, _, 'm', h).call(this), x;
            }),
            (P = function (I) {
              return I === void 0
                ? Promise.resolve()
                : (n(this, _, 'm', h).call(this), I);
            }),
            (h = function (I = !1) {
              if (
        ...
        39460: function (G, U, k) {
          ...
          var _,
            ...
            S =
              ...
              function (i, p, f, u, v) {
                ...
                return (
                  u === 'a' ? v.call(i, f) : v ? (v.value = f) : p.set(i, f), f
                );
              },
            y =
              (this && this.__classPrivateFieldGet) ||
          ...
          class R {
            ...
            SELECT(p, f) {
              return (
                S(this, E, p, 'f'), this.addCommand(['SELECT', p.toString()], f)
              );
            }
            addCommand(p, f) {
            ...
            unsubscribe(h, c, e, n) {
              ...
              for (let T of a) {
                ...
                if (H) {
                  ...
                  if (
                    (n
                      ? ((A = H.buffers), (D = H.strings))
                      : ((A = H.strings), (D = H.buffers)),
                    (A.has(e) ? A.size - 1 : A.size) !== 0 || D.size !== 0)
                  )
                    continue;
                  H.unsubscribing = !0;
                }
        ...
        53304: function (G, U, k) {
          ...
          var _,
            ...
            c =
              ...
              function (A, D, j, $) {
                ...
                if (typeof D == 'function' ? A !== D || !$ : !D.has(A))
                  throw TypeError(
                    'Cannot read private member from an object whose class did not declare it'
                  );
                return j === 'm'
            ...
            e =
              ...
              function (A, D, j, $, Q) {
                ...
                if (typeof D == 'function' ? A !== D || !Q : !D.has(A))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  $ === 'a' ? Q.call(A, j) : Q ? (Q.value = j) : D.set(A, j), j
                );
              };
          Object.defineProperty(U, '__esModule', { value: !0 });
          let n = k(15846),
          ...
          class H extends n.EventEmitter {
            ...
            writeCommand(D) {
              if (!c(this, S, 'f')) throw new d.ClientClosedError();
              for (let j of D) e(this, N, !c(this, S, 'f').write(j), 'f');
            }
            disconnect() {
            ...
            async quit(D) {
              ...
              e(this, y, !1, 'f');
              let j = await D();
              return c(this, _, 'm', P).call(this), j;
            }
            cork() {
              !c(this, S, 'f') ||
                c(this, h, 'f') ||
                ...
                e(this, h, !0, 'f'),
                setImmediate(() => {
                  c(this, S, 'f')?.uncork(), e(this, h, !1, 'f');
                }));
            }
            ref() {
              e(this, B, !1, 'f'), c(this, S, 'f')?.ref();
            }
            unref() {
              e(this, B, !0, 'f'), c(this, S, 'f')?.unref();
            }
          }
          (m = H),
            (b = new WeakMap()),
            ...
            (o = function (A) {
              ...
              return (
                A ?? (A = {}),
                A.path ||
                  ((D = A).port ?? (D.port = 6379),
                  (j = A).host ?? (j.host = 'localhost')),
            ...
            (R = function (A, D) {
              ...
              if (c(this, l, 'f').reconnectStrategy)
                try {
                  let j = c(this, l, 'f').reconnectStrategy(A, D);
            ...
            (i = function (A, D) {
              let j = c(this, _, 'm', R).call(this, A, D);
              return j === !1
                ? (e(this, y, !1, 'f'), this.emit('error', D), D)
                : j instanceof Error
                ? (e(this, y, !1, 'f'),
                  this.emit('error', D),
                  new d.ReconnectStrategyError(j, D))
                : j;
            }),
            (p = async function () {
              let A = 0;
              do
                try {
                  e(this, S, await c(this, _, 'm', f).call(this), 'f'),
                    e(this, N, !1, 'f'),
                    this.emit('connect');
                  try {
                    ...
                    throw (
                      (c(this, S, 'f').destroy(), e(this, S, void 0, 'f'), D)
                    );
                  }
                  e(this, L, !0, 'f'), this.emit('ready');
                } catch (D) {
                  let j = c(this, _, 'm', i).call(this, A++, D);
                  if (typeof j != 'number') throw j;
                  this.emit('error', D),
                    await (0, T.promiseTimeout)(j),
            ...
            (f = function () {
              return new Promise((A, D) => {
                let { connectEvent: j, socket: $ } = c(m, m, 'm', E).call(
                  m,
                  c(this, l, 'f')
                )
                ...
                c(this, l, 'f').connectTimeout &&
                  $.setTimeout(c(this, l, 'f').connectTimeout, () =>
                    $.destroy(new d.ConnectionTimeoutError())
                  ),
                  c(this, B, 'f') && $.unref(),
            ...
            (P = function () {
              e(this, L, !1, 'f'),
                c(this, S, 'f') &&
                  (c(this, S, 'f').destroy(), e(this, S, void 0, 'f')),
                this.emit('end');
            }),
            (U.default = H);
        },
        73663: function (G, U, k) {
          ...
          var _,
            ...
            T =
              ...
              function (M, w, O, W, I) {
                ...
                if (typeof w == 'function' ? M !== w || !I : !w.has(M))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  W === 'a' ? I.call(M, O) : I ? (I.value = O) : w.set(M, O), O
                );
              };
          Object.defineProperty(U, '__esModule', { value: !0 });
          let H = k(85366),
          ...
          class Q {
            ...
            async connect() {
              if (d(this, S, 'f')) throw Error('Cluster already open');
              T(this, S, !0, 'f');
              try {
                await d(this, _, 'm', y).call(this);
              } catch (w) {
                throw (T(this, S, !1, 'f'), w);
              }
            }
            nodeClient(w) {
          ...
          (m = Q),
            ...
            (N = async function (M) {
              ...
              try {
                ...
                for (let { from: r, to: x, master: C, replicas: F } of (d(
                  this,
                  _,
                  'm',
                  L
                ...
                O)) {
                  let z = {
                    master: d(this, _, 'm', p).call(this, C, !1, I, w, W),
                  };
                  d(this, E, 'f').useReplicas &&
                    ...
                    this.shards.push(z);
                  for (let J = r; J <= x; J++) this.slots[J] = z;
                }
                if (this.pubSubNode && !w.has(this.pubSubNode.address))
                  if (D.types.isPromise(this.pubSubNode.client))
                    ...
                    (r.size || x.size) &&
                      W.push(
                        d(this, _, 'm', s).call(this, {
                          [j.PubSubType.CHANNELS]: r,
                          [j.PubSubType.PATTERNS]: x,
                        })
                      );
                  }
                for (let [r, x] of this.nodeByAddress.entries()) {
                  ...
                  x.client &&
                    W.push(
                      d(this, _, 'm', h).call(this, x.client, (F) =>
                        F.disconnect()
                      )
                    );
            ...
            (p = function ({ id: M, ip: w, port: O }, W, I, r, x) {
              let C = `${w}:${O}`;
              r.add(C);
              ...
              return (
                F ||
                  ...
                  I && x.push(d(this, _, 'm', u).call(this, F)),
            ...
            (g = async function (M) {
              if (!(await d(this, _, 'm', N).call(this, M.options)))
              ...
              for (let { master: O, replicas: W } of this.shards)
                if (
                  ...
                  for (let { client: I } of W)
                    I && w.push(d(this, _, 'm', h).call(this, I, M));
              this.pubSubNode &&
                (w.push(
            ...
            (a = function (M) {
              let w = d(this, _, 'm', f)
                ...
                .then(
                  (O) => (
                    O.on('server-sunsubscribe', async (W, I) => {
                      try {
          ...
          var _,
            ...
            S =
              ...
              function (f, u, v, g, P) {
                ...
                return (
                  g === 'a' ? P.call(f, v) : P ? (P.value = v) : u.set(f, v), v
                );
              };
          Object.defineProperty(U, '__esModule', { value: !0 });
          let y = k(53817),
          ...
          class p extends B.EventEmitter {
            ...
            constructor(u) {
              super(),
                ...
                S(this, m, u, 'f'),
                S(this, o, new L.default(u, this.emit.bind(this)), 'f'),
                S(this, E, R.default.extend(u), 'f');
            }
            duplicate(u) {
              return new (Object.getPrototypeOf(this).constructor)({
                ...l(this, m, 'f'),
            ...
            async commandsExecutor(u, v) {
              let {
                jsArgs: g,
                args: P,
                options: h,
              } = (0, N.transformCommandArguments)(u, v);
            ...
            async sendCommand(u, v, g, P) {
              return l(this, _, 'm', b).call(this, u, v, (h) =>
                h.sendCommand(g, P)
              );
            }
            async functionsExecutor(u, v, g) {
              let { args: P, options: h } = (0, N.transformCommandArguments)(
                u,
                v
              );
              return (0, N.transformCommandReply)(
                u,
                await this.executeFunction(g, u, v, P, h),
                P.preserve
              );
            }
            async executeFunction(u, v, g, P, h) {
              return l(this, _, 'm', b).call(
                this,
                p.extractFirstKey(v, g, P),
                v.IS_READ_ONLY,
                (c) => c.executeFunction(u, v, P, h)
              );
            }
            async scriptsExecutor(u, v) {
              ...
              return (0, N.transformCommandReply)(
                u,
                await this.executeScript(u, v, g, P),
                g.preserve
              );
            }
            async executeScript(u, v, g, P) {
              return l(this, _, 'm', b).call(
                this,
                p.extractFirstKey(u, v, g),
                u.IS_READ_ONLY,
            ...
            async UNSUBSCRIBE(u, v, g) {
              return l(this, o, 'f').executeUnsubscribeCommand((P) =>
                P.UNSUBSCRIBE(u, v, g)
              );
            }
            async PSUBSCRIBE(u, v, g) {
          ...
          var _,
            ...
            E =
              ...
              function (B, R, i, p, f) {
                ...
                if (typeof R == 'function' ? B !== R || !f : !R.has(B))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  p === 'a' ? f.call(B, i) : f ? (f.value = i) : R.set(B, i), i
                );
              },
            b =
              (this && this.__classPrivateFieldGet) ||
            ...
            commandsExecutor(R, i) {
              ...
              return (
                E(
                  this,
                  o,
                  b(this, o, 'f') ?? L.default.extractFirstKey(R, i, p),
                  'f'
                ),
            ...
            functionsExecutor(R, i, p) {
              ...
              return (
                E(
                  this,
                  o,
                  b(this, o, 'f') ?? L.default.extractFirstKey(R, i, f),
                  'f'
                ),
                this
              );
        ...
        89601: function (G, U) {
          ...
          (m = new WeakMap()),
                ...
                e = {
                  ...
                  data: h.data.map((n) => {
                    ...
                    for (let a = 0; a < n.length; a++)
                      s[h.headers[a][1]] = g(this, _, 'm', R).call(
                        this,
                        n[a],
                        c
                      );
            ...
            (f = function (h, c) {
              let e = {};
              for (let [n, s, a] of h) {
                let d = g(this, _, 'm', R).call(this, [s, a], c),
        ...
        95514: function (G, U, k) {
          ...
          var _ =
              ...
              (Object.create
                ? function (N, B, R, i) {
                    i === void 0 && (i = R);
                    var p = Object.getOwnPropertyDescriptor(B, R);
                    (!p ||
                      ('get' in p
                        ? !B.__esModule
            ...
            m =
              ...
              function (N, B) {
                for (var R in N)
                  R === 'default' ||
                    Object.prototype.hasOwnProperty.call(B, R) ||
                    _(B, N, R);
              };
          Object.defineProperty(U, '__esModule', { value: !0 }),
          ...
          (U.createClient = function (N) {
            return (0, o.createClient)({
              ...N,
              modules: { ...L, ...N?.modules },
            });
          }),
            (U.createCluster = function (N) {
    ...
    (K.webpackChunk_N_E = K.webpackChunk_N_E || []).push([
        ...
        96708: (G, U, k) => {
          ...
          async function R(n) {
            try {
              ...
              let d = await N.db.getAllPlayRecords(s.username);
              return S.xk.json(d, { status: 200 });
            } catch (s) {
              return (
                console.error(
                  '\u83B7\u53D6\u64AD\u653E\u8BB0\u5F55\u5931\u8D25',
                ...
                S.xk.json({ error: 'Internal Server Error' }, { status: 500 })
              );
            }
          }
          async function i(n) {
            try {
              ...
              let { key: d, record: T } = await n.json();
              if (!d || !T)
                return S.xk.json(
                  { error: 'Missing key or record' },
                  { status: 400 }
                );
              if (!T.title || !T.source_name || T.index < 1)
                return S.xk.json(
              ...
              let D = { ...T, save_time: T.save_time ?? Date.now() };
              return (
                await N.db.savePlayRecord(s.username, H, A, D),
                S.xk.json({ success: !0 }, { status: 200 })
              );
            } catch (s) {
              return (
                console.error(
          ...
          async function p(n) {
            try {
              ...
              if (H) {
                ...
                await N.db.deletePlayRecord(d, A, D);
              } else {
                let A = await N.db.getAllPlayRecords(d);
                await Promise.all(
                  Object.keys(A).map(async (D) => {
                    let [j, $] = D.split('+');
                    j && $ && (await N.db.deletePlayRecord(d, j, $));
                  })
                );
              }
              return S.xk.json({ success: !0 }, { status: 200 });
            } catch (s) {
              return (
                console.error(
                  '\u5220\u9664\u64AD\u653E\u8BB0\u5F55\u5931\u8D25',
          ...
          let f = new E.AppRouteRouteModule({
              definition: {
                kind: b.x.APP_ROUTE,
                page: '/api/playrecords/route',
                pathname: '/api/playrecords',
                filename: 'route',
                bundlePath: 'app/api/playrecords/route',
              },
              resolvedPagePath:
                '/Volumes/OS/Users/wangbengang/Documents/moontv/MoonTV/src/app/api/playrecords/route.ts',
      ...
      (G) => {
        var U = (_) => G((G.s = _));
        G.O(0, [5300, 7304, 366, 4292, 3664], () => U(96708));
        var k = G.O();
        (V._ENTRIES = typeof V._ENTRIES > 'u' ? {} : V._ENTRIES)[
          'middleware_app/api/playrecords/route'
        ] = k;
      },
    ]),
    function () {
        ...
        (function (k, _) {
          ...
          function g(e) {
            ...
            for (; s < e.length; ) {
              for (a = s, A = !1; D(); )
                if (((d = e.charAt(s)), d === ',')) {
                  for (T = s, s += 1, D(), H = s; s < e.length && j(); ) s += 1;
          ...
          function P(e) {
            ...
            return async function (a, d) {
              ...
              if (!H.name) {
                let D = c(T);
                for (let j of s || []) {
                  if (D && !c(j.page)) continue;
                  let $ = j.regexp.exec(T);
                  if ($) {
                    H = { name: j.page, params: $.groups };
                    break;
                  }
                }
              }
      ...
      .call({})
      .default({
        name: 'app/api/playrecords/route',
        staticRoutes: [
          {
            page: '/',
            regex: '^/(?:/)?$',
