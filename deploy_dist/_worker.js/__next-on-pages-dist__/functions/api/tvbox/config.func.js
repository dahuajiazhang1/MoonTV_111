    ...
    if ((Q && typeof Q == 'object') || typeof Q == 'function')
      for (let j of kt(Q))
        !ft.call($, j) &&
          ...
          ut($, j, {
            get: () => Q[j],
            enumerable: !(K = lt(Q, j)) || K.enumerable,
          });
    return $;
  },
...
var X =
    globalThis.__nextOnPagesRoutesIsolation.getProxyFor('/api/tvbox/config'),
  rt = pt(X, X, X),
  St = rt.__chunk_67550,
  Ct = rt.__chunk_21892,
  t = bt(X, X, X),
  ...
  Da = (($, Q, tt) => (
      ...
      (k.m = K),
        ...
        (() => {
          ...
          k.O = (m, r, E, b) => {
            ...
            for (var T = 1 / 0, a = 0; a < _.length; a++) {
              for (var [r, E, b] = _[a], g = !0, U = 0; U < r.length; U++)
      ...
      [7304],
      {
          ...
          class c {
                  ...
                  new v.default({
                    ...
                    onReply: (l) => {
                      if (u(this, g, 'f').isActive && Array.isArray(l)) {
                        ...
                        if (s.equals(l[0])) {
                          let { resolve: L, returnBuffers: F } = u(
                              this,
                              a,
                              'f'
                            ).shift(),
                      ...
                      let { resolve: d, reject: I } = u(this, a, 'f').shift();
            ...
            subscribe(n, o, l, d) {
              return u(this, _, 'm', M).call(
                this,
                u(this, g, 'f').subscribe(n, o, l, d)
              );
            }
            unsubscribe(n, o, l, d) {
              return u(this, _, 'm', M).call(
                this,
                u(this, g, 'f').unsubscribe(n, o, l, d)
              );
            }
            resubscribe() {
            ...
            extendPubSubChannelListeners(n, o, l) {
              return u(this, _, 'm', M).call(
                this,
                u(this, g, 'f').extendChannelListeners(n, o, l)
              );
            }
            extendPubSubListeners(n, o) {
              return u(this, _, 'm', M).call(
                this,
                u(this, g, 'f').extendTypeListeners(n, o)
              );
            }
        ...
        85366: function (K, j, k) {
          ...
          var _,
            ...
            n =
              ...
              function (O, i, P, S) {
                ...
                if (typeof i == 'function' ? O !== i || !S : !i.has(O))
                  throw TypeError(
                    'Cannot read private member from an object whose class did not declare it'
                  );
                return P === 'm'
            ...
            o =
              ...
              function (O, i, P, S, D) {
                ...
                if (typeof i == 'function' ? O !== i || !D : !i.has(O))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  S === 'a' ? D.call(O, P) : D ? (D.value = P) : i.set(O, P), P
                );
              };
          Object.defineProperty(j, '__esModule', { value: !0 });
          let l = k(76486),
          ...
          class W extends L.EventEmitter {
            ...
            async commandsExecutor(i, P) {
              let { args: S, options: D } = (0, B.transformCommandArguments)(
                i,
                P
              );
              return (0, B.transformCommandReply)(
                i,
                await n(this, _, 'm', y).call(this, S, D),
                S.preserve
              );
            }
            sendCommand(i, P) {
              return n(this, _, 'm', y).call(this, i, P);
            }
            async functionsExecuter(i, P, S) {
              let { args: D, options: G } = (0, B.transformCommandArguments)(
                i,
                P
              );
              return (0, B.transformCommandReply)(
                i,
                await this.executeFunction(S, i, D, G),
                D.preserve
              );
            }
            ...
            async executeScript(i, P, S) {
              ...
              i.NUMBER_OF_KEYS !== void 0 &&
                ...
                D.push(...P);
              try {
                return await n(this, _, 'm', y).call(this, D, S);
              } catch (G) {
                if (!G?.message?.startsWith?.('NOSCRIPT')) throw G;
                return (
                  (D[0] = 'EVAL'),
                  (D[1] = i.SCRIPT),
                  n(this, _, 'm', y).call(this, D, S)
                );
              }
            }
            async SELECT(i, P) {
            ...
            SUBSCRIBE(i, P, S) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').subscribe(w.PubSubType.CHANNELS, i, P, S)
              );
            }
            UNSUBSCRIBE(i, P, S) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').unsubscribe(w.PubSubType.CHANNELS, i, P, S)
              );
            }
            PSUBSCRIBE(i, P, S) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').subscribe(w.PubSubType.PATTERNS, i, P, S)
              );
            }
            PUNSUBSCRIBE(i, P, S) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').unsubscribe(w.PubSubType.PATTERNS, i, P, S)
              );
            }
            SSUBSCRIBE(i, P, S) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').subscribe(w.PubSubType.SHARDED, i, P, S)
              );
            }
            SUNSUBSCRIBE(i, P, S) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').unsubscribe(w.PubSubType.SHARDED, i, P, S)
              );
            }
            ...
            extendPubSubChannelListeners(i, P, S) {
              return n(this, _, 'm', C).call(
                this,
                n(this, b, 'f').extendPubSubChannelListeners(i, P, S)
              );
            }
            ...
            async *hScanIterator(i, P) {
              ...
              do {
                ...
                for (let G of ((S = D.cursor), D.tuples)) yield G;
              } while (S !== 0);
            }
            async *hScanNoValuesIterator(i, P) {
              ...
              do {
                ...
                for (let G of ((S = D.cursor), D.keys)) yield G;
              } while (S !== 0);
            }
            async *sScanIterator(i, P) {
              ...
              do {
                ...
                for (let G of ((S = D.cursor), D.members)) yield G;
              } while (S !== 0);
            }
          ...
          (m = W),
            ...
            (U = function (O) {
              ...
              return O?.database && o(this, g, O.database, 'f'), O;
            }),
            (N = function () {
                  ...
                  n(this, r, 'f')?.disableClientInfo ||
                    (i.push(
                      n(this, b, 'f')
                        ...
                        .catch((S) => {
                          if (!(S instanceof Y.ErrorReply)) throw S;
                        })
                    ),
                    i.push(
                      n(this, b, 'f')
            ...
            (u = function () {
              ...
              if (n(this, r, 'f')?.legacyMode) {
                ...
                (this.sendCommand = (...S) => {
                  let D = n(this, _, 'm', p).call(this, ...S);
                  D &&
                    D.promise
            ...
            (f = function (O, i) {
              (n(this, T, 'f')[O] = this[O].bind(this)),
                (this[O] =
                  i && i.TRANSFORM_LEGACY_REPLY && i.transformReply
                    ? (...P) => {
                        let S = n(this, _, 'm', p).call(this, O, ...P);
                        S &&
                          S.promise
        ...
        53304: function (K, j, k) {
          ...
          var _,
            ...
            e =
              ...
              function (L, F, B, q, Y) {
                ...
                return (
                  q === 'a' ? Y.call(L, B) : Y ? (Y.value = B) : F.set(L, B), B
                );
              };
          Object.defineProperty(j, '__esModule', { value: !0 });
          let n = k(15846),
          ...
          (m = H),
            ...
            (u = function (L, F) {
              let B = c(this, _, 'm', x).call(this, L, F);
              return B === !1
            ...
            (p = async function () {
              ...
              do
                try {
                  ...
                  let B = c(this, _, 'm', u).call(this, L++, F);
        ...
        73663: function (K, j, k) {
          ...
          var _,
            ...
            d =
              ...
              function (R, w, A, W) {
                ...
                if (typeof w == 'function' ? R !== w || !W : !w.has(R))
                  throw TypeError(
                    'Cannot read private member from an object whose class did not declare it'
                  );
                return A === 'm'
            ...
            I =
              ...
              function (R, w, A, W, O) {
                ...
                if (typeof w == 'function' ? R !== w || !O : !w.has(R))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  W === 'a' ? O.call(R, A) : O ? (O.value = A) : w.set(R, A), A
                );
              };
          Object.defineProperty(j, '__esModule', { value: !0 });
          let H = k(85366),
          ...
          (m = Y),
            ...
            (g = async function () {
              ...
              for (let w = R; w < d(this, E, 'f').rootNodes.length; w++)
                if (
            ...
            (N = async function (R) {
              let w = new Set();
              try {
                let A = await d(this, _, 'm', M).call(this, R),
                  W = [],
                ...
                A)) {
                  let G = {
                    master: d(this, _, 'm', p).call(this, S, !1, O, w, W),
                  };
                ...
                for (let [i, P] of this.nodeByAddress.entries()) {
                  ...
                  P.client &&
                    W.push(
                      d(this, _, 'm', s).call(this, P.client, (D) =>
                        D.disconnect()
                      )
                    );
                  ...
                  S &&
                    W.push(
                      d(this, _, 'm', s).call(this, S, (D) => D.disconnect())
                    ),
            ...
            (x = function (R) {
              switch (typeof d(this, E, 'f').nodeAddressMap) {
                case 'object':
                  return d(this, E, 'f').nodeAddressMap[R];
                case 'function':
                  return d(this, E, 'f').nodeAddressMap(R);
              }
            }),
            (u = function (R, w) {
              ...
              if (d(this, E, 'f').defaults) {
                ...
                (W = d(this, E, 'f').defaults.socket
                  ? { ...d(this, E, 'f').defaults.socket, ...R?.socket }
                  : R?.socket),
                  (A = { ...d(this, E, 'f').defaults, ...R, socket: W });
              } else A = R;
              return (
                w &&
                  (A ?? (A = {}),
            ...
            (p = function ({ id: R, ip: w, port: A }, W, O, i, P) {
              let S = `${w}:${A}`;
              i.add(S);
              ...
              return (
                D ||
                  ...
                  O && P.push(d(this, _, 'm', h).call(this, D)),
                  this.nodeByAddress.set(S, D)),
                (W ? this.replicas : this.masters).push(D),
                D
              );
            }),
            (f = async function (R, w = R.readonly) {
              let A = new (d(this, b, 'f'))(
                d(this, _, 'm', u).call(this, {
                  socket: d(this, _, 'm', x).call(this, R.address) ?? {
                    host: R.host,
                    port: R.port,
                  },
                  readonly: w,
            ...
            (y = async function (R) {
              if (!(await d(this, _, 'm', N).call(this, R.options)))
            ...
            (C = async function (R) {
              ...
              for (let { master: A, replicas: W } of this.shards)
                if (
                  (A.client &&
                    w.push(d(this, _, 'm', s).call(this, A.client, R)),
                  A.pubSubClient &&
                    w.push(d(this, _, 'm', s).call(this, A.pubSubClient, R)),
                  W)
                )
                  for (let { client: O } of W)
                    O && w.push(d(this, _, 'm', s).call(this, O, R));
              this.pubSubNode &&
                (w.push(
                  d(this, _, 'm', s).call(this, this.pubSubNode.client, R)
                ),
                (this.pubSubNode = void 0)),
                d(this, _, 'm', U).call(this),
            ...
            (s = function (R, w) {
              return F.types.isPromise(R) ? R.then(w) : w(R);
            }),
            (c = function* () {
              let R = Math.floor(
            ...
            (n = function* (R) {
              let w = Math.floor(Math.random() * (1 + R.replicas.length));
              if (w < R.replicas.length)
                do yield R.replicas[w];
                while (++w < R.replicas.length);
                        ...
                        R &&
                          (await Promise.all([
                            W.extendPubSubListeners(
                              B.PubSubType.CHANNELS,
                              R[B.PubSubType.CHANNELS]
                            ),
                            W.extendPubSubListeners(
                              B.PubSubType.PATTERNS,
                              R[B.PubSubType.PATTERNS]
                            ),
                          ])),
            ...
            (l = function (R) {
              ...
              return (R.pubSubClient = w), w;
            }),
            (r = { value: 16384 }),
            (j.default = Y);
        },
        53817: gr,
        87423: function (K, j, k) {
          'use strict';
          var _,
            m,
            r,
          ...
          class p extends M.EventEmitter {
            ...
            async sendCommand(h, v, y, C) {
              return a(this, _, 'm', b).call(this, h, v, (s) =>
                s.sendCommand(y, C)
              );
            }
                ...
                e = {
                  ...
                  data: s.data.map((n) => {
                    ...
                    for (let l = 0; l < n.length; l++)
                      o[s.headers[l][1]] = y(this, _, 'm', x).call(
                        this,
                        n[l],
                        c
                      );
    ...
    ($.webpackChunk_N_E = $.webpackChunk_N_E || []).push([
        ...
        87250: (K, j, k) => {
          ...
          async function M(s) {
            try {
              let c = new URL(s.url),
                e =
                  c.searchParams.get('pwd') ||
                  c.searchParams.get('password') ||
                  '',
                n = c.searchParams.get('un') || '',
                o = await (0, g.iE)(),
                l = process.env.NEXT_PUBLIC_STORAGE_TYPE || 'localstorage';
              if (l !== 'localstorage' && !n.trim())
                return T.xk.json(
                  { error: '\u7F3A\u5C11\u53C2\u6570 un' },
                  { status: 400 }
                );
              ...
              if (n.trim())
                try {
                  d = U.from(n, 'base64').toString('utf8');
                } catch {
                  return T.xk.json(
                    { error: '\u53C2\u6570 un \u975E\u6CD5' },
                    { status: 400 }
              ...
              l !== 'localstorage' || e || (e = process.env.PASSWORD || '');
              let I =
                  l === 'localstorage'
                    ? process.env.TVBOX_ENABLED == null ||
                      String(process.env.TVBOX_ENABLED).toLowerCase() === 'true'
                    : o.SiteConfig.TVBoxEnabled === !0,
                H =
                  l === 'localstorage'
                    ? process.env.PASSWORD || ''
                    : o.SiteConfig.TVBoxPassword || '';
              if (!I)
                return T.xk.json(
                  { error: 'TVBox \u63A5\u53E3\u672A\u5F00\u542F' },
                  { status: 403 }
              ...
              let [L, F] = await Promise.all([
                ...
                q = new URL(s.url).origin,
                Y = {
                  sites: [
                    {
                      key: 'douban_custom',
                      api: `${q}/api/tvbox/categories`,
                      name: '\u8C46\u74E3\uFF5C\u81EA\u5B9A\u4E49',
                      type: 1,
                      searchable: 0,
                      ext: '',
              ...
              return T.xk.json(Y, {
                headers: {
                  'Cache-Control': `public, max-age=${F}, s-maxage=0`,
                },
              });
            } catch {
              return T.xk.json(
          ...
          let x = new E.AppRouteRouteModule({
              definition: {
                kind: b.x.APP_ROUTE,
                page: '/api/tvbox/config/route',
                pathname: '/api/tvbox/config',
                filename: 'route',
                bundlePath: 'app/api/tvbox/config/route',
              },
              resolvedPagePath:
                '/Volumes/OS/Users/wangbengang/Documents/moontv/MoonTV/src/app/api/tvbox/config/route.ts',
      ...
      (K) => {
        var j = (_) => K((K.s = _));
        K.O(0, [5300, 7304, 366, 4292, 3664], () => j(87250));
        var k = K.O();
        (Q._ENTRIES = typeof Q._ENTRIES > 'u' ? {} : Q._ENTRIES)[
          'middleware_app/api/tvbox/config/route'
        ] = k;
      },
    ]),
    function () {
        ...
        (function (k, _) {
          ...
          function y(e) {
            ...
            for (; o < e.length; ) {
              for (l = o, L = !1; F(); )
                if (((d = e.charAt(o)), d === ',')) {
                  for (I = o, o += 1, F(), H = o; o < e.length && B(); ) o += 1;
                  o < e.length && e.charAt(o) === '='
                    ? ((L = !0), (o = H), n.push(e.substring(l, I)), (l = o))
                    : (o = I + 1);
                } else o += 1;
      ...
      .call({})
      .default({
        name: 'app/api/tvbox/config/route',
        staticRoutes: [
          {
            page: '/',
            regex: '^/(?:/)?$',
