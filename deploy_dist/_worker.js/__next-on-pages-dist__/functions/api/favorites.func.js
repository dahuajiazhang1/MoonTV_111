...
var q = globalThis.__nextOnPagesRoutesIsolation.getProxyFor('/api/favorites'),
  Ct = pt(q, q, q),
  Pt = Ct.__chunk_52387,
  rt = bt(q, q, q),
  xt = rt.__chunk_67550,
  ...
  $a = ((K, V, tt) => (
        ...
        (() => {
          ...
          k.O = (m, o, E, b) => {
            ...
            for (var S = 1 / 0, l = 0; l < _.length; l++) {
              for (var [o, E, b] = _[l], y = !0, F = 0; F < o.length; F++)
                S >= b && Object.keys(k.O).every((f) => k.O[f](o[F]))
                  ? o.splice(F--, 1)
                  : ((y = !1), b < S && (S = b));
              if (y) {
                _.splice(l--, 1);
        ...
        (() => {
          ...
          var m = (E, b) => {
              var l,
                ...
                L = 0;
              if (y.some((i) => _[i] !== 0)) {
                for (l in F) k.o(F, l) && (k.m[l] = F[l]);
                if (N) var R = N(k);
              }
              for (E && E(b); L < y.length; L++)
                (S = y[L]), k.o(_, S) && _[S] && _[S][0](), (_[S] = 0);
              return k.O(R);
            },
      ...
      [7304],
      {
              ...
              (Object.create
                ? function (y, F, N, L) {
                    ...
                    (!R ||
                      ...
                      Object.defineProperty(y, L, R);
                  }
                : function (y, F, N, L) {
                    L === void 0 && (L = N), (y[L] = F[N]);
                  }),
            m =
        ...
        7976: function (G, U, k) {
          ...
          class c {
                ...
                N.set(
                  ...
                  new v.default({
                    ...
                    onReply: (a) => {
                      if (i(this, y, 'f').isActive && Array.isArray(a)) {
                        ...
                        if (H && !i(this, l, 'f').length) {
                          ...
                          i(this, S, 'f').call(
                            this,
                            T,
                            i(this, y, 'f').removeShardedListeners(T)
                          );
                          return;
                        }
                        if (H || P.PubSub.isStatusReply(a)) {
                          let T = i(this, l, 'f').head.value;
                          ((Number.isNaN(T.channelsCounter) && a[2] === 0) ||
                            --T.channelsCounter == 0) &&
                            i(this, l, 'f').shift().resolve();
                          return;
                        }
                        if (h.equals(a[0])) {
                          let { resolve: T, returnBuffers: B } = i(
                              this,
                              l,
                              'f'
                            ).shift(),
                      ...
                      let { resolve: d, reject: A } = i(this, l, 'f').shift();
                      a instanceof u.ErrorReply ? A(a) : d(a);
                    },
                  })
                ),
                p(this, E, n, 'f'),
                    ...
                    if (s?.signal) {
                      let H = () => {
                        i(this, b, 'f').removeNode(A),
                          A.value.reject(new u.AbortError());
                      };
                      (A.value.abort = { signal: s.signal, listener: H }),
            ...
            resubscribe() {
              ...
              if (n.length)
                return Promise.all(
                  n.map((s) => i(this, _, 'm', L).call(this, s))
                );
            }
            ...
            flushWaitingForReply(n) {
              if (
                ...
                for (
                  ;
                  i(this, b, 'f').head?.value.chainId === i(this, F, 'f');
        ...
        85366: function (G, U, k) {
          ...
          let a = k(76486),
            ...
            w = k(66723),
            O = k(52772);
          class W extends T.EventEmitter {
            static commandOptions(r) {
              return (0, B.commandOptions)(r);
            }
            static extend(r) {
            ...
            constructor(r) {
              super(),
                ...
                s(this, o, n(this, _, 'm', F).call(this, r), 'f'),
                s(this, b, n(this, _, 'm', N).call(this), 'f'),
                s(this, E, n(this, _, 'm', L).call(this), 'f'),
            ...
            async functionsExecuter(r, x, C) {
              let { args: D, options: z } = (0, I.transformCommandArguments)(
                r,
                x
              );
              return (0, I.transformCommandReply)(
                r,
                await this.executeFunction(C, r, D, z),
                D.preserve
              );
            }
            ...
            async SELECT(r, x) {
              (0, B.isCommandOptions)(r) || ((x = r), (r = null)),
            ...
            (b = function () {
              ...
              (this.addCommand = (...u) => (
                y(this, m, 'f').addCommand(
                  (0, L.transformLegacyCommandArguments)(u)
                ),
                this
              )),
          ...
          class g {
            ...
            subscribe(h, c, e, n) {
              ...
              for (let A of d) {
                ...
                (!H || H.unsubscribing) && a.push(A);
              }
              if (a.length === 1) {
                for (let A of d)
                  f(o, o, 'm', b).call(o, f(this, y, 'f')[h].get(A), n).add(e);
                return;
              }
              return (
                u(this, S, !0, 'f'),
                  ...
                  resolve: () => {
                    ...
                    d)) {
                      ...
                      T ||
                        ...
                        f(this, y, 'f')[h].set(H, T)),
                        f(o, o, 'm', b).call(o, T, n).add(e);
                    }
                  },
                  reject: () => {
                    var A;
                    u(this, l, ((A = f(this, l, 'f')), --A), 'f'),
            ...
            extendChannelListeners(h, c, e) {
              var n;
              if (f(this, m, 'm', F).call(this, h, c, e))
                return (
                  u(this, S, !0, 'f'),
            ...
            extendTypeListeners(h, c) {
              ...
              let n = [v[h].subscribe];
              for (let [s, a] of c)
                f(this, m, 'm', F).call(this, h, s, a) && n.push(s);
              if (n.length !== 1)
                return (
                  u(this, S, !0, 'f'),
            ...
            unsubscribe(h, c, e, n) {
              ...
              for (let A of a) {
                ...
                if (H) {
                  ...
                  if (
                    (n
                      ? ((T = H.buffers), (B = H.strings))
                      : ((T = H.strings), (B = H.buffers)),
                    (T.has(e) ? T.size - 1 : T.size) !== 0 || B.size !== 0)
                  )
                    continue;
                  H.unsubscribing = !0;
                }
              ...
              if (d.length === 1) {
                for (let A of a) f(o, o, 'm', b).call(o, s.get(A), n).delete(e);
                return;
              }
        ...
        53304: function (G, U, k) {
          ...
          var _,
            ...
            c =
              ...
              function (T, B, I, $) {
                ...
                if (typeof B == 'function' ? T !== B || !$ : !B.has(T))
                  throw TypeError(
                    'Cannot read private member from an object whose class did not declare it'
                  );
                return I === 'm'
            ...
            e =
              ...
              function (T, B, I, $, Q) {
                ...
                if (typeof B == 'function' ? T !== B || !Q : !B.has(T))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  $ === 'a' ? Q.call(T, I) : Q ? (Q.value = I) : B.set(T, I), I
                );
              };
          Object.defineProperty(U, '__esModule', { value: !0 });
          let n = k(15846),
          ...
          class H extends n.EventEmitter {
            ...
            writeCommand(B) {
              ...
              for (let I of B) e(this, N, !c(this, S, 'f').write(I), 'f');
            }
            disconnect() {
            ...
            ref() {
              e(this, L, !1, 'f'), c(this, S, 'f')?.ref();
            }
            unref() {
              e(this, L, !0, 'f'), c(this, S, 'f')?.unref();
            }
          }
          (m = H),
            (b = new WeakMap()),
            ...
            (o = function (T) {
              ...
              return (
                T ?? (T = {}),
                T.path ||
                  ((B = T).port ?? (B.port = 6379),
                  (I = T).host ?? (I.host = 'localhost')),
            ...
            (R = function (T, B) {
              ...
              if (c(this, l, 'f').reconnectStrategy)
                try {
                  let I = c(this, l, 'f').reconnectStrategy(T, B);
            ...
            (i = function (T, B) {
              let I = c(this, _, 'm', R).call(this, T, B);
              return I === !1
                ? (e(this, y, !1, 'f'), this.emit('error', B), B)
                : I instanceof Error
                ? (e(this, y, !1, 'f'),
                  this.emit('error', B),
                  new d.ReconnectStrategyError(I, B))
                : I;
            }),
            (p = async function () {
              let T = 0;
              do
                try {
                  ...
                  try {
                    ...
                    throw (
                      (c(this, S, 'f').destroy(), e(this, S, void 0, 'f'), B)
                    );
                  }
                  e(this, F, !0, 'f'), this.emit('ready');
                } catch (B) {
                  let I = c(this, _, 'm', i).call(this, T++, B);
                  if (typeof I != 'number') throw I;
                  this.emit('error', B),
                    await (0, A.promiseTimeout)(I),
                    this.emit('reconnecting');
                }
              while (c(this, y, 'f') && !c(this, F, 'f'));
            }),
            (f = function () {
              return new Promise((T, B) => {
                let { connectEvent: I, socket: $ } = c(m, m, 'm', E).call(
                  m,
                  c(this, l, 'f')
                )
            ...
            (g = function (T) {
              ...
              e(this, F, !1, 'f'),
                ...
                B &&
                  c(this, y, 'f') &&
                  typeof c(this, _, 'm', i).call(this, 0, T) == 'number' &&
                  (this.emit('reconnecting'),
                  c(this, _, 'm', p)
                    .call(this)
                    .catch(() => {}));
        ...
        73663: function (G, U, k) {
          ...
          (m = Q),
            ...
            (N = async function (M) {
              let w = new Set();
              try {
                let O = await d(this, _, 'm', L).call(this, M),
                  W = [],
                ...
                if (this.pubSubNode && !w.has(this.pubSubNode.address))
                  if (B.types.isPromise(this.pubSubNode.client))
            ...
            (h = function (M, w) {
              return B.types.isPromise(M) ? M.then(w) : w(M);
            }),
            (c = function* () {
              let M = Math.floor(
          ...
          class p extends L.EventEmitter {
            ...
            constructor(u) {
              super(),
                ...
                S(this, m, u, 'f'),
                S(this, o, new F.default(u, this.emit.bind(this)), 'f'),
          ...
          var _,
            ...
            E =
              ...
              function (L, R, i, p, f) {
                ...
                if (typeof R == 'function' ? L !== R || !f : !R.has(L))
                  throw TypeError(
                    'Cannot write private member to an object whose class did not declare it'
                  );
                return (
                  p === 'a' ? f.call(L, i) : f ? (f.value = i) : R.set(L, i), i
                );
              },
            b =
              (this && this.__classPrivateFieldGet) ||
            ...
            commandsExecutor(R, i) {
              ...
              return (
                E(
                  this,
                  o,
                  b(this, o, 'f') ?? F.default.extractFirstKey(R, i, p),
                  'f'
                ),
            ...
            functionsExecutor(R, i, p) {
              ...
              return (
                E(
                  this,
                  o,
                  b(this, o, 'f') ?? F.default.extractFirstKey(R, i, f),
                  'f'
                ),
                this
              );
          ...
          (m = new WeakMap()),
            ...
            (i = function ([h, c, e, n, s], a) {
              let d = {
                ...
                A = g(this, _, 'm', F).call(this, 'relationshipTypes', c);
              return (
                A instanceof Promise
                  ? a.push(A.then((H) => (d.relationshipType = H)))
            ...
            (p = function ([h, c, e], n) {
              ...
              for (let a = 0; a < c.length; a++) {
                let d = g(this, _, 'm', F).call(this, 'labels', c[a]);
                d instanceof Promise
                  ? n.push(d.then((A) => (s[a] = A)))
                  : (s[a] = d);
              }
              return {
                id: h,
            ...
            (f = function (h, c) {
              ...
              for (let [n, s, a] of h) {
                let d = g(this, _, 'm', R).call(this, [s, a], c),
                  A = g(this, _, 'm', F).call(this, 'propertyKeys', n);
                A instanceof Promise
                  ? c.push(A.then((H) => (e[H] = d)))
                  : (e[A] = d);
              }
              return e;
            }),
    ...
    (K.webpackChunk_N_E = K.webpackChunk_N_E || []).push([
        ...
        55027: (G, U, k) => {
          ...
          async function R(n) {
            try {
              ...
              if (A) {
                ...
                let I = await N.db.getFavorite(s.username, T, B);
                return S.xk.json(I, { status: 200 });
              }
              let H = await N.db.getAllFavorites(s.username);
              return S.xk.json(H, { status: 200 });
            } catch (s) {
              return (
                console.error('\u83B7\u53D6\u6536\u85CF\u5931\u8D25', s),
          ...
          async function i(n) {
            try {
              ...
              let { key: d, favorite: A } = await n.json();
              if (!d || !A)
                return S.xk.json(
                  { error: 'Missing key or favorite' },
                  { status: 400 }
                );
              if (!A.title || !A.source_name)
                return S.xk.json(
              ...
              let B = { ...A, save_time: A.save_time ?? Date.now() };
              return (
                await N.db.saveFavorite(s.username, H, T, B),
                S.xk.json({ success: !0 }, { status: 200 })
              );
            } catch (s) {
              return (
                console.error('\u4FDD\u5B58\u6536\u85CF\u5931\u8D25', s),
                S.xk.json({ error: 'Internal Server Error' }, { status: 500 })
              );
            }
          }
          async function p(n) {
            try {
              ...
              if (H) {
                ...
                await N.db.deleteFavorite(d, T, B);
              } else {
                let T = await N.db.getAllFavorites(d);
                await Promise.all(
                  Object.keys(T).map(async (B) => {
                    let [I, $] = B.split('+');
                    I && $ && (await N.db.deleteFavorite(d, I, $));
                  })
                );
              }
          ...
          let f = new E.AppRouteRouteModule({
              ...
              resolvedPagePath:
                '/Volumes/OS/Users/wangbengang/Documents/moontv/MoonTV/src/app/api/favorites/route.ts',
      ...
      (G) => {
        var U = (_) => G((G.s = _));
        G.O(0, [5300, 7304, 366, 4292, 3664], () => U(55027));
        var k = G.O();
        (V._ENTRIES = typeof V._ENTRIES > 'u' ? {} : V._ENTRIES)[
          'middleware_app/api/favorites/route'
        ] = k;
      },
    ]),
    function () {
        ...
        (function (k, _) {
          ...
          function g(e) {
            ...
            for (; s < e.length; ) {
              for (a = s, T = !1; B(); )
                if (((d = e.charAt(s)), d === ',')) {
                  for (A = s, s += 1, B(), H = s; s < e.length && I(); ) s += 1;
                  s < e.length && e.charAt(s) === '='
                    ? ((T = !0), (s = H), n.push(e.substring(a, A)), (a = s))
                    : (s = A + 1);
                } else s += 1;
              (!T || s >= e.length) && n.push(e.substring(a, e.length));
            }
            return n;
          }
          function P(e) {
            ...
            return async function (a, d) {
              ...
              if (
                ...
                for (let B of e.nextConfig.i18n.locales) {
                  let I = new RegExp(`^/${B}($|/)`, 'i');
                  if (A.match(I)) {
                    A = A.replace(I, '/') || '/';
                    break;
                  }
              ...
              if (!H.name) {
                let B = c(A);
                for (let I of s || []) {
                  if (B && !c(I.page)) continue;
                  let $ = I.regexp.exec(A);
                  if ($) {
                    H = { name: I.page, params: $.groups };
                    break;
                  }
                }
              }
              let T = await u({ waitUntil: d.waitUntil }, () =>
              ...
              return T.waitUntil && d.waitUntil(T.waitUntil), T.response;
            };
          }
          function h(e, n, s = !1) {
