  ...
  [108],
  {
    9571: function (r, e, u) {
      var a,
        ...
        S;
      (r = u.nmd(r)) && r.exports,
        (t = 'object' == typeof u.g && u.g).global === t || t.window,
        (o = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g),
        (s = /[\x01-\x7F]/g),
        ...
        (y = function (r, e) {
          for (var u = -1, a = r.length; ++u < a; ) if (r[u] == e) return !0;
          return !1;
        }),
        (A = function (r, e) {
          if (!r) return e;
        ...
        (E = function (r, e) {
          ...
          return (r >= 55296 && r <= 57343) || r > 1114111
            ? (e &&
                k('character reference outside the permissible Unicode range'),
              '�')
            : w(h, r)
            ? (e && k('disallowed character reference'), h[r])
            : (e && y(b, r) && k('disallowed character reference'),
              r > 65535 &&
                ((r -= 65536),
                (u += q(((r >>> 10) & 1023) | 55296)),
                (r = 56320 | (1023 & r))),
        ...
        ((L = function (r, e) {
          (e = A(e, L.options)).strict &&
            d.test(r) &&
            k('forbidden code point');
          var u = e.encodeEverything,
          ...
          return (
            u
              ...
              ? (t ||
                ...
                (r = (r = r
                  .replace(/&gt;\u20D2/g, '&nvgt;')
                  .replace(/&lt;\u20D2/g, '&nvlt;')).replace(l, function (r) {
                  return '&' + i[r] + ';';
                })))
              : t || (r = r.replace(n, D)),
            r
        ...
        ((B = function (r, e) {
          var u = (e = A(e, B.options)).strict;
          return (
            u && D.test(r) && k('malformed character reference'),
            r.replace(g, function (r, a, t, o, s, c, l, i, n) {
              var p, D;
              return a
                ? m[(D = a)]
                : t
                ? ((D = t), o && e.isAttributeValue)
                  ? (u &&
                      '=' == o &&
                ...
                ? ((p = c),
                  u &&
                    !p &&
                    k('character reference was not terminated by a semicolon'),
                  E(parseInt(s, 10), u))
                : l
                ? ((p = i),
                  u &&
    ...
    9818: function (r, e, u) {
      ...
      var a = u(5663);
      let t = (r) => r.replace(/([a-z0-9])([A-Z])/g, '$1-$2').toLowerCase(),
        o = function () {
          for (var r = arguments.length, e = Array(r), u = 0; u < r; u++)
            e[u] = arguments[u];
          return e.filter((r, e, u) => !!r && u.indexOf(r) === e).join(' ');
        };
      var s = {
      ...
      let c = (0, a.forwardRef)((r, e) => {
          ...
          return (0, a.createElement)(
            'svg',
            {
              ...
              height: t,
              stroke: u,
              strokeWidth: l ? (24 * Number(c)) / Number(t) : c,
        ...
        l = (r, e) => {
          let u = (0, a.forwardRef)((u, s) => {
            let { className: l, ...i } = u;
            return (0, a.createElement)(c, {
              ref: s,
              iconNode: e,
              className: o('lucide-'.concat(t(r)), l),
              ...i,
            });
          });
          return (u.displayName = ''.concat(r)), u;
        };
    },
    4819: function (r, e, u) {
      'use strict';
    ...
    1816: function (r, e, u) {
      ...
      var a, t;
      r.exports =
        (null == (a = u.g.process) ? void 0 : a.env) &&
        'object' == typeof (null == (t = u.g.process) ? void 0 : t.env)
          ? u.g.process
          : u(7405);
    },
    7405: function (r) {
        ...
        var e = {
            229: function (r) {
              ...
              function c(r) {
                ...
                if ((e === o || !e) && setTimeout)
                  return (e = setTimeout), setTimeout(r, 0);
                try {
                  return e(r, 0);
                } catch (u) {
                  try {
                  ...
                  (a = null),
                    ...
                    (function (r) {
                      ...
                      if ((u === s || !u) && clearTimeout)
                        return (u = clearTimeout), clearTimeout(r);
                      try {
                        u(r);
                      } catch (e) {
                        try {
              ...
              (t.nextTick = function (r) {
                ...
                if (arguments.length > 1)
                  for (var u = 1; u < arguments.length; u++)
                    e[u - 1] = arguments[u];
                l.push(new d(r, e)), 1 !== l.length || i || c(D);
              }),
