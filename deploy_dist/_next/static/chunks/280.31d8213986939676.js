...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [280],
  {
    8855: function (e, t, r) {
        ...
        })(
          {
            esqvp: [
              function (e, t, r, a) {
                ...
                var i = e('bundle-text:./style/index.less'),
                  ...
                  C = e('./mask'),
                  F = o.interopDefault(C),
                  q = e('./notice'),
                  D = o.interopDefault(q),
                  A = e('./player'),
                  R = o.interopDefault(A),
                  B = e('./plugins'),
                  L = o.interopDefault(B),
                  P = e('./scheme'),
                  O = o.interopDefault(P),
                  _ = e('./setting'),
                  z = o.interopDefault(_),
                  H = e('./storage'),
                  X = o.interopDefault(H),
                  V = e('./subtitle'),
                ...
                let K = 0,
                  J = [];
                class Q extends G.default {
                  constructor(e, t) {
                    if ((super(), !Y.isBrowser))
                      throw Error(
                        'Artplayer can only be used in the browser environment'
                      );
                    this.id = ++K;
                    let r = Y.mergeDeep(Q.option, e);
                    if (
                      ((r.container = e.container),
                      (this.option = (0, l.default)(r, O.default)),
                      (this.isLock = !1),
                      (this.isReady = !1),
                      (this.isFocus = !1),
                      (this.isInput = !1),
                      (this.isRotate = !1),
                      (this.isDestroy = !1),
                      (this.template = new U.default(this)),
                      (this.events = new v.default(this)),
                      (this.storage = new X.default(this)),
                      (this.icons = new k.default(this)),
                      (this.i18n = new w.default(this)),
                      (this.notice = new D.default(this)),
                      (this.player = new R.default(this)),
                      (this.layers = new I.default(this)),
                      (this.controls = new m.default(this)),
                      (this.contextmenu = new f.default(this)),
                      (this.subtitle = new N.default(this)),
                      (this.info = new $.default(this)),
                      (this.loading = new M.default(this)),
                      (this.hotkey = new b.default(this)),
                      (this.mask = new F.default(this)),
                      (this.setting = new z.default(this)),
                      (this.plugins = new L.default(this)),
                      'function' == typeof t &&
                      ...
                      e(`Version@${Q.version}`);
                      for (let t = 0; t < d.default.events.length; t++)
                        this.on(`video:${d.default.events[t]}`, (t) =>
                          e(`Event@${t.type}`)
                        );
                    }
                    J.push(this);
                  ...
                  static get option() {
                    return {
                      ...
                      moreVideoAttr: {
                        controls: !1,
                        preload: Y.isSafari ? 'auto' : 'metadata',
                      },
                      i18n: {},
                      icons: {},
                      cssVar: {},
                ...
                (r.default = Q),
                  ...
                  (Q.NOTICE_TIME = 2e3),
                  (Q.SETTING_WIDTH = 250),
                  (Q.SETTING_ITEM_WIDTH = 200),
                  (Q.SETTING_ITEM_HEIGHT = 35),
                  (Q.RESIZE_TIME = 200),
                  (Q.SCROLL_TIME = 200),
                  (Q.SCROLL_GAP = 50),
                  (Q.AUTO_PLAYBACK_MAX = 10),
                  (Q.AUTO_PLAYBACK_MIN = 5),
                  (Q.AUTO_PLAYBACK_TIMEOUT = 3e3),
                  (Q.RECONNECT_TIME_MAX = 5),
                  (Q.RECONNECT_SLEEP_TIME = 1e3),
                  (Q.CONTROL_HIDE_TIME = 3e3),
                  (Q.DBCLICK_TIME = 300),
                  (Q.DBCLICK_FULLSCREEN = !0),
                  (Q.MOBILE_DBCLICK_PLAY = !0),
                  (Q.MOBILE_CLICK_PLAY = !1),
                  (Q.AUTO_ORIENTATION_TIME = 200),
                  (Q.INFO_LOOP_TIME = 1e3),
                  (Q.FAST_FORWARD_VALUE = 3),
                  (Q.FAST_FORWARD_TIME = 1e3),
                  (Q.TOUCH_MOVE_RATIO = 0.5),
                  (Q.VOLUME_STEP = 0.1),
                  (Q.SEEK_STEP = 5),
                  (Q.PLAYBACK_RATE = [0.5, 0.75, 1, 1.25, 1.5, 2]),
                  (Q.ASPECT_RATIO = ['default', '4:3', '16:9']),
                  (Q.FLIP = ['normal', 'horizontal', 'vertical']),
                  (Q.FULLSCREEN_WEB_IN_BODY = !1),
                  (Q.LOG_VERSION = !0),
                  (Q.USE_RAF = !1),
                  (Q.REMOVE_SRC_WHEN_DESTROY = !0),
                  Y.isBrowser &&
                    ((window.Artplayer = Q),
                    Y.setStyleText('artplayer-style', n.default),
                    setTimeout(() => {
                      Q.LOG_VERSION &&
                        console.log(
                          `%c ArtPlayer %c ${Q.version} %c https://artplayer.org`,
              ...
              {
                'bundle-text:./style/index.less': '2wh8D',
                'option-validator': 'g7VGh',
                '../package.json': 'lh3R5',
                './config': 'eJfh8',
                './contextmenu': '9zso8',
                './control': 'dp1yk',
            ...
            lh3R5: [
              function (e, t, r, a) {
                t.exports = JSON.parse(
                  '{"name":"artplayer","version":"5.3.0","description":"ArtPlayer.js is a modern and full featured HTML5 video player","author":"Harvey Zack <laozhaochaguan@gmail.com>","license":"MIT","homepage":"https://artplayer.org","repository":{"type":"git","url":"git+https://github.com/zhw2590582/ArtPlayer.git"},"bugs":{"url":"https://github.com/zhw2590582/ArtPlayer/issues"},"keywords":["html5","video","player"],"exports":{".":{"types":"./types/artplayer.d.ts","import":"./dist/artplayer.mjs","require":"./dist/artplayer.js"},"./legacy":{"types":"./types/artplayer.d.ts","import":"./dist/artplayer.legacy.js","require":"./dist/artplayer.legacy.js"},"./i18n/*":{"types":"./types/i18n.d.ts","import":"./dist/i18n/*.mjs","require":"./dist/i18n/*.js"}},"main":"./dist/artplayer.js","module":"./dist/artplayer.mjs","types":"./types/artplayer.d.ts","typesVersions":{"*":{"i18n/*":["types/i18n.d.ts"],"legacy":["types/artplayer.d.ts"]}},"legacy":"./dist/artplayer.legacy.js","browserslist":"last 1 Chrome version","dependencies":{"option-validator":"^2.0.6"}}'
                );
              },
              {},
            ],
              ...
              function (e, t, r, a) {
                ...
                class x extends s.default {
                  ...
                  init() {
                    ...
                    e.playbackRate &&
                      this.add(
                        (0, v.default)({ name: 'playbackRate', index: 10 })
                      ),
                      e.aspectRatio &&
                        this.add(
                          (0, c.default)({ name: 'aspectRatio', index: 20 })
                        ),
                      e.flip &&
                        this.add((0, f.default)({ name: 'flip', index: 30 })),
                      this.add((0, m.default)({ name: 'info', index: 40 })),
                      this.add((0, b.default)({ name: 'version', index: 50 })),
                      this.add((0, d.default)({ name: 'close', index: 60 }));
                    ...
                    t(r, 'contextmenu', (e) => {
                      ...
                      let t = e.clientX,
                        ...
                        { height: p, width: d } = (0, i.getRect)(a),
                        u = t - l,
                        f = o - c;
                      t + d > l + s && (u = s - d),
                        o + p > c + n && (f = n - p),
                        (0, i.setStyles)(a, { top: `${f}px`, left: `${u}px` });
                    }),
                      t(r, 'click', (e) => {
            ...
            jg0yq: [
              function (e, t, r, a) {
                ...
                o.defineInteropFlag(r),
                  ...
                  o.export(r, 'isIOS', () => s),
                  o.export(r, 'isIOS13', () => l),
                  o.export(r, 'isMobile', () => c),
                  o.export(r, 'isBrowser', () => p);
                let i =
                  ...
                  s = /iPad|iPhone|iPod/i.test(i) && !window.MSStream,
                  l =
                    s ||
                    (i.includes('Macintosh') && navigator.maxTouchPoints >= 1),
                  c =
            ...
            eANXw: [
              function (e, t, r, a) {
                ...
                o.defineInteropFlag(r),
                  ...
                  o.export(r, 'setStyleText', () => E),
                  o.export(r, 'supportsFlex', () => $),
                  o.export(r, 'getRect', () => S),
                  o.export(r, 'loadImg', () => I),
                  o.export(r, 'getComposedPath', () => T);
                var i = e('./compatibility');
                ...
                function g(e) {
                  return Array.from(e.parentElement.children).filter(
                    (t) => t !== e
                  );
                }
                function v(e, t) {
                ...
                function k(e = '', t = '') {
                  let r = j('i');
                  return l(r, 'art-icon'), l(r, `art-icon-${e}`), d(r, t), r;
                }
                function E(e, t) {
                ...
                function T(e) {
                  ...
                  let t = [],
                    r = e.target;
                  for (; r; ) t.push(r), (r = r.parentNode);
                  return (
                    t.includes(window) || void 0 === window || t.push(window), t
                  );
                }
              },
              {
              ...
              function (e, t, r, a) {
                ...
                r.default = class {
                  ...
                  set show(e) {
                    ...
                    e ? (0, l.addClass)(t, r) : (0, l.removeClass)(t, r),
                  ...
                  add(e) {
                    ...
                    (0, c.errorHandle)(
                      ...
                      (this.id += 1);
                    let o = (0, l.createElement)('div');
                    (0, l.addClass)(o, `art-${this.name}`),
                      (0, l.addClass)(o, `art-${this.name}-${r}`);
                    let i = Array.from(this.$parent.children);
                    ...
                    p
                      ...
                      : (0, l.append)(this.$parent, o),
                      t.html && (0, l.append)(o, t.html),
                      t.style && (0, l.setStyles)(o, t.style),
                      t.tooltip && (0, l.tooltip)(o, t.tooltip);
                    let d = [];
                    if (t.click) {
                    ...
                    return (
                      t.selector &&
                        ...
                        this.selector(t, o, d),
                      (this[r] = o),
                      this.cache.set(r, { $ref: o, events: d, option: t }),
                  ...
                  remove(e) {
                    ...
                    (0, c.errorHandle)(
                      t,
                      `Can't find [${e}] from the [${this.name}]`
                    ),
                    ...
                    this.cache.delete(e), delete this[e], (0, l.remove)(t.$ref);
                  }
                  update(e) {
                    let t = this.cache.get(e.name);
                    return (
                      t &&
                        ((e = Object.assign(t.option, e)), this.remove(e.name)),
                      this.add(e)
                    );
                  }
                };
                ...
                class T extends s.default {
                  constructor(e) {
                    ...
                    e.on('mousemove', () => {
                      ...
                      e.on('control', (e) => {
                        e
                          ? ((0, i.removeClass)(r, 'art-hide-cursor'),
                            (0, i.addClass)(r, 'art-hover'),
                            (this.timer = Date.now()))
                          : ((0, i.addClass)(r, 'art-hide-cursor'),
                            (0, i.removeClass)(r, 'art-hover'));
                      }),
                      this.init();
                  }
                  init() {
                  ...
                  check(e) {
                    ...
                    for (let t = 0; t < e.$control_option.length; t++) {
                      ...
                      (r.default = r === e),
                        r.default &&
                          (0, i.inverseClass)(r.$control_item, 'art-current');
                    }
                  }
                  selector(e, t, r) {
                    ...
                    (0, i.addClass)(o, 'art-selector-value'),
                      (0, i.append)(o, e.html),
                      (t.textContent = ''),
                      (0, i.append)(t, o);
                    let n = (0, i.createElement)('div');
                    (0, i.addClass)(n, 'art-selector-list'),
                      (0, i.append)(t, n);
                    for (let t = 0; t < e.selector.length; t++) {
                      let r = e.selector[t],
                        a = (0, i.createElement)('div');
                      (0, i.addClass)(a, 'art-selector-item'),
                        r.default && (0, i.addClass)(a, 'art-current'),
                        (a.dataset.index = t),
                        (a.dataset.value = r.value),
                        (a.innerHTML = r.html),
                        (0, i.append)(n, a),
                        (0, i.def)(r, '$control_option', {
                          get: () => e.selector,
                        }),
                        (0, i.def)(r, '$control_item', { get: () => a }),
                        (0, i.def)(r, '$control_value', { get: () => o });
                    }
                    let s = a(n, 'click', async (t) => {
                      let r = (0, i.getComposedPath)(t),
                        a = e.selector.find(
                          (e) =>
                            e.$control_item ===
                            r.find((t) => e.$control_item === t)
                        );
                      this.check(a),
                        e.onSelect &&
                    ...
                    mounted: (e) => {
                      ...
                      (0, i.append)(e, a.pip),
                        ...
                        t.on('pip', (t) => {
                          (0, i.tooltip)(
                            e,
                            o.get(t ? 'Exit PIP Mode' : 'PIP Mode')
                          );
                        });
                    },
                  });
                    ...
                    return {
                      ...
                      mounted: (e) => {
                        let l = null,
                          ...
                          d = (0, i.query)('.art-progress-loaded', e),
                    ...
                    mounted: (e) => {
                      ...
                      (0, i.append)(e, a.setting),
                        ...
                        t.on('setting', (t) => {
                          (0, i.tooltip)(
                            e,
                            o.get(t ? 'Hide Setting' : 'Show Setting')
                          );
                        });
                    },
                  });
                  ...
                  return (t) => ({
                    ...
                    mounted: (e) => {
                      let { proxy: r, icons: a } = t,
                        ...
                        s = (0, i.append)(
                          e,
                          '<div class="art-volume-panel"></div>'
                        ),
                        l = (0, i.append)(
                          s,
                          '<div class="art-volume-inner"></div>'
                        ),
                        c = (0, i.append)(
                          l,
                          '<div class="art-volume-val"></div>'
                        ),
                        p = (0, i.append)(
                          l,
                          '<div class="art-volume-slider"></div>'
                        ),
                        d = (0, i.append)(
                          p,
                        ...
                        u = (0, i.append)(
                          d,
                          '<div class="art-volume-loaded"></div>'
                        ),
                        f = (0, i.append)(
                          p,
                      ...
                      function m() {
                        if (t.muted || 0 === t.volume)
                          ...
                          (0, i.setStyle)(o, 'display', 'flex'),
                            ...
                            (0, i.setStyle)(u, 'top', `${100 - e}%`),
                            (c.textContent = Math.floor(e));
                        }
                      }
                      if (
                        (m(),
            ...
            jmVSD: [
              function (e, t, r, a) {
                ...
                r.default = class {
                  ...
                  proxy(e, t, r, a = {}) {
                    if (Array.isArray(t))
                      return t.map((t) => this.proxy(e, t, r, a));
            ...
            i8G6V: [
              function (e, t, r, a) {
                ...
                function n(e, t) {
                  ...
                  e.on('document:click', n), e.on('document:contextmenu', n);
                  let s = [];
                  t.proxy(o, 'click', (t) => {
                    let a = Date.now();
                    s.push(a);
            ...
            '9wEzB': [
              function (e, t, r, a) {
                ...
                var i = e('../control/progress'),
                  n = e('../utils');
                function s(e, t) {
                  if (n.isMobile && !e.option.isLive) {
                    let { $video: r, $progress: a } = e.template,
                      ...
                      d = (t) => {
                        if (1 === t.touches.length && !e.isLock) {
                          o === a && (0, i.setCurrentTime)(e, t), (s = !0);
                          let { pageX: r, pageY: n } = t.touches[0];
                          (l = r), (c = n), (p = e.currentTime);
                        }
                      },
                      u = (t) => {
                        if (1 === t.touches.length && s && e.duration) {
                          let { pageX: a, pageY: i } = t.touches[0],
                            s = (function (e, t, r, a) {
                              let o = t - a,
                                i = r - e,
                                n = 0;
                              if (2 > Math.abs(i) && 2 > Math.abs(o)) return n;
                              let s = (180 * Math.atan2(o, i)) / Math.PI;
                              return (
                                s >= -45 && s < 45
                                  ? (n = 4)
                                  : s >= 45 && s < 135
                            ...
                            d = [3, 4].includes(s),
                            u = [1, 2].includes(s);
                          if ((d && !e.isRotate) || (u && e.isRotate)) {
                            let s = (0, n.clamp)((a - l) / e.width, -1, 1),
                              d = (0, n.clamp)((i - c) / e.height, -1, 1),
                              u = e.isRotate ? d : s,
                            ...
                            (e.seek = h),
                              e.emit(
                                'setBar',
                                'played',
                                (0, n.clamp)(h / e.duration, 0, 1),
                                t
                              ),
                              (e.notice.show = `${(0, n.secondToTime)(
                                h
                              )} / ${(0, n.secondToTime)(e.duration)}`);
                          }
                        }
                      };
                    e.option.gesture &&
                      ...
                      t.proxy(r, 'touchmove', u)),
                      t.proxy(a, 'touchstart', (e) => {
                        (o = a), d(e);
                      }),
                      t.proxy(a, 'touchmove', u),
                      e.on('document:touchend', () => {
              ...
              function (e, t, r, a) {
                ...
                function i(e, t) {
                  let r = [
                    ...
                    o = [];
                  function i(i = {}) {
                    for (let e = 0; e < o.length; e++) t.remove(o[e]);
                    o.length = 0;
                    let { $player: n } = e.template;
                    r.forEach((r) => {
                      let a = i.document || n.ownerDocument || document,
                        s = t.proxy(a, r, (t) => {
                          e.emit(`document:${r}`, t);
                        });
                      o.push(s);
                      ...
                      a.forEach((r) => {
                        let a =
                            i.window || n.ownerDocument?.defaultView || window,
                          s = t.proxy(a, r, (t) => {
                            e.emit(`window:${r}`, t);
                          });
                        o.push(s);
            ...
            '42JNz': [
              function (e, t, r, a) {
                ...
                function n(e, t) {
                  ...
                  e.on('window:orientationchange', () => o()),
                    e.on('window:resize', () => o()),
                    screen &&
                      screen.orientation &&
              ...
              function (e, t, r, a) {
                ...
                function n(e) {
                  let {
                    ...
                    o = (0, i.throttle)(() => {
                      e.emit('view', (0, i.isInViewport)(a, r.SCROLL_GAP));
                    }, r.SCROLL_TIME);
                  e.on('window:scroll', () => o()),
                    e.on('view', (r) => {
                      t.autoMini && (e.mini = !r);
                    });
                }
                ...
                r.default = class {
                  ...
                  init() {
                    ...
                    this.add('Escape', () => {
                      ...
                      this.art.on('document:keydown', (e) => {
                        if (this.art.isFocus) {
            ...
            d9ktO: [
              function (e, t, r, a) {
                ...
                r.default = class {
                  ...
                  update(e) {
                    (this.languages = (0, i.mergeDeep)(this.languages, e)),
                      this.init();
                  }
                };
              },
            ...
            fFHY0: [
              function (e, t, r, a) {
                var o = e('@parcel/transformer-js/src/esmodule-helpers.js');
                o.defineInteropFlag(r);
                var i = e('bundle-text:./airplay.svg'),
                  n = o.interopDefault(i),
                  s = e('bundle-text:./arrow-left.svg'),
                  l = o.interopDefault(s),
                  c = e('bundle-text:./arrow-right.svg'),
                  p = o.interopDefault(c),
                  d = e('bundle-text:./aspect-ratio.svg'),
                  u = o.interopDefault(d),
                  f = e('bundle-text:./check.svg'),
                  h = o.interopDefault(f),
                  m = e('bundle-text:./close.svg'),
                  g = o.interopDefault(m),
                  v = e('bundle-text:./config.svg'),
                  y = o.interopDefault(v),
                  b = e('bundle-text:./error.svg'),
                  x = o.interopDefault(b),
                  w = e('bundle-text:./flip.svg'),
                  j = o.interopDefault(w),
                  k = e('bundle-text:./fullscreen-off.svg'),
                  E = o.interopDefault(k),
                  $ = e('bundle-text:./fullscreen-on.svg'),
                  S = o.interopDefault($),
                  I = e('bundle-text:./fullscreen-web-off.svg'),
                  T = o.interopDefault(I),
                  M = e('bundle-text:./fullscreen-web-on.svg'),
                  C = o.interopDefault(M),
                  F = e('bundle-text:./loading.svg'),
                  q = o.interopDefault(F),
                  D = e('bundle-text:./lock.svg'),
                  A = o.interopDefault(D),
                  R = e('bundle-text:./pause.svg'),
                  B = o.interopDefault(R),
                  L = e('bundle-text:./pip.svg'),
                  P = o.interopDefault(L),
                  O = e('bundle-text:./play.svg'),
                  _ = o.interopDefault(O),
                  z = e('bundle-text:./playback-rate.svg'),
                  H = o.interopDefault(z),
                  X = e('bundle-text:./screenshot.svg'),
                  V = o.interopDefault(X),
                  N = e('bundle-text:./setting.svg'),
                  W = o.interopDefault(N),
                  U = e('bundle-text:./state.svg'),
                  Y = o.interopDefault(U),
                  Z = e('bundle-text:./switch-off.svg'),
                  G = o.interopDefault(Z),
                  K = e('bundle-text:./switch-on.svg'),
                  J = o.interopDefault(K),
                  Q = e('bundle-text:./unlock.svg'),
                  ee = o.interopDefault(Q),
                  et = e('bundle-text:./volume-close.svg'),
                  er = o.interopDefault(et),
                  ea = e('bundle-text:./volume.svg'),
                ...
                r.default = class {
                  constructor(e) {
                    let t = {
                      ...
                      check: h.default,
                      volume: eo.default,
                      volumeClose: er.default,
                      screenshot: V.default,
                      setting: W.default,
                      pip: P.default,
                      arrowLeft: l.default,
                      arrowRight: p.default,
                      playbackRate: H.default,
                      aspectRatio: u.default,
                      config: y.default,
                      lock: A.default,
                      flip: j.default,
                      unlock: ee.default,
                      fullscreenOff: E.default,
                      fullscreenOn: S.default,
                      fullscreenWebOff: T.default,
                      fullscreenWebOn: C.default,
                      switchOn: J.default,
                      switchOff: G.default,
                      error: x.default,
                      close: g.default,
                    ...
                    for (let e in t)
                      (0, ei.def)(this, e, {
                        get: () => (0, ei.getIcon)(e, t[e]),
                      });
                  }
                };
              },
              {
                'bundle-text:./airplay.svg': 'gkZgZ',
                'bundle-text:./arrow-left.svg': 'kQyD4',
                'bundle-text:./arrow-right.svg': '64ztm',
                'bundle-text:./aspect-ratio.svg': '72LvA',
                'bundle-text:./check.svg': '4QmBo',
                'bundle-text:./close.svg': 'j1hoe',
                'bundle-text:./config.svg': 'hNZaT',
                'bundle-text:./error.svg': 'dKh4l',
                'bundle-text:./flip.svg': 'lIEIE',
                'bundle-text:./fullscreen-off.svg': '1533e',
                'bundle-text:./fullscreen-on.svg': '76ut3',
                'bundle-text:./fullscreen-web-off.svg': '3NzMk',
                'bundle-text:./fullscreen-web-on.svg': '12xHc',
                'bundle-text:./loading.svg': 'iVcUF',
                'bundle-text:./lock.svg': '1J4so',
                'bundle-text:./pause.svg': '1KgkK',
                'bundle-text:./pip.svg': '4h4tM',
                'bundle-text:./play.svg': 'jecAY',
                'bundle-text:./playback-rate.svg': 'anPe9',
                'bundle-text:./screenshot.svg': '9BPYQ',
                'bundle-text:./setting.svg': 'hsI9k',
                'bundle-text:./state.svg': 'gr1ZU',
                'bundle-text:./switch-off.svg': '6kdAr',
                'bundle-text:./switch-on.svg': 'ksdMo',
                'bundle-text:./unlock.svg': 'iz5Qc',
                'bundle-text:./volume-close.svg': '3OZoa',
                'bundle-text:./volume.svg': 'hRYA4',
                '../utils': 'aBlEo',
                '@parcel/transformer-js/src/esmodule-helpers.js': 'loqXi',
              },
            ],
            gkZgZ: [
              function (e, t, r, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"><path d="M16 1H2a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h3v-2H3V3h12v8h-2v2h3a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1"/><path d="M4 17h10l-5-6Z"/></svg>';
              },
              {},
            ],
            kQyD4: [
              function (e, t, r, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="m19.41 20.09-4.58-4.59 4.58-4.59L18 9.5l-6 6 6 6Z"/></svg>';
              },
              {},
            ],
            '64ztm': [
              function (e, t, r, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="m12.59 20.34 4.58-4.59-4.58-4.59L14 9.75l6 6-6 6Z"/></svg>';
              },
              {},
            ],
            '72LvA': [
            ...
            '4QmBo': [
              function (e, t, r, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%" viewBox="0 0 24 24"><path d="M9 16.2 4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4Z"/></svg>';
              },
              {},
            ],
            j1hoe: [
            ...
            hNZaT: [
              function (e, t, r, a) {
                t.exports =
                  '<svg width="24" height="24" viewBox="0 0 24 24"><path d="M15 17h6v1h-6Zm-4 0H3v1h8v2h1v-5h-1Zm3-9h1V3h-1v2H3v1h11Zm4-3v1h3V5ZM6 14h1V9H6v2H3v1h3Zm4-2h11v-1H10Z" style="--darkreader-inline-fill:#a8a6a4"/></svg>';
              },
              {},
            ],
            dKh4l: [
            ...
            '1533e': [
              function (e, t, r, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="icon" viewBox="0 0 1024 1024"><path d="M768 298.667h170.667V384h-256V128H768ZM341.333 384h-256v-85.333H256V128h85.333ZM768 725.333V896h-85.333V640h256v85.333ZM341.333 640v256H256V725.333H85.333V640Z"/></svg>';
              },
              {},
            ],
            '76ut3': [
              function (e, t, r, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="icon" viewBox="0 0 1024 1024"><path d="M625.778 256H768v142.222h113.778v-256h-256ZM256 398.222V256h142.222V142.222h-256v256Zm512 227.556V768H625.778v113.778h256v-256ZM398.222 768H256V625.778H142.222v256h256Z"/></svg>';
              },
              {},
            ],
            '3NzMk': [
            ...
            '1KgkK': [
              function (e, t, r, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"><path d="M7 3a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2m8 0a2 2 0 0 0-2 2v12a2 2 0 1 0 4 0V5a2 2 0 0 0-2-2"/></svg>';
              },
              {},
            ],
            '4h4tM': [
            ...
            jecAY: [
              function (e, t, r, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"><path d="M17.982 9.275 8.06 3.27A2.013 2.013 0 0 0 5 4.994v12.011a2.017 2.017 0 0 0 3.06 1.725l9.922-6.005a2.017 2.017 0 0 0 0-3.45"/></svg>';
              },
              {},
            ],
            anPe9: [
              ...
              function (e, t, r, a) {
                ...
                r.default = class {
                  ...
                  set show(e) {
                    ...
                    e
                      ? ((a.textContent =
                          e instanceof Error ? e.message.trim() : e),
                  ...
                  get show() {
                    ...
                    return e.classList.contains('art-notice-show');
                  }
                };
              },
              {
            ...
            uR0Sw: [
              ...
              {
                './airplayMix': 'd8BTB',
                './aspectRatioMix': 'aQNJl',
                './attrMix': '5DA9e',
                './autoHeightMix': '1swKn',
                './autoSizeMix': 'lSbiD',
                './cssVarMix': '32Hp1',
                './currentTimeMix': 'kfZbu',
                './durationMix': 'eV1ag',
                './eventInit': 'f8NQq',
                './flipMix': 'ea3Qm',
                './fullscreenMix': 'ffXE3',
                './fullscreenWebMix': '8tarF',
                './loadedMix': 'f9syH',
                './miniMix': 'dLuS7',
                './optionInit': 'd1F69',
                './pauseMix': 'kewk9',
                './pipMix': '4XzDs',
                './playbackRateMix': 'jphfi',
                './playedMix': 'iNpeS',
                './playingMix': 'aBIWL',
                './playMix': 'hRBri',
                './posterMix': 'fgfXC',
              ...
              function (e, t, r, a) {
                ...
                function n(e) {
                  ...
                  (0, i.def)(e, 'currentTime', {
                    get: () => t.currentTime || 0,
                    set: (r) => {
                      Number.isNaN((r = Number.parseFloat(r))) ||
                ...
                function l(e) {
                  ...
                  e.on('video:canplay', () => {
                    ...
                    e.on('video:error', async (i) => {
                      d < o.RECONNECT_TIME_MAX
                        ? (await (0, s.sleep)(o.RECONNECT_SLEEP_TIME),
                          (d += 1),
                          (e.url = a.url),
                          (r.show = `${t.get('Reconnect')}: ${d}`),
                          e.emit('error', i, d))
                        : ((e.mask.show = !0),
                          (e.loading.show = !1),
                          (e.controls.show = !0),
                ...
                function l(e) {
                  ...
                  e.once('video:loadedmetadata', () => {
                    n.default.isEnabled
                      ...
                      ? (e.on('document:webkitfullscreenchange', () => {
              ...
              function (e, t, r, a) {
                ...
                let o = [
                  ...
                  s = {
                    ...
                    toggle: (e, t) =>
                      s.isFullscreen ? s.exit() : s.request(e, t),
                    onchange(e) {
                      s.on('change', e);
                    },
                    onerror(e) {
                ...
                function n(e) {
                  ...
                  (0, i.def)(e, 'fullscreenWeb', {
                    ...
                    set(n) {
                      n
                        ? ((o = a.style.cssText),
                          t.FULLSCREEN_WEB_IN_BODY &&
                            (0, i.append)(document.body, a),
                ...
                function n(e) {
                  ...
                  (0, i.def)(e, 'loaded', {
                    ...
                    (0, i.def)(e, 'loadedTime', {
                      get: () =>
                        t.buffered.length
                          ? t.buffered.end(t.buffered.length - 1)
                          : 0,
                    });
                }
              },
                      ...
                      if (f) {
                        ...
                        let f = (function () {
                              ...
                              );
                            {
                              ...
                              (0, i.append)(u, t.close), r(u, 'click', p);
                              let f = (0, i.append)(
                                  o,
                              ...
                              return (
                                ...
                                r(m, 'click', () => e.pause()),
                                d(h, m),
                                e.on('video:playing', () => d(h, m)),
                                e.on('video:pause', () => d(h, m)),
                                e.on('video:timeupdate', () => d(h, m)),
                                r(o, 'mousedown', (e) => {
                                  (s = 0 === e.button),
                                    (l = e.pageX),
                                    (c = e.pageY);
            ...
            d1F69: [
              function (e, t, r, a) {
                ...
                function n(e) {
                  ...
                  t.poster &&
                    (0, i.setStyle)(o, 'backgroundImage', `url(${t.poster})`),
                    ...
                    (0, i.def)(e, 'screenshot', {
                      value: async (t) => {
                        let a = await e.getDataURL(),
                          o =
                            t ||
                            `artplayer_${(0, i.secondToTime)(r.currentTime)}`;
                        return (
                          (0, i.download)(a, `${o}.png`),
                          e.emit('screenshot', a),
                          a
                        );
                      },
                ...
                function n(e) {
                  ...
                  (0, i.def)(e, 'seek', {
                    set(r) {
                      (e.currentTime = r),
                        e.duration &&
                          (t.show = `${(0, i.secondToTime)(
                            e.currentTime
                          )} / ${(0, i.secondToTime)(e.duration)}`),
              ...
              function (e, t, r, a) {
                ...
                function n(e) {
                  ...
                  t.hover(
                    ...
                    e.on('setBar', async (t, d, u) => {
                      let f = e.controls?.thumbnails,
                        { url: h, scale: m } = r.thumbnails;
                      if (!f || !h) return;
                      let g = 'played' === t && u && i.isMobile;
                      if ('hover' === t || g) {
                        if (
                          (l ||
                            ((l = !0),
                            (s = await (0, i.loadImg)(h, m)),
                            (c = !0)),
                          !c || !p)
                        )
                          return;
                        let t = a.clientWidth * d;
                          ...
                          t > 0 && t < a.clientWidth
                            ? (function (t) {
                                ...
                                let {
                                  ...
                                  f = p * u || s.naturalWidth / c,
                                  h =
                                    d * u || f / (o.videoWidth / o.videoHeight),
                  ...
                  (0, i.def)(e, 'volume', {
                    ...
                    set: (e) => {
                      (t.volume = (0, i.clamp)(e, 0, 1)),
                        (a.show = `${r.get('Volume')}: ${Number.parseInt(
                          100 * t.volume,
                          10
                        )}`),
            ...
            cjxJL: [
              function (e, t, r, a) {
                ...
                r.default = class {
                  constructor(e) {
                    ...
                    let { option: t } = e;
                    t.miniProgressBar && !t.isLive && this.add(m.default),
                      t.lock && i.isMobile && this.add(f.default),
                      t.autoPlayback && !t.isLive && this.add(c.default),
                      t.autoOrientation && i.isMobile && this.add(s.default),
                      t.fastForward &&
                        i.isMobile &&
                        !t.isLive &&
                        this.add(d.default);
              ...
              {
                '../utils': 'aBlEo',
                './autoOrientation': 'jb9jb',
                './autoPlayback': '21HWM',
                './fastForward': '4sxBO',
                './lock': 'fjy9V',
                './miniProgressBar': 'd0xRp',
                '@parcel/transformer-js/src/esmodule-helpers.js': 'loqXi',
              },
            ],
            jb9jb: [
              function (e, t, r, a) {
                ...
                function n(e) {
                  let {
                    ...
                    n = 'art-auto-orientation',
                    s = 'art-auto-orientation-fullscreen',
                    l = !1;
                  function c() {
                    let { videoWidth: e, videoHeight: t } = o,
                      r = document.documentElement.clientWidth,
                      a = document.documentElement.clientHeight;
                    return (e > t && r < a) || (e < t && r > a);
                  }
                  return (
                    e.on('fullscreenWeb', (t) => {
                      t
                        ? c() &&
                          setTimeout(() => {
                            let t, r;
                            e.fullscreenWeb &&
                              ...
                              (0, i.setStyle)(a, 'width', `${r}px`),
                              (0, i.setStyle)(a, 'height', `${t}px`),
                              (0, i.setStyle)(a, 'transform-origin', '0 0'),
                              (0, i.setStyle)(
                                a,
                                'transform',
                                `rotate(90deg) translate(0, -${t}px)`
                              ),
                              (0, i.addClass)(a, n),
                              (e.isRotate = !0),
                              e.emit('resize'));
                          }, Number(r.AUTO_ORIENTATION_TIME ?? 0))
                        : (0, i.hasClass)(a, n) &&
                          ((0, i.setStyle)(a, 'width', ''),
                          (0, i.setStyle)(a, 'height', ''),
                          (0, i.setStyle)(a, 'transform-origin', ''),
                          (0, i.setStyle)(a, 'transform', ''),
                          (0, i.removeClass)(a, n),
                          (e.isRotate = !1),
                          e.emit('resize'));
                    }),
                    e.on('fullscreen', async (e) => {
                      let r = !!screen?.orientation?.lock;
                      if (e) {
                        if (r && c())
                          try {
                            let e = screen.orientation.type.startsWith(
                              'portrait'
                            )
                              ? 'landscape'
                              : 'portrait';
                        ...
                        ((0, i.hasClass)(a, s) && (0, i.removeClass)(a, s),
                        r && l)
                      ) {
                        try {
              ...
              function (e, t, r, a) {
                ...
                function n(e) {
                  let {
                    ...
                    d = (0, i.query)('.art-auto-playback-close', l);
                  (0, i.append)(d, r.close);
                  let u = null;
                  function f() {
                    ...
                    clearTimeout(u),
                      ...
                      r &&
                        ...
                        (c.textContent = `${t.get('Last Seen')} ${(0,
                        i.secondToTime)(r)}`),
                        (p.textContent = t.get('Jump Play')),
                        n(d, 'click', () => {
                          (0, i.setStyle)(l, 'display', 'none');
                        }),
                        n(p, 'click', () => {
              ...
              function (e, t, r, a) {
                ...
                function n(e) {
                  ...
                  return (
                    ...
                    e.on('document:touchmove', c),
                    e.on('document:touchend', c),
                    {
                      name: 'fastForward',
                      get state() {
                ...
                class g extends s.default {
                  constructor(e) {
                    ...
                    (this.name = 'setting'),
                      ...
                      t.setting &&
                        ...
                        e.on('focus', (e) => {
                          let t = (0, i.includeFromEvent)(e, r.setting),
                            a = (0, i.includeFromEvent)(e, this.$parent);
                          !this.show ||
                            t ||
                            a ||
                            ((this.show = !1), this.render());
                        }),
                  ...
                  get builtin() {
                    let e = [],
                      { option: t } = this.art;
                    return (
                      t.playbackRate && e.push((0, f.default)(this.art)),
                      t.aspectRatio && e.push((0, c.default)(this.art)),
                      t.flip && e.push((0, d.default)(this.art)),
                      t.subtitleOffset && e.push((0, m.default)(this.art)),
                      e
                    );
                  }
                  traverse(e, t = this.option) {
                    for (let r = 0; r < t.length; r++) {
                      let a = t[r];
                      e(a), a.selector?.length && this.traverse(e, a.selector);
                    }
                  }
                  check(e) {
                    (e.$parent.tooltip = e.html),
                      this.traverse((t) => {
                        (t.default = t === e),
                          t.default &&
                            t.$item &&
                            (0, i.inverseClass)(t.$item, 'art-current');
                      }, e.$option),
                    ...
                    for (let o = 0; o < e.length; o++) {
                      ...
                      if (
                        (n?.name
                          ? ((0, i.errorHandle)(
                              !a.includes(n.name),
                              `The [${n.name}] already exists in [setting]`
                            ),
                            a.push(n.name))
                          : (n.name = `setting-${this.id++}`),
                        !n.$formatted)
                      ) {
                        (0, i.def)(n, '$parent', { get: () => t }),
                          (0, i.def)(n, '$parents', { get: () => r }),
                          (0, i.def)(n, '$option', { get: () => e });
                        let a = [];
                        (0, i.def)(n, '$events', { get: () => a }),
                          (0, i.def)(n, '$formatted', { get: () => !0 });
                      }
                      this.format(n.selector || [], n, e, a);
                    }
                    this.option = e;
                  }
                  find(e = '') {
                  ...
                  resize() {
                    ...
                    if (e.setting && this.show) {
                      let n = this.active[0]?.$parent?.width || t,
                        { left: s, width: l } = (0, i.getRect)(e.setting),
                        { left: c, width: p } = (0, i.getRect)(a),
                        d = s - c + l / 2 - n / 2,
                        u =
                      ...
                      if (
                        ((0, i.setStyle)(o, 'height', `${u}px`),
                        (0, i.setStyle)(o, 'width', `${n}px`),
                        this.art.isRotate || i.isMobile)
                      )
                        return;
                      d + n > p
                        ? ((0, i.setStyle)(o, 'left', null),
                          (0, i.setStyle)(o, 'right', null))
                        : ((0, i.setStyle)(o, 'left', `${d}px`),
                          (0, i.setStyle)(o, 'right', 'auto'));
                    }
                  }
                  inactivate(e) {
                  ...
                  remove(e) {
                    let t = this.find(e);
                    (0, i.errorHandle)(t, `Can't find [${e}] in the [setting]`);
                    let r = t.$option.indexOf(t);
                    t.$option.splice(r, 1),
                      this.inactivate(t),
                      t.$item && (0, i.remove)(t.$item),
                      this.render();
                  }
                  update(e) {
                  ...
                  createHeader(e) {
                    ...
                    (0, i.setStyle)(n, 'height', `${o}px`),
                      (0, i.addClass)(n, 'art-setting-item'),
                      (0, i.addClass)(n, 'art-setting-item-back');
                    let s = (0, i.append)(
                        n,
                        '<div class="art-setting-item-left"></div>'
                      ),
                      l = (0, i.createElement)('div');
                    (0, i.addClass)(l, 'art-setting-item-left-icon'),
                      (0, i.append)(l, a),
                      (0, i.append)(s, l),
                      (0, i.append)(s, e.$parent.html);
                    let c = r(n, 'click', () => this.render(e.$parents));
                    e.$parent.$events.push(c), (0, i.append)(t, n);
                  }
                  createItem(e, t = !1) {
                    if (!this.cache.has(e.$option)) return;
                    let r = this.cache.get(e.$option),
                      a = e.$item,
                      o = 'selector';
                    (0, i.has)(e, 'switch') && (o = 'switch'),
                      (0, i.has)(e, 'range') && (o = 'range'),
                      (0, i.has)(e, 'onClick') && (o = 'button');
                    let { icons: n, proxy: s, constructor: l } = this.art,
                      c = (0, i.createElement)('div');
                    (0, i.addClass)(c, 'art-setting-item'),
                      (0, i.setStyle)(
                        c,
                        'height',
                        `${l.SETTING_ITEM_HEIGHT}px`
                      ),
                      (c.dataset.name = e.name || ''),
                      (c.dataset.value = e.value || '');
                    let p = (0, i.append)(
                        c,
                        '<div class="art-setting-item-left"></div>'
                      ),
                      ...
                      u = (0, i.createElement)('div');
                    switch (
                      ((0, i.addClass)(u, 'art-setting-item-left-icon'), o)
                    ) {
                      case 'button':
                      case 'switch':
                      case 'range':
                        (0, i.append)(u, e.icon || n.config);
                        break;
                      case 'selector':
                        e.selector?.length
                          ? (0, i.append)(u, e.icon || n.config)
                          : (0, i.append)(u, n.check);
                    }
                    (0, i.append)(p, u),
                      (0, i.def)(e, '$icon', {
                        configurable: !0,
                      ...
                      (0, i.def)(e, 'icon', {
                        ...
                        get: () => u.innerHTML,
                        set(e) {
                          (u.innerHTML = ''), (0, i.append)(u, e);
                        },
                      });
                    let f = (0, i.createElement)('div');
                    (0, i.addClass)(f, 'art-setting-item-left-text'),
                      (0, i.append)(f, e.html || ''),
                      (0, i.append)(p, f),
                      (0, i.def)(e, '$html', {
                        configurable: !0,
                      ...
                      (0, i.def)(e, 'html', {
                        ...
                        get: () => f.innerHTML,
                        set(e) {
                          (f.innerHTML = ''), (0, i.append)(f, e);
                        },
                      });
                    let h = (0, i.createElement)('div');
                    switch (
                      ((0, i.addClass)(h, 'art-setting-item-right-tooltip'),
                      (0, i.append)(h, e.tooltip || ''),
                      (0, i.append)(d, h),
                      (0, i.def)(e, '$tooltip', {
                        configurable: !0,
                        get: () => h,
                      ...
                      (0, i.def)(e, 'tooltip', {
                        ...
                        get: () => h.innerHTML,
                        set(e) {
                          (h.innerHTML = ''), (0, i.append)(h, e);
                        },
                      }),
                      o)
                    ) {
                      case 'switch': {
                        let t = (0, i.createElement)('div');
                        (0, i.addClass)(t, 'art-setting-item-right-icon');
                        let r = (0, i.append)(t, n.switchOn),
                          a = (0, i.append)(t, n.switchOff);
                        (0, i.setStyle)(e.switch ? a : r, 'display', 'none'),
                          (0, i.append)(d, t),
                          (0, i.def)(e, '$switch', {
                            configurable: !0,
                            get: () => t,
                        ...
                        (0, i.def)(e, 'switch', {
                          ...
                          set(e) {
                            (o = e),
                              e
                                ? ((0, i.setStyle)(a, 'display', 'none'),
                                  (0, i.setStyle)(r, 'display', null))
                                : ((0, i.setStyle)(a, 'display', null),
                                  (0, i.setStyle)(r, 'display', 'none'));
                          },
                        });
                        break;
                      ...
                      case 'range':
                        {
                          let t = (0, i.createElement)('div');
                          (0, i.addClass)(t, 'art-setting-item-right-icon');
                          let r = (0, i.append)(t, '<input type="range">');
                          (r.value = e.range[0]),
                            (r.min = e.range[1]),
                            (r.max = e.range[2]),
                            (r.step = e.range[3]),
                            (0, i.addClass)(r, 'art-setting-range'),
                            (0, i.append)(d, t),
                            (0, i.def)(e, '$range', {
                              configurable: !0,
                              get: () => r,
                      ...
                      case 'selector':
                        if (e.selector?.length) {
                          let e = (0, i.createElement)('div');
                          (0, i.addClass)(e, 'art-setting-item-right-icon'),
                            (0, i.append)(e, n.arrowRight),
                            (0, i.append)(d, e);
                        }
                    }
                    switch (o) {
                      case 'switch':
                        if (e.onSwitch) {
                          let t = s(c, 'click', async (t) => {
                            e.switch = await e.onSwitch.call(this.art, e, c, t);
                          });
                          e.$events.push(t);
                        }
                        break;
                      case 'range':
                        if (e.$range) {
                          if (e.onRange) {
                            let t = s(e.$range, 'change', async (t) => {
                              (e.range[0] = e.$range.valueAsNumber),
                                (e.tooltip = await e.onRange.call(
                                  this.art,
                                  e,
                                  c,
                                  t
                          ...
                          if (e.onChange) {
                            let t = s(e.$range, 'input', async (t) => {
                              (e.range[0] = e.$range.valueAsNumber),
                                (e.tooltip = await e.onChange.call(
                                  this.art,
                                  e,
                                  c,
                                  t
                      ...
                      case 'selector':
                        {
                          ...
                          e.$events.push(t),
                            e.default && (0, i.addClass)(c, 'art-current');
                        }
                        break;
                      case 'button':
                        if (e.onClick) {
                          let t = s(c, 'click', async (t) => {
                            e.tooltip = await e.onClick.call(this.art, e, c, t);
                          });
                          e.$events.push(t);
                        }
                    }
                    (0, i.def)(e, '$item', { configurable: !0, get: () => c }),
                      t ? (0, i.replaceElement)(c, a) : (0, i.append)(r, c),
                      e.mounted &&
                        setTimeout(
                          () => e.mounted.call(this.art, e.$item, e),
                          0
                        );
                  }
                  render(e = this.option) {
                    if (((this.active = e), this.cache.has(e))) {
                      let t = this.cache.get(e);
                      (0, i.inverseClass)(t, 'art-current');
                    } else {
                      let t = (0, i.createElement)('div');
                      this.cache.set(e, t),
                        (0, i.addClass)(t, 'art-setting-panel'),
                        (0, i.append)(this.$parent, t),
                        (0, i.inverseClass)(t, 'art-current'),
                ...
                class u extends d.default {
                  constructor(e) {
                    ...
                    e.on('video:timeupdate', () => {
                      if (!this.url) return;
                      let e =
                        this.art.template.$video.webkitDisplayingFullscreen;
                      'boolean' == typeof e &&
                        e !== t &&
                        ((t = e),
                        this.createTrack(
                          e ? 'subtitles' : 'metadata',
                          this.url
                        ));
                    });
                  }
                  ...
                  get activeCues() {
                    return this.textTrack
                      ? Array.from(this.textTrack.activeCues)
                      : [];
                  }
                  get cues() {
                    return this.textTrack
                  ...
                  async switch(e, t = {}) {
                    ...
                    return (
                      t.name &&
                        (a.show = `${r.get('Switch Subtitle')}: ${t.name}`),
                      n
                    );
                  }
                  createTrack(e, t) {
                    let { template: r, proxy: a, option: o } = this.art,
                      { $video: i, $track: n } = r,
                      s = (0, c.createElement)('track');
                    (s.default = !0),
                      (s.kind = e),
                      (s.src = t),
                      (s.label = o.subtitle.name || 'Artplayer'),
                      (s.track.mode = 'hidden'),
                      (s.onload = () => {
                  ...
                  async init(e) {
                    ...
                    return this.textTrack
                      ? ((0, n.default)(e, l.default.subtitle), e.url)
                        ? ((this.option = e),
                          this.style(e.style),
                          fetch(e.url)
                            ...
                            .then((t) => {
                              ...
                              switch (e.type || (0, c.getExt)(e.url)) {
                                case 'srt': {
                                  let t = (0, c.srtToVtt)(r),
                                    a = e.onVttLoad(t);
                                  return (0, c.vttToBlob)(a);
                                }
                                case 'ass': {
                                  let t = (0, c.assToVtt)(r),
                                    a = e.onVttLoad(t);
                                  return (0, c.vttToBlob)(a);
                                }
                                case 'vtt': {
                                  let t = e.onVttLoad(r);
                                  return (0, c.vttToBlob)(t);
                                }
                                default:
                                  return e.url;
                              }
                ...
                class n {
                  ...
                  init() {
                    ...
                    if (
                      ...
                      (this.$controlsCenter = this.query(
                        '.art-controls-center'
                      )),
      ...
      let { default: a } = parcelRequire4dc0('esqvp');
    },
  },
]);
