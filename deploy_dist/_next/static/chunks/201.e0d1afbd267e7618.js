...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [201],
  {
    9201: function (e, t, i) {
      i.r(t),
        ...
        (function (e, t, i, a, n, o, s, l) {
          ...
          function m(t, i) {
            if (!u[t]) {
              ...
              (p.resolve = function (i) {
                ...
                (p.cache = {});
              var l = (u[t] = new m.Module(t));
              e[t][0].call(l.exports, p, l, l.exports, r);
            }
            return u[t].exports;
            function p(e) {
              var t = p.resolve(e);
          ...
          (m.isParcelRequire = !0),
            ...
            (r[a] = m);
          for (var c = 0; c < t.length; c++) m(t[c]);
          if (i) {
            var f = m(i);
        ...
        })(
          {
            '7ICE7': [
              function (e, t, i, a) {
                ...
                function u(e) {
                  return (t) => {
                    let i = new s.default(t, e),
                      a = new p.default(t, i);
                    return (
                      i.option.heatmap &&
                        (0, r.default)(t, i, i.option.heatmap),
                      {
                ...
                (u.icons = p.default.icons),
                  'undefined' != typeof window &&
                    (window.artplayerPluginDanmuku = u);
              },
              {
                './danmuku': '9bpce',
                './heatmap': '9KNY2',
                './setting': '94xSe',
                '@parcel/transformer-js/src/esmodule-helpers.js': 'loqXi',
              },
            ],
            '9bpce': [
              function (e, t, i, a) {
                ...
                var o = e('bundle-text:./worker'),
                  s = n.interopDefault(o),
                  l = e('./bilibili');
                class r {
                  constructor(e, t) {
                    let { constructor: i, template: a } = e;
                    (this.utils = i.utils),
                      (this.validator = i.validator),
                      (this.$danmuku = a.$danmuku),
                      ...
                      this.config(t, !0);
                    let n = new Blob(
                      [s.default.replace('export{e as default};', '')],
                  ...
                  get marginTop() {
                    let { clamp: e } = this.utils,
                      t = this.option.margin[0],
                      { clientHeight: i } = this.$player;
                    return 'number' == typeof t
                      ? e(t, 0, i)
                      : 'string' == typeof t && t.endsWith('%')
                      ? e((Number.parseFloat(t) / 100) * i, 0, i)
                      : r.option.margin[0];
                  }
                  get marginBottom() {
                    let { clamp: e } = this.utils,
                      t = this.option.margin[1],
                      { clientHeight: i } = this.$player;
                    return 'number' == typeof t
                      ? e(t, 0, i)
                      : 'string' == typeof t && t.endsWith('%')
                  ...
                  get fontSize() {
                    let { clamp: e } = this.utils,
                      { clientHeight: t } = this.$player,
                      i = this.option.fontSize;
                    return 'number' == typeof i
                      ? Math.round(e(i, 12, t))
                      : 'string' == typeof i && i.endsWith('%')
                      ? Math.round(e((Number.parseFloat(i) / 100) * t, 12, t))
                      : r.option.fontSize;
                  }
                  get $ref() {
                    let e = this.$refs.pop() || document.createElement('div');
                    return (
                      (e.style.cssText = r.cssText),
                      (e.dataset.mode = ''),
                      (e.dataset.id = ''),
                      (e.className = ''),
                      e
                  ...
                  get readys() {
                    let { currentTime: e } = this.art,
                      t = [];
                    return (
                      this.filter('ready', (e) => t.push(e)),
                      this.filter('wait', (i) => {
                        e + 0.1 >= i.time && i.time >= e - 0.1 && t.push(i);
                      }),
                      t
                    );
                  }
                  get visibles() {
                    let e = [],
                      { clientWidth: t } = this.$player,
                      i = this.getLeft(this.$player);
                    return (
                      this.filter('emit', (a) => {
                        let n = a.$ref.offsetTop,
                          o = this.getLeft(a.$ref) - i,
                          s = a.$ref.clientHeight,
                          l = a.$ref.clientWidth,
                          r = o + l,
                          d = r / a.$restTime,
                          p = {};
                  ...
                  get speed() {
                    return this.option.synchronousPlayback &&
                      this.art.playbackRate
                      ? this.option.speed / Number(this.art.playbackRate)
                      : this.option.speed;
                  }
                  async load(e) {
                    let { errorHandle: t } = this.utils,
                      i = [],
                      a = e || this.option.danmuku;
                    try {
                      'function' == typeof a
                        ? (i = await a())
                        ...
                        ? (i = await a)
                        : 'string' == typeof a
                        ? (i = await (0, l.bilibiliDanmuParseFromUrl)(a))
                        : Array.isArray(a) && (i = a),
                        t(
                          Array.isArray(i),
                      ...
                      throw (
                        (this.art.emit('artplayerPluginDanmuku:error', e), e)
                      );
                    }
                    return this;
                  }
                  async emit(e) {
                    let { clamp: t } = this.utils;
                    if (
                      (this.validator(e, {
                        id: '?string',
                        text: 'string',
                      ...
                      !e.text.trim() ||
                        (e.time
                          ? (e.time = t(e.time, 0, 1 / 0))
                          : (e.time = this.art.currentTime + 0.5),
                        void 0 === e.mode && (e.mode = this.option.mode),
                        void 0 === e.style && (e.style = {}),
                        void 0 === e.color && (e.color = this.option.color),
                        ![0, 1, 2].includes(e.mode) || !this.option.filter(e)))
                    )
                      return this;
                    let i = {
                      ...e,
                  ...
                  config(e, t = !1) {
                    let { clamp: i } = this.utils,
                      { $controlsCenter: a } = this.art.template;
                    return (
                      (Object.keys(e).some(
                        (t) =>
                          JSON.stringify(this.option[t]) !==
                          JSON.stringify(e[t])
                      ) ||
                        t) &&
                        ...
                        this.validator(this.option, r.scheme),
                        (this.option.mode = i(this.option.mode, 0, 2)),
                        (this.option.speed = i(this.option.speed, 1, 10)),
                        (this.option.opacity = i(this.option.opacity, 0, 1)),
                        (this.option.lockTime = i(this.option.lockTime, 1, 60)),
                        (this.option.maxLength = i(
                          this.option.maxLength,
                          1,
                          1e3
                        )),
                        (this.option.mount = this.option.mount || a),
                        e.fontSize && this.reset(),
                  ...
                  getLeft(e) {
                    ...
                    return this.isRotate ? t.top : t.left;
                  }
                  postMessage(e = {}) {
                  ...
                  setState(e, t) {
                    (this.states[e.$state] = this.states[e.$state].filter(
                      (t) => t !== e
                    )),
                      (e.$state = t),
                      e.$ref && (e.$ref.dataset.state = t),
                      this.states[t].push(e);
                  }
                  makeWait(e) {
                    this.setState(e, 'wait'),
                      e.$ref &&
                        ((e.$ref.style.cssText = r.cssText),
                        (e.$ref.style.visibility = 'hidden'),
                        (e.$ref.style.marginLeft = '0px'),
                        (e.$ref.style.transform = 'translateX(0px)'),
                        (e.$ref.style.transition = 'transform 0s linear 0s'),
                        this.$refs.push(e.$ref),
                        (e.$ref = null));
                  }
                  update() {
                    ...
                    return (
                      (this.timer = window.requestAnimationFrame(async () => {
                        if (this.art.playing && !this.isHide) {
                          this.filter('emit', (e) => {
                            let t = (Date.now() - e.$lastStartTime) / 1e3;
                            (e.$restTime -= t),
                              (e.$lastStartTime = Date.now()),
                              e.$restTime <= 0 && this.makeWait(e);
                          });
                          let t = this.readys;
                          for (let i = 0; i < t.length; i++) {
                            let a = t[i];
                            if (await this.option.beforeVisible(a)) {
                              let { clientWidth: t, clientHeight: i } =
                                this.$player;
                              (a.$ref = this.$ref),
                                ...
                                (a.$restTime = this.speed);
                              let n = t + a.$ref.clientWidth,
                                { result: o } = await this.postMessage({
                                  type: 'getDanmuTop',
                                  target: {
                                    mode: a.mode,
                              ...
                              if (a.$ref) {
                                if (this.isStop || void 0 === o)
                                  this.setState(a, 'ready'),
                                    this.$refs.push(a.$ref),
                                    (a.$ref = null);
                                else {
                                  switch (
                                    (this.setState(a, 'emit'),
                                    (a.$ref.style.top = `${o}px`),
                                    ...
                                    case 0:
                                      (a.$ref.style.left = `${t}px`),
                                        ...
                                        (a.$ref.style.transform = `translateX(${-n}px)`),
                                  ...
                                  this.art.emit(
                                    'artplayerPluginDanmuku:visible',
                                    a
                                  );
                                }
                              }
                  ...
                  resize() {
                    ...
                    this.filter('stop', (t) => {
                      0 === t.mode && (t.$ref.style.left = `${e}px`);
                    }),
                      this.filter('emit', (t) => {
                        if (((t.$lastStartTime = Date.now()), 0 === t.mode)) {
                          let i = e + t.$ref.clientWidth;
                          (t.$ref.style.left = `${e}px`),
                            (t.$ref.style.transform = `translateX(${-i}px)`),
                  ...
                  suspend() {
                    ...
                    return (
                      this.filter('emit', (t) => {
                        if ((this.setState(t, 'stop'), 0 === t.mode)) {
                          let i =
                            e -
                            (this.getLeft(t.$ref) - this.getLeft(this.$player));
                          (t.$ref.style.transform = `translateX(${-i}px)`),
                  ...
                  reset() {
                    return (
                      this.queue.forEach((e) => this.makeWait(e)),
            ...
            '5Elzl': [
              function (e, t, i, a) {
                t.exports =
                  '!function(e,t,i,o,r,n,l,d){var u="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},f="function"==typeof u[o]&&u[o],p=f.i||{},s=f.cache||{},h="undefined"!=typeof module&&"function"==typeof module.require&&module.require.bind(module);function a(t,i){if(!s[t]){if(!e[t]){if(r[t])return r[t];var n="function"==typeof u[o]&&u[o];if(!i&&n)return n(t,!0);if(f)return f(t,!0);if(h&&"string"==typeof t)return h(t);var l=Error("Cannot find module \'"+t+"\'");throw l.code="MODULE_NOT_FOUND",l}p.resolve=function(i){var o=e[t][1][i];return null!=o?o:i},p.cache={};var d=s[t]=new a.Module(t);e[t][0].call(d.exports,p,d,d.exports,u)}return s[t].exports;function p(e){var t=p.resolve(e);return!1===t?{}:a(t)}}a.isParcelRequire=!0,a.Module=function(e){this.id=e,this.bundle=a,this.require=h,this.exports={}},a.modules=e,a.cache=s,a.parent=f,a.distDir=void 0,a.publicUrl=void 0,a.devServer=void 0,a.i=p,a.register=function(t,i){e[t]=[function(e,t){t.exports=i},{}]},Object.defineProperty(a,"root",{get:function(){return u[o]}}),u[o]=a;for(var c=0;c<t.length;c++)a(t[c]);if(i){var g=a(i);"object"==typeof exports&&"undefined"!=typeof module?module.exports=g:"function"==typeof define&&define.amd&&define(function(){return g})}}({b8YFA:[function(e,t,i,o){function r({target:e,visibles:t,clientWidth:i,clientHeight:o,marginBottom:r,marginTop:n,antiOverlap:l}){let d=o-r,u=t.filter(t=>t.mode===e.mode&&t.top<=d).sort((e,t)=>e.top-t.top);if(0===u.length)if(2===e.mode)return d-e.height;else return n;if(u.unshift({type:"top",top:0,left:0,right:0,height:n,width:i,speed:0,distance:i}),u.push({type:"bottom",top:d,left:0,right:0,height:r,width:i,speed:0,distance:i}),2===e.mode)for(let t=u.length-2;t>=0;t-=1){let i=u[t],o=u[t+1],r=i.top+i.height;if(o.top-r>=e.height)return o.top-e.height}else for(let t=1;t<u.length;t+=1){let i=u[t],o=u[t-1],r=o.top+o.height;if(i.top-r>=e.height)return r}let f=[];for(let e=1;e<u.length-1;e+=1){let t=u[e];if(f.length){let e=f[f.length-1];e[0].top===t.top?e.push(t):f.push([t])}else f.push([t])}if(l)switch(e.mode){case 0:{let t=f.find(t=>t.every(t=>!(i<t.distance)&&(!!(e.speed<t.speed)||!!(t.right/(e.speed-t.speed)>t.time))));return t&&t[0]?t[0].top:void 0}case 1:case 2:return}else{switch(e.mode){case 0:f.sort((e,t)=>{let i=Math.min(...t.map(e=>e.right)),o=Math.min(...e.map(e=>e.right));return i*t.length-o*e.length});break;case 1:case 2:f.sort((e,t)=>{let i=Math.max(...t.map(e=>e.width));return Math.max(...e.map(e=>e.width))*e.length-i*t.length})}return f[0][0].top}}onmessage=e=>{let{data:t}=e;t.id&&t.type&&globalThis.postMessage({result:(0,({getDanmuTop:r})[t.type])(t),id:t.id})}},{}]},["b8YFA"],"b8YFA","parcelRequire4dc0",{});let{"*":e}=parcelRequire4dc0("b8YFA");export{e as default};';
              },
              {},
            ],
            f9FoX: [
              function (e, t, i, a) {
                ...
                function l({ data: e }) {
                  let { xml: t, id: i } = e;
                  i && t && globalThis.postMessage({ danmus: s(t), id: i });
                }
                function r(e) {
                  return new Promise(async (t) => {
                    ...
                    try {
                      ...
                      let i =
                        ((e = new Blob(
                          [
                            ` ${o.toString()} ${s.toString()} onmessage = ${l.toString()} `,
                          ],
                          { type: 'application/javascript' }
                        )),
                        new Worker(URL.createObjectURL(e)));
                      (i.onmessage = (e) => {
                        let { danmus: a, id: n } = e.data;
                        n && a && (t(a), i.terminate());
                      }),
                        i.postMessage({ xml: a, id: Date.now() });
                    } catch (e) {
                      console.error('Error parsing Bilibili Danmu:', e),
                        t(s(a));
                    }
                  });
                }
                n.defineInteropFlag(i),
                  n.export(i, 'bilibiliDanmuParseFromUrl', () => r);
              },
              { '@parcel/transformer-js/src/esmodule-helpers.js': 'loqXi' },
            ],
            loqXi: [
              function (e, t, i, a) {
                (i.interopDefault = function (e) {
                  return e && e.__esModule ? e : { default: e };
                }),
                  (i.defineInteropFlag = function (e) {
                    Object.defineProperty(e, '__esModule', { value: !0 });
                  }),
                  (i.exportAll = function (e, t) {
                    return (
            ...
            '9KNY2': [
              function (e, t, i, a) {
                var n = e('@parcel/transformer-js/src/esmodule-helpers.js');
                n.defineInteropFlag(i), n.export(i, 'default', () => s);
                let o = {
                  map: (e, t, i, a, n) => ((e - t) * (n - a)) / (i - t) + a,
                  range(e, t, i) {
                    let a = Math.round(e / i) * i;
                    return Array.from(
                      { length: Math.floor((t - e) / i) },
                      (e, t) => t * i + a
                    );
                  },
                };
                function s(e, t, i) {
                  let { query: a } = e.constructor.utils;
                  e.controls.add({
                    name: 'heatmap',
                    position: 'top',
                    html: '',
                    ...
                    mounted(n) {
                      ...
                      function r(r = []) {
                        if (
                          ...
                          (l = null),
                          (n.innerHTML = ''),
                          !e.duration || e.option.isLive)
                        )
                          return;
                        let d = { w: n.offsetWidth, h: n.offsetHeight },
                          p = {
                            xMin: 0,
                            xMax: d.w,
                            yMin: 0,
                            ...
                            scale: 0.25,
                            opacity: 0.2,
                            minHeight: Math.floor(0.05 * d.h),
                            sampling: Math.floor(d.w / 100),
                            smoothing: 0.2,
                            flattening: 0.2,
                          };
                        'object' == typeof i && Object.assign(p, i);
                        let u = [];
                        if (Array.isArray(r) && r.length) u = [...r];
                        else {
                          let i = e.duration / d.w;
                          for (let e = 0; e <= d.w; e += p.sampling) {
                            let a = t.queue.filter(
                              ({ time: t }) =>
                                t > e * i && t <= (e + p.sampling) * i
                            ).length;
                            u.push([e, a]);
                          }
                        }
                        ...
                        let y = (e, t, i, a) => {
                            ...
                            let d =
                              ...
                              u = o.map(
                                Math.cos(d.angle) * p.flattening,
                                0,
                                1,
                                1,
                                0
                              ),
                              h = d.angle * u + (a ? Math.PI : 0),
                              m = d.length * p.smoothing;
                            return [
                              e[0] + Math.cos(h) * m,
                              e[1] + Math.sin(h) * m,
                            ];
                          ...
                          v = u
                            .map((e) => [
                              o.map(e[0], p.xMin, p.xMax, 0, d.w),
                              o.map(e[1], p.yMin, p.yMax, d.h, 0),
                            ])
                            .reduce((e, t, i, a) => {
                              let n, o, s;
                              return 0 === i
                                ? `M ${a[a.length - 1][0]},${d.h} L ${t[0]},${
                                    d.h
                                  } L ${t[0]},${t[1]}`
                                : `${e} ${
                                    ((n = y(a[i - 1], a[i - 2], t)),
                                    (o = y(t, a[i - 1], a[i + 1], !0)),
                                    (s = i === a.length - 1 ? ' z' : ''),
                                    `C ${n[0]},${n[1]} ${o[0]},${o[1]} ${t[0]},${t[1]}${s}`)
                                  }`;
                            }, '');
                        (n.innerHTML = `<svg viewBox="0 0 ${d.w} ${d.h}"><defs><linearGradient id="heatmap-solids" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" style="stop-color:var(--art-theme);stop-opacity:${p.opacity}" /><stop offset="0%" style="stop-color:var(--art-theme);stop-opacity:${p.opacity}" id="heatmap-start" /><stop offset="0%" style="stop-color:var(--art-progress-color);stop-opacity:1" id="heatmap-stop" /><stop offset="100%" style="stop-color:var(--art-progress-color);stop-opacity:1" /></linearGradient></defs><path fill="url(#heatmap-solids)" d="${v}"></path></svg>`),
                          (s = a('#heatmap-start', n)),
                          (l = a('#heatmap-stop', n)),
                          s.setAttribute('offset', `${100 * e.played}%`),
                          l.setAttribute('offset', `${100 * e.played}%`);
                      }
                      e.on('video:timeupdate', () => {
                        ...
                        e.on('setBar', (e, t) => {
                          s &&
                            l &&
                            'played' === e &&
                            (s.setAttribute('offset', `${100 * t}%`),
                            l.setAttribute('offset', `${100 * t}%`));
                        }),
                        e.on('ready', () => r()),
                        e.on('resize', () => r()),
                        e.on('artplayerPluginDanmuku:loaded', () => r()),
                        e.on('artplayerPluginDanmuku:points', (e) => r(e));
                    },
                  });
                }
              },
            ...
            '94xSe': [
              function (e, t, i, a) {
                var n = e('@parcel/transformer-js/src/esmodule-helpers.js');
                n.defineInteropFlag(i);
                var o = e('bundle-text:./img/check_off.svg'),
                  s = n.interopDefault(o),
                  l = e('bundle-text:./img/check_on.svg'),
                  r = n.interopDefault(l),
                  d = e('bundle-text:./img/config.svg'),
                  p = n.interopDefault(d),
                  u = e('bundle-text:./img/mode_0_off.svg'),
                  h = n.interopDefault(u),
                  m = e('bundle-text:./img/mode_0_on.svg'),
                  c = n.interopDefault(m),
                  f = e('bundle-text:./img/mode_1_off.svg'),
                  g = n.interopDefault(f),
                  y = e('bundle-text:./img/mode_1_on.svg'),
                  v = n.interopDefault(y),
                  x = e('bundle-text:./img/mode_2_off.svg'),
                  $ = n.interopDefault(x),
                  k = e('bundle-text:./img/mode_2_on.svg'),
                  b = n.interopDefault(k),
                  w = e('bundle-text:./img/off.svg'),
                  M = n.interopDefault(w),
                  S = e('bundle-text:./img/on.svg'),
                  D = n.interopDefault(S),
                  E = e('bundle-text:./img/style.svg'),
                  C = n.interopDefault(E),
                  q = e('bundle-text:./style.less'),
                  T = n.interopDefault(q);
                if (
                  ((i.default = class {
                    constructor(e, t) {
                      (this.art = e),
                        (this.danmuku = t),
                        (this.utils = e.constructor.utils);
                      let { setStyle: i } = this.utils,
                        { $controlsCenter: a } = e.template;
                      i(a, 'display', 'flex'),
                        (this.template = {
                          $controlsCenter: a,
                          $mount: a,
                        ...
                        e.on('resize', () => this.resize()),
                        e.on('fullscreen', (e) => this.onFullscreen(e)),
                        e.on('fullscreenWeb', (e) => this.onFullscreen(e)),
                        e.proxy(this.template.$config, 'mouseenter', () => {
                          this.onMouseEnter({
                            $control: this.template.$config,
                            $panel: this.template.$configPanel,
                          });
                        }),
                        e.proxy(this.template.$style, 'mouseenter', () => {
                          this.onMouseEnter({
                    ...
                    static get icons() {
                      return {
                        ...
                        $config: p.default,
                        $style: C.default,
                        $mode_0_off: h.default,
                        $mode_0_on: c.default,
                        $mode_1_off: g.default,
                        $mode_1_on: v.default,
                        $mode_2_off: $.default,
                        $mode_2_on: b.default,
                        $check_on: r.default,
                    ...
                    get outside() {
                      return (
                        this.template.$mount !== this.template.$controlsCenter
                      );
                    }
                    get TEMPLATE() {
                      let { option: e } = this;
                      return `<div class="apd-toggle">${D.default}${
                        M.default
                      }</div><div class="apd-config">${
                        p.default
                      }<div class="apd-config-panel"><div class="apd-config-panel-inner"><div class="apd-config-mode">\u{6309}\u{7C7B}\u{578B}\u{5C4F}\u{853D}<div class="apd-modes"><div data-mode="0" class="apd-mode">${
                        h.default
                      }${
                        c.default
                      }<div>\u{6EDA}\u{52A8}</div></div><div data-mode="1" class="apd-mode">${
                        g.default
                      }${
                        v.default
                      }<div>\u{9876}\u{90E8}</div></div><div data-mode="2" class="apd-mode">${
                        $.default
                      }${
                        b.default
                      }<div>\u{5E95}\u{90E8}</div></div></div></div><div class="apd-config-other"><div class="apd-other apd-anti-overlap">${
                        r.default
                      }${
                        s.default
                      } \u{9632}\u{6B62}\u{5F39}\u{5E55}\u{91CD}\u{53E0}</div><div class="apd-other apd-sync-video">${
                        r.default
                      }${
                        s.default
                      } \u{540C}\u{6B65}\u{89C6}\u{9891}\u{901F}\u{5EA6}</div></div><div class="apd-config-slider apd-config-opacity">\u{4E0D}\u{900F}\u{660E}\u{5EA6}<div class="apd-slider"></div><div class="apd-value">\u{672A}\u{77E5}</div></div><div class="apd-config-slider apd-config-margin">\u{663E}\u{793A}\u{533A}\u{57DF}<div class="apd-slider"></div><div class="apd-value">\u{672A}\u{77E5}</div></div><div class="apd-config-slider apd-config-fontSize">\u{5F39}\u{5E55}\u{5B57}\u{53F7}<div class="apd-slider"></div><div class="apd-value">\u{672A}\u{77E5}</div></div><div class="apd-config-slider apd-config-speed">\u{5F39}\u{5E55}\u{901F}\u{5EA6}<div class="apd-slider"></div><div class="apd-value">\u{672A}\u{77E5}</div></div></div></div></div><div class="apd-emitter"><div class="apd-style">${
                        C.default
                      }<div class="apd-style-panel"><div class="apd-style-panel-inner"><div class="apd-style-mode">\u{6A21}\u{5F0F}<div class="apd-modes"><div data-mode="0" class="apd-mode">${
                        c.default
                      }<div>\u{6EDA}\u{52A8}</div></div><div data-mode="1" class="apd-mode">${
                        v.default
                      }<div>\u{9876}\u{90E8}</div></div><div data-mode="2" class="apd-mode">${
                        b.default
                      }<div>\u{5E95}\u{90E8}</div></div></div></div><div class="apd-style-color">\u{989C}\u{8272}<div class="apd-colors">${this.COLOR.map(
                        (e) =>
                          `<div data-color="${e}" class="apd-color" style="background-color: ${e}"></div>`
                      ).join(
                        ''
                      )}</div></div></div></div></div><input class="apd-input" placeholder="\u{53D1}\u{4E2A}\u{53CB}\u{5584}\u{7684}\u{5F39}\u{5E55}\u{89C1}\u{8BC1}\u{5F53}\u{4E0B}" autocomplete="off" maxLength="${
                        e.maxLength
                      }" /><div class="apd-send">\u{53D1}\u{9001}</div></div>`;
                    }
                    get OPACITY() {
                      return {
                        min: 0,
                    ...
                    get SPEED() {
                      return {
                        ...
                        steps: [
                          { name: '极慢', value: 10 },
                          { name: '较慢', value: 7.5, hide: !0 },
                          { name: '适中', value: 5 },
                          { name: '较快', value: 2.5, hide: !0 },
                          { name: '极快', value: 1 },
                        ],
                        ...this.option.SPEED,
                      };
                    ...
                    query(e) {
                      let { query: t } = this.utils,
                        { $danmuku: i } = this.template;
                      return t(e, i);
                    }
                    append(e, t) {
                      let { append: i } = this.utils;
                      [...e.children].includes(t) || i(e, t);
                    }
                    setData(e, t) {
                      let { $player: i } = this.art.template,
                        { $mount: a } = this.template;
                      (i.dataset[e] = t), this.outside && (a.dataset[e] = t);
                    }
                    createTemplate() {
                      let { createElement: e, tooltip: t } = this.utils,
                        i = e('div');
                      (i.className = 'artplayer-plugin-danmuku'),
                        ...
                        (this.template.$configPanel =
                          this.query('.apd-config-panel')),
                        (this.template.$configModes = this.query(
                          '.apd-config-mode .apd-modes'
                        )),
                        (this.template.$style = this.query('.apd-style')),
                        (this.template.$stylePanel =
                          this.query('.apd-style-panel')),
                        (this.template.$styleModes = this.query(
                          '.apd-style-mode .apd-modes'
                        )),
                        (this.template.$colors = this.query('.apd-colors')),
                        (this.template.$antiOverlap =
                          this.query('.apd-anti-overlap')),
                        (this.template.$syncVideo =
                          this.query('.apd-sync-video')),
                    ...
                    createEvents() {
                      ...
                      this.art.proxy(e, 'click', () => {
                        this.danmuku.config({ visible: !this.option.visible }),
                          this.reset();
                      }),
                        this.art.proxy(t, 'click', (e) => {
                          let t = e.target.closest('.apd-mode');
                          if (!t) return;
                          let i = Number(t.dataset.mode);
                          this.option.modes.includes(i)
                            ? this.danmuku.config({
                                modes: this.option.modes.filter((e) => e !== i),
                              })
                            : this.danmuku.config({
                                modes: [...this.option.modes, i],
                              }),
                            this.reset();
                        }),
                        ...
                        this.art.proxy(o, 'click', () => {
                          this.danmuku.config({
                            synchronousPlayback:
                              !this.option.synchronousPlayback,
                          }),
                            this.reset();
                        }),
                        this.art.proxy(i, 'click', (e) => {
                          let t = e.target.closest('.apd-mode');
                          if (!t) return;
                          let i = Number(t.dataset.mode);
                          this.danmuku.config({ mode: i }), this.reset();
                        }),
                        this.art.proxy(a, 'click', (e) => {
                          let t = e.target.closest('.apd-color');
                          t &&
                            (this.danmuku.config({ color: t.dataset.color }),
                            this.reset());
                        }),
                        this.art.proxy(s, 'click', () => this.emit()),
                        this.art.proxy(l, 'keypress', (e) => {
                          'Enter' === e.key &&
                            (e.preventDefault(), this.emit());
                        });
                    }
                    createSliders() {
                      (this.slider.opacity = this.createSlider({
                        ...
                        onChange: (e) => {
                          let { $opacityValue: t } = this.template;
                          (t.textContent = `${e}%`),
                            this.danmuku.config({ opacity: e / 100 });
                        },
                      })),
                        (this.slider.margin = this.createSlider({
                          ...
                          findIndex: () =>
                            this.MARGIN.steps.findIndex(
                              (e) =>
                                e.value[0] === this.option.margin[0] &&
                                e.value[1] === this.option.margin[1]
                            ),
                          onChange: (e) => {
                            let t = this.MARGIN.steps[e];
                            if (!t) return;
                            let { $marginValue: i } = this.template;
                            (i.textContent = t.name),
                              this.danmuku.config({ margin: t.value });
                          },
                        })),
                        (this.slider.fontSize = this.createSlider({
                          ...
                          onChange: (e) => {
                            let { $fontSizeValue: t } = this.template;
                            (t.textContent = `${e}px`),
                              e !== this.danmuku.fontSize &&
                                this.danmuku.config({ fontSize: e });
                          },
                        })),
                        (this.slider.speed = this.createSlider({
                          ...
                          findIndex: () =>
                            this.SPEED.steps.findIndex(
                              (e) => e.value === this.option.speed
                            ),
                          onChange: (e) => {
                            let t = this.SPEED.steps[e];
                            if (!t) return;
                            let { $speedValue: i } = this.template;
                            (i.textContent = t.name),
                              this.danmuku.config({ speed: t.value });
                          },
                        }));
                    }
                    createSlider({
                      ...
                      r(i, 'touch-action', 'none'),
                        (i.innerHTML = `<div class="apd-slider-line"><div class="apd-slider-points">${o
                          .map(() => '<div class="apd-slider-point"></div>')
                          .join(
                            ''
                          )}</div><div class="apd-slider-progress"></div></div><div class="apd-slider-dot"></div><div class="apd-slider-steps">${o
                          .map((e) =>
                            e.hide
                              ? ''
                              : `<div class="apd-slider-step">${e.name}</div>`
                          )
                          .join('')}</div>`);
                      let d = s('.apd-slider-dot', i),
                      ...
                      function m(a) {
                        ...
                        this.art.isRotate
                          ? h(
                              Math.round(
                                (l(a.clientY - n, 0, o) / o) * (t - e) + e
                              )
                            )
                          : h(
                              Math.round(
                                (l(a.clientX - s, 0, r) / r) * (t - e) + e
                              )
                            );
                      }
                      return (
                        ...
                        this.art.proxy(i, 'pointerdown', (e) => {
                          u = 0 === e.button;
                        }),
                        this.art.on('document:pointermove', (e) => {
                          u && m.call(this, e);
                        }),
                        this.art.on('document:pointerup', (e) => {
                          u && ((u = !1), m.call(this, e));
                        }),
                        { reset: h }
                      );
                    ...
                    onMouseEnter({ $control: e, $panel: t }) {
                      let { $player: i } = this.art.template,
                        a = e.getBoundingClientRect(),
                        n = t.getBoundingClientRect(),
                        o = i.getBoundingClientRect(),
                        s = n.width / 2 - a.width / 2,
                        l = o.left - (a.left - s),
                        r = a.right + s - o.right;
                      l > 0
                        ? (t.style.left = `${-s + l}px`)
                    ...
                    async emit() {
                      let { $input: e } = this.template,
                        t = e.value.trim();
                      if (!t.length || this.isLock || this.emitting) return;
                      let i = {
                        text: t,
                      ...
                      try {
                        this.emitting = !0;
                        let t = await this.option.beforeEmit(i);
                        if (((this.emitting = !1), !0 !== t)) return;
                        (i.border = !0),
                          delete i.time,
                          this.danmuku.emit(i),
                          (e.value = ''),
                        ...
                        console.error('Error emitting danmuku:', e),
                          (this.emitting = !1);
                      }
                    }
                    lock() {
                      let { addClass: e } = this.utils,
                        { $send: t } = this.template;
                      this.isLock = !0;
                      let i = this.option.lockTime;
                      (t.textContent = i), e(t, 'apd-lock');
                      let a = () => {
                    ...
                    resize() {
                      if (
                        this.outside ||
                        this.art.fullscreen ||
                        this.art.fullscreenWeb
                      )
                        return;
                      let { $player: e, $controlsCenter: t } =
                          this.art.template,
                        { $danmuku: i } = this.template;
                    ...
                    reset() {
                      let { inverseClass: e, tooltip: t } = this.utils,
                        { $toggle: i, $colors: a } = this.template;
                      this.slider.opacity.reset(),
                        ...
                        this.setData(
                          'danmukuMode0',
                          this.option.modes.includes(0)
                        ),
                        this.setData(
                          'danmukuMode1',
                          this.option.modes.includes(1)
                        ),
                        this.setData(
                          'danmukuMode2',
                          this.option.modes.includes(2)
                        ),
                        this.setData(
                          'danmukuAntiOverlap',
                          this.option.antiOverlap
                        ),
                        this.setData(
                          'danmukuSyncVideo',
                          this.option.synchronousPlayback
                      ...
                      let n = Array.from(a.children).find(
                        (e) =>
                          e.dataset.color === this.option.color.toUpperCase()
                      );
                      n && e(n, 'apd-active'),
                        t(i, this.option.visible ? '关闭弹幕' : '打开弹幕'),
                        this.resize();
                    }
                    mount(e) {
                      let { errorHandle: t } = this.utils,
                      ...
                      t(i, `Can not find the mount point: ${e}`),
                  ...
                  let e = 'artplayer-plugin-danmuku',
                  ...
                  t ||
                    ...
                    (t.textContent = T.default);
                }
              },
              {
                'bundle-text:./img/check_off.svg': '3d0s4',
                'bundle-text:./img/check_on.svg': 'gTqkL',
                'bundle-text:./img/config.svg': 'lsDbb',
                'bundle-text:./img/mode_0_off.svg': 'jTAC7',
                'bundle-text:./img/mode_0_on.svg': '4x46T',
                'bundle-text:./img/mode_1_off.svg': 'lhP68',
                'bundle-text:./img/mode_1_on.svg': '3hVSD',
                'bundle-text:./img/mode_2_off.svg': 'gfCRn',
                'bundle-text:./img/mode_2_on.svg': 'STM8G',
                'bundle-text:./img/off.svg': '660vM',
                'bundle-text:./img/on.svg': '7YDpP',
                'bundle-text:./img/style.svg': 'iSFDC',
                'bundle-text:./style.less': 'kEmiJ',
                '@parcel/transformer-js/src/esmodule-helpers.js': 'loqXi',
              },
            ],
            '3d0s4': [
              function (e, t, i, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="apd-icon apd-check-off" data-pointer="none" viewBox="0 0 32 32"><path fill="#fff" d="M8 6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2Zm0-2h16c2.21 0 4 1.79 4 4v16c0 2.21-1.79 4-4 4H8c-2.21 0-4-1.79-4-4V8c0-2.21 1.79-4 4-4"/></svg>';
              },
              {},
            ],
            gTqkL: [
            ...
            '3hVSD': [
              function (e, t, i, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="28" height="28" class="apd-icon apd-mode-1-on" data-pointer="none" viewBox="0 0 28 28"><path fill="#fff" d="M23 3H5a4 4 0 0 0-4 4v14a4 4 0 0 0 4 4h18a4 4 0 0 0 4-4V7a4 4 0 0 0-4-4M9 9H7V7h2Zm4 0h-2V7h2Zm4 0h-2V7h2Zm4 0h-2V7h2Z"/></svg>';
              },
              {},
            ],
            gfCRn: [
            ...
            STM8G: [
              function (e, t, i, a) {
                t.exports =
                  '<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="28" height="28" class="apd-icon apd-mode-2-on" data-pointer="none" viewBox="0 0 28 28"><path fill="#fff" d="M23 3H5a4 4 0 0 0-4 4v14a4 4 0 0 0 4 4h18a4 4 0 0 0 4-4V7a4 4 0 0 0-4-4M9 21H7v-2h2Zm4 0h-2v-2h2Zm4 0h-2v-2h2Zm4 0h-2v-2h2Z"/></svg>';
              },
              {},
            ],
            '660vM': [
      ...
      let { default: a } = parcelRequire4dc0('7ICE7');
    },
  },
]);
